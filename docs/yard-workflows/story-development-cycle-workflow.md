...
2. **Story Template** - `story-tmpl.yaml` disponivel em `.yard-core/development/templates/`
...
| Story template | YAML | `.yard-core/development/templates/` | Template padrao |
...
| Arquivo | Caminho |
|---------|---------|
| Workflow Definition | `.yard-core/development/workflows/story-development-cycle.yaml` |
| SM Agent | `.yard-core/development/agents/sm.md` |
| PO Agent | `.yard-core/development/agents/po.md` |
| Dev Agent | `.yard-core/development/agents/dev.md` |
| QA Agent | `.yard-core/development/agents/qa.md` |
| Create Story Task | `.yard-core/development/tasks/create-next-story.md` |
| Validate Story Task | `.yard-core/development/tasks/validate-next-story.md` |
| Develop Story Task | `.yard-core/development/tasks/dev-develop-story.md` |
| QA Gate Task | `.yard-core/development/tasks/qa-gate.md` |
| Story Template | `.yard-core/development/templates/story-tmpl.yaml` |
