...
**Localização:** `.yard-core/development/tasks/qa-review-story.md`
...
**Localização:** `.yard-core/development/tasks/qa-create-fix-request.md`
...
**Localização:** `.yard-core/development/tasks/dev-apply-qa-fixes.md`
...
config:
  ...
  dashboardStatusPath: .yard/dashboard/status.json
  legacyStatusPath: .yard/status.json
...
No arquivo `.yard-core/core-config.yaml`:
...
| Arquivo | Localização |
|---------|-------------|
| Workflow Definition | `.yard-core/development/workflows/qa-loop.yaml` |
| QA Review Task | `.yard-core/development/tasks/qa-review-story.md` |
| Create Fix Request Task | `.yard-core/development/tasks/qa-create-fix-request.md` |
| Apply QA Fixes Task | `.yard-core/development/tasks/dev-apply-qa-fixes.md` |
...
|----------|-------------|-----|
| `qa-gate-tmpl.yaml` | `.yard-core/development/templates/` | Gate file structure |
| `story-tmpl.yaml` | `.yard-core/development/templates/` | Story file structure |
