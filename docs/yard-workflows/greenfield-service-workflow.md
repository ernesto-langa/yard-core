...
**Versão:** 1.0
**Criado:** 2026-02-04
**Fonte:** `.yard-core/development/workflows/greenfield-service.yaml`
...
| Arquivo | Descricao |
|---------|-----------|
| `.yard-core/core-config.yaml` | Configuracao do framework |
...
|----------|-------------|--------|
| `project-brief-tmpl.yaml` | `.yard-core/development/templates/` | analyst |
| `prd-tmpl.yaml` | `.yard-core/development/templates/` | pm |
| `architecture-tmpl.yaml` | `.yard-core/development/templates/` | architect |
| `story-tmpl.yaml` | `.yard-core/development/templates/` | sm |
| `qa-gate-tmpl.yaml` | `.yard-core/development/templates/` | qa |
...
| Tipo | Localizacao |
|------|-------------|
| Logs do agente | `.yard/logs/agent.log` |
| Status do projeto | `.yard/project-registry.yaml` |
...
| Arquivo | Agente |
|---------|--------|
| `.yard-core/development/agents/analyst.md` | Atlas (Analyst) |
| `.yard-core/development/agents/pm.md` | Morgan (PM) |
| `.yard-core/development/agents/architect.md` | Aria (Architect) |
| `.yard-core/development/agents/po.md` | Pax (PO) |
| `.yard-core/development/agents/sm.md` | River (SM) |
| `.yard-core/development/agents/dev.md` | Dex (Dev) |
| `.yard-core/development/agents/qa.md` | Quinn (QA) |

### Tasks Principais

| Arquivo | Task |
|---------|------|
| `.yard-core/development/tasks/create-doc.md` | Criacao de documentos |
| `.yard-core/development/tasks/shard-doc.md` | Fragmentacao de documentos |
| `.yard-core/development/tasks/sm-create-next-story.md` | Criacao de stories |
| `.yard-core/development/tasks/dev-develop-story.md` | Implementacao de stories |
| `.yard-core/development/tasks/qa-review-story.md` | Revisao de implementacao |
| `.yard-core/development/tasks/execute-checklist.md` | Execucao de checklists |

### Templates

| Arquivo | Template |
|---------|----------|
| `.yard-core/development/templates/project-brief-tmpl.yaml` | Project Brief |
| `.yard-core/development/templates/prd-tmpl.yaml` | PRD |
| `.yard-core/development/templates/architecture-tmpl.yaml` | Arquitetura |
| `.yard-core/development/templates/story-tmpl.yaml` | User Story |
| `.yard-core/development/templates/qa-gate-tmpl.yaml` | QA Gate |

### Checklists

| Arquivo | Checklist |
|---------|-----------|
| `.yard-core/development/checklists/po-master-checklist.md` | Validacao PO |
| `.yard-core/development/checklists/story-draft-checklist.md` | Validacao Story Draft |
| `.yard-core/development/checklists/story-dod-checklist.md` | Definition of Done |
...
*Documentacao gerada automaticamente a partir de `.yard-core/development/workflows/greenfield-service.yaml`*
