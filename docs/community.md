...
4. Introduce yourself in [Discussions](https://github.com/ernesto-langa/yard-core/discussions)

### Find Your First Contribution

- Look for issues labeled [`good-first-issue`](https://github.com/ernesto-langa/yard-core/labels/good-first-issue)
- Check [`help-wanted`](https://github.com/ernesto-langa/yard-core/labels/help-wanted) for more complex tasks
- Browse [open Discussions](https://github.com/ernesto-langa/yard-core/discussions) to help others

## Communication Channels

### GitHub Discussions (Primary)

Our main communication hub for all YARD repositories:

- **Announcements** - Project updates from maintainers
- **General** - General discussions about YARD
- **Ideas** - Propose new features and improvements
- **Q&A** - Get help with technical questions
- **Show and Tell** - Share your projects using YARD
- **Troubleshooting** - Get help with problems
- **Squads** - Discussions about YARD Squads (modular agent teams)
- **MCP Ecosystem** - Discussions about MCP tools and integrations

[Join the Discussion](https://github.com/ernesto-langa/yard-core/discussions)
...
Anyone who has contributed to YARD in any way.
- Listed in our [Contributors page](https://github.com/ernesto-langa/yard-core/graphs/contributors)
...
All contributors are recognized in our [Contributors page](https://github.com/ernesto-langa/yard-core/graphs/contributors).
...
2. Search [existing Discussions](https://github.com/ernesto-langa/yard-core/discussions)
3. Ask in Q&A Discussions
4. Open a Troubleshooting discussion

### Found a bug?

1. Search [existing issues](https://github.com/ernesto-langa/yard-core/issues)
2. If new, [open a bug report](https://github.com/ernesto-langa/yard-core/issues/new?template=bug_report.md)

### Have an idea?

1. Check if it exists in [Ideas](https://github.com/ernesto-langa/yard-core/discussions/categories/ideas)
2. If new, [share your idea](https://github.com/ernesto-langa/yard-core/discussions/new?category=ideas)
...
1. **Voting** on ideas in [Discussions](https://github.com/ernesto-langa/yard-core/discussions/categories/ideas)
...
- [User Guide](.yard-core/user-guide.md)
...
- Current Version: See [releases](https://github.com/ernesto-langa/yard-core/releases)
...
**Thank you for being part of the YARD community!**

---

*This document is maintained by the YARD community.*
