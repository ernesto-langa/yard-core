...
**Características:**
- **Escopo:** Interno a um único arquivo de task (`.yard-core/tasks/*.md`)
...
- **Localização:** Definido em `.yard-core/workflows/*.yaml` ou seções de workflow de stories
...
- Exemplo: `.yard-core/tasks/security-scan.md`

**Arquivos de Workflow:**
- Localização: `.yard-core/workflows/{workflow-name}.yaml`
- Contém: Definição de orquestração multi-task
- Exemplo: `.yard-core/workflows/story-development-workflow.yaml`
...
```yaml
# .yard-core/workflows/story-development-workflow.yaml
workflow:
  id: story-development-workflow
  name: Story Development Flow
