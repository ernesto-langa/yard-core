...
git clone https://github.com/SEU_USUARIO/yard-core.git
cd yard-core
...
```
.yard-core/development/agents/seu-agent.md
```
...
```
.yard-core/development/tasks/sua-task.md
```
...
- [Discussoes de Squads](https://github.com/ernesto-langa/yard-core/discussions/categories/ideas) - Compartilhe ideias
...
- **GitHub Issues:** [Abra uma issue](https://github.com/ernesto-langa/yard-core/issues)
- **Discussoes:** [Inicie uma discussao](https://github.com/ernesto-langa/yard-core/discussions)
