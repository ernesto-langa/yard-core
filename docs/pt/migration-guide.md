...
1. **Verificar Logs**: Revise `.yard-core/logs/upgrade.log`
2. **Issues no GitHub**: [github.com/ernesto-langa/yard-core/issues](https://github.com/ernesto-langa/yard-core/issues)
...
**Novos Recursos:**
- Melhorias no meta-agente `yard-developer`
