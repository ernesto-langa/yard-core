...
# Seção de Comunidade do README - yard-core

> **Propósito:** Copie este snippet para o README.md do repositório `ernesto-langa/yard-core`.
...
- [Good First Issues](https://github.com/ernesto-langa/yard-core/labels/good-first-issue)
