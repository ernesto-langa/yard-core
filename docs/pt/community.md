...
4. Apresente-se nas [Discussões](https://github.com/ernesto-langa/yard-core/discussions)

### Encontre Sua Primeira Contribuição

- Procure issues marcadas com [`good-first-issue`](https://github.com/ernesto-langa/yard-core/labels/good-first-issue)
- Verifique [`help-wanted`](https://github.com/ernesto-langa/yard-core/labels/help-wanted) para tarefas mais complexas
- Navegue pelas [Discussões abertas](https://github.com/ernesto-langa/yard-core/discussions) para ajudar outros

## Canais de Comunicação

### GitHub Discussions (Principal)

Nosso hub principal de comunicação para todos os repositórios YARD:

- **Anúncios** - Atualizações do projeto pelos mantenedores
- **Geral** - Discussões gerais sobre YARD
- **Ideias** - Proponha novas funcionalidades e melhorias
- **Q&A** - Obtenha ajuda com questões técnicas
- **Mostre e Conte** - Compartilhe seus projetos usando YARD
- **Troubleshooting** - Obtenha ajuda com problemas
- **Squads** - Discussões sobre Squads YARD (equipes modulares de agentes)
- **Ecossistema MCP** - Discussões sobre ferramentas e integrações MCP

[Participe da Discussão](https://github.com/ernesto-langa/yard-core/discussions)
...
Qualquer pessoa que contribuiu para o YARD de qualquer forma.
- Listados em nossa [página de Contribuidores](https://github.com/ernesto-langa/yard-core/graphs/contributors)
...
Todos os contribuidores são reconhecidos em nossa [página de Contribuidores](https://github.com/ernesto-langa/yard-core/graphs/contributors).
...
2. Pesquise [Discussões existentes](https://github.com/ernesto-langa/yard-core/discussions)
3. Pergunte nas Discussões de Q&A
4. Abra uma discussão de Troubleshooting

### Encontrou um bug?

1. Pesquise [issues existentes](https://github.com/ernesto-langa/yard-core/issues)
2. Se for novo, [abra um relatório de bug](https://github.com/ernesto-langa/yard-core/issues/new?template=bug_report.md)

### Tem uma ideia?

1. Verifique se existe em [Ideias](https://github.com/ernesto-langa/yard-core/discussions/categories/ideas)
2. Se for nova, [compartilhe sua ideia](https://github.com/ernesto-langa/yard-core/discussions/new?category=ideas)
...
1. **Votando** em ideias nas [Discussões](https://github.com/ernesto-langa/yard-core/discussions/categories/ideas)
...
- [Guia do Usuário](.yard-core/user-guide.md)
...
- Versão Atual: Veja [releases](https://github.com/ernesto-langa/yard-core/releases)
...
**Obrigado por fazer parte da comunidade YARD!**

---

*Este documento é mantido pela comunidade YARD.*
