...
Referência completa de API para o YARD-Framework - o Sistema Orquestrado por IA para Desenvolvimento Full Stack.
...
1. O arquivo de definição do agente é carregado de `.yard-core/development/agents/{id}.md`
...
| -------------------- | ------------------------------- | --------------------------------------------- |
| `AGENT_NOT_FOUND`    | Definição de agente ausente     | Verificar `.yard-core/development/agents/`    |
...
_YARD-Framework Referência de API v4.2.11_
