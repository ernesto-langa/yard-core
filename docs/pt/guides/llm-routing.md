...
**Opção 1: Se você tem o yard-core clonado**
```bash
# Do diretório yard-core
...
- **Definição da Ferramenta:** `.yard-core/infrastructure/tools/cli/llm-routing.yaml`
- **Script de Instalação:** `.yard-core/infrastructure/scripts/llm-routing/install-llm-routing.js`
- **Definição de Tarefa:** `.yard-core/development/tasks/setup-llm-routing.md`
