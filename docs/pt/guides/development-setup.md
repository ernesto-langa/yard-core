...
Guia completo para desenvolvedores que desejam contribuir com o projeto YARD-Framework.
...
| -------------------- | --------------------------------------------- |
| **Claude Code**      | Desenvolvimento com IA usando agentes YARD    |
| **VS Code / Cursor** | IDE com integração YARD                       |
...
1. Navegue até [github.com/ernesto-langa/yard-core](https://github.com/ernesto-langa/yard-core)
...
Sincronizar agentes YARD com sua IDE:
...
Entendendo a estrutura de diretórios do `yard-core`:

```
yard-core/
├── .yard-core/                    # Fonte do framework (commitado)
...
| ----------------------------------- | ----------------------------- | ------------------------- |
| `.yard-core/development/agents/`    | Personas e comportamentos de agentes | Adicionar/modificar agentes |
| `.yard-core/development/tasks/`     | Workflows de tasks executáveis | Adicionar/modificar tasks |
| `.yard-core/development/workflows/` | Orquestrações multi-etapas    | Criar workflows           |
...
Crie um novo arquivo em `.yard-core/development/agents/`:

```bash
# Arquivo: .yard-core/development/agents/my-agent.md
```
...
dependencies:
  tasks:
    - my-agent-task.md       # Criar em .yard-core/development/tasks/
  checklists:
    - my-agent-checklist.md  # Criar em .yard-core/development/checklists/
  tools:
    - git
    - context7
````
...
Crie um novo arquivo em `.yard-core/development/tasks/`:
...
# .yard-core/development/tasks/create-doc.md          (compartilhada)
```
...
## Definição da Task (YARD Task Format V1.0)
...
Crie um novo arquivo em `.yard-core/development/workflows/`:

```bash
# Arquivo: .yard-core/development/workflows/my-workflow.yaml
```
...
- Marque `@YardAI/core-team` para issues urgentes
