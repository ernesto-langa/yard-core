...
Guia completo para criar, validar, publicar e gerenciar Squads no YARD.
...
Squads são equipes modulares de agentes de IA que estendem a funcionalidade do YARD. Cada squad é um pacote autocontido contendo:
...
- Node.js 18+
- Projeto YARD inicializado (`.yard-core/` existe)
...
Tasks devem seguir [TASK-FORMAT-SPECIFICATION-V1](../../../.yard-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md).
...
| Modo       | Comportamento                                   |
| ---------- | ----------------------------------------------- |
| `extend`   | Adiciona regras do squad às regras core do YARD |
...
```javascript
const { SquadAnalyzer } = require('./.yard-core/development/scripts/squad/squad-analyzer');
const { SquadExtender } = require('./.yard-core/development/scripts/squad/squad-extender');
...
```javascript
const { SquadValidator } = require('./.yard-core/development/scripts/squad');
...
### Nível 2: Repositório yard-squads (Público)
...
3. **Adicionar Campos** - `yard.type`, `yard.minVersion`
...
```javascript
const { SquadLoader } = require('./.yard-core/development/scripts/squad');
...
```javascript
const { SquadLoader, SquadLoaderError } = require('./.yard-core/development/scripts/squad');
...
# - yard.type: deve ser "squad"
# - yard.minVersion: deve ser semver válido
```
...
- [TASK-FORMAT-SPECIFICATION-V1](../../../.yard-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
- [GitHub Discussions](https://github.com/ernesto-langa/yard-core/discussions)
- [Issue Tracker](https://github.com/ernesto-langa/yard-core/issues)

---

_YARD Squads: Equipes de AI agents trabalhando com você_
