...
```
.yard/data/quality-metrics.json
```
...
```bash
# Sincronizar de .yard/data para o dashboard
npm run sync-metrics
...
Isso copia `.yard/data/quality-metrics.json` para `tools/quality-dashboard/public/.yard/data/`.
...
ls -la .yard/data/quality-metrics.json

# Se estiver faltando, popule com dados de exemplo
npx yard-core metrics seed
```
