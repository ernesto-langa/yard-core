...
# Guia de Service Discovery YARD

> 🌐 [EN](../../guides/service-discovery.md) | **PT** | [ES](../../es/guides/service-discovery.md)

---

> Como descobrir, consultar e usar workers no framework YARD.
...
O sistema de Service Discovery permite encontrar e usar workers (tasks, templates, scripts, workflows) em todo o framework YARD. O **Service Registry** é o catálogo central contendo metadados sobre todos os workers disponíveis.
...
```javascript
const { getRegistry, loadRegistry } = require('./.yard-core/core/registry/registry-loader');
...
//   name: 'Create Story',
//   category: 'task',
//   path: '.yard-core/development/tasks/po-create-story.md',
...
Encontrados 5 workers correspondendo a "create story":
  ...
  [task] dev-create-brownfield-story
         Path: .yard-core/development/tasks/dev-create-brownfield-story.md
...
**Localização:** `.yard-core/development/tasks/`
...
**Localização:** `.yard-core/product/templates/`
...
**Localização:** `.yard-core/infrastructure/scripts/`
...
**Localização:** `.yard-core/development/workflows/`
...
**Localização:** `.yard-core/product/checklists/`
...
node .yard-core/core/registry/build-registry.js
```
...
- `.yard-core/infrastructure/scripts/**/*.js`
- `.yard-core/product/checklists/**/*.md`
- `.yard-core/development/workflows/**/*.yaml`
- `.yard-core/core/data/**/*`
...
```javascript
const { getRegistry } = require('./.yard-core/core/registry/registry-loader');
...
```javascript
const { getRegistry } = require('./.yard-core/core/registry/registry-loader');
const { TaskExecutor } = require('./.yard-core/development/scripts/task-executor');
...
ls .yard-core/core/registry/service-registry.json

# Reconstruir registry
node .yard-core/core/registry/build-registry.js

# Validar registry
node .yard-core/core/registry/validate-registry.js
```
