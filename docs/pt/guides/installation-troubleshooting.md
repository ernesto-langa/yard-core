...
# Guia de Instalação e Solução de Problemas do YARD-Core
...
Este comando baixa e executa a versão mais recente do instalador do YARD-Core.
...
2. **Execute diagnósticos**: `npx yard-core@latest doctor`
3. **Verifique informações do sistema**: `npx yard-core@latest info`
...
| Comando | Descrição |
|---------|-----------|
| `npx yard-core@latest` | Instalar/executar assistente |
| `npx yard-core@latest --version` | Mostrar versão |
| `npx yard-core@latest --help` | Mostrar ajuda |
| `npx yard-core@latest install` | Instalar no diretório atual |
| `npx yard-core@latest init <name>` | Criar novo projeto |
| `npx yard-core@latest doctor` | Executar diagnósticos |
| `npx yard-core@latest info` | Mostrar informações do sistema |

---

*Última atualização: Dezembro 2025 | YARD-Core v2.2.0*
