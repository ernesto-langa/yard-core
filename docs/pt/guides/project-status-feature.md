...
3. Criar arquivo de cache `.yard/project-status.yaml`
...
1. Edite `.yard-core/core-config.yaml`:
   ```yaml
   projectStatus:
     enabled: true
...
Localização: `.yard-core/core-config.yaml`
...
projectStatus:
  ...
  statusFile: .yard/project-status.yaml  # Localização do arquivo de cache
...
1. **Verifica cache** - Procura por `.yard/project-status.yaml`
...
- **Localização do Cache:** `.yard/project-status.yaml`
...
3. O arquivo `.yard-core/infrastructure/scripts/project-status-loader.js` existe?
...
R: Sim, todos os agentes usam o mesmo arquivo de cache (`.yard/project-status.yaml`).
...
- **Testes:** `.yard-core/infrastructure/scripts/__tests__/project-status-loader.test.js`
