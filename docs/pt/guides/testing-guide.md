# Guia de Testes do YARD-Framework

> [EN](../../guides/testing-guide.md) | **PT** | [ES](../../es/guides/testing-guide.md)

---

> Guia completo sobre a estratégia de testes, ferramentas e melhores práticas do YARD-Framework.
...
O YARD segue uma estratégia abrangente de testes que garante qualidade de código em todas as camadas do framework. Nossa filosofia de testes é baseada em:
...
const {
  QualityGateManager,
} = require('../../../.yard-core/core/quality-gates/quality-gate-manager');
 ...
 *
 * Garante que agentes de versões anteriores do YARD continuem funcionando.
 */
...
O YARD suporta Windows, macOS e Linux. Testes cross-platform garantem comportamento consistente.
...
module.exports = {
  collectCoverageFrom: [
    ...
    '!.yard-core/development/templates/**',
    '!.yard-core/product/templates/**',
    '!**/dist/**',
    // Excluir módulos com I/O pesado (melhor para testes de integração)
    '!.yard-core/core/health-check/checks/**',
    '!.yard-core/core/config/**',
    '!.yard-core/core/manifest/**',
    '!.yard-core/core/registry/**',
    '!.yard-core/core/utils/**',
  ],
...
│   └── .yard-core/       # Cobertura por módulo
...
O Sistema de Quality Gate do YARD (veja [Guia de Quality Gates](./quality-gates.md)) integra testes em múltiplas camadas:
...
jest.mock('../../.yard-core/integrations/clickup-client');
const clickupClient = require('../../.yard-core/integrations/clickup-client');
...
_YARD-Framework v4 Guia de Testes_
