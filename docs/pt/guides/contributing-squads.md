...
2. **Yard Marketplace** - Squads premium via API YARD
...
Isso irá:
1. Fazer fork de `YardAI/yard-squads` (se necessário)
...
## Publicando no Yard Marketplace
...
- **Perguntas**: [GitHub Discussions](https://github.com/ernesto-langa/yard-core/discussions)
- **Issues**: [Issue Tracker](https://github.com/ernesto-langa/yard-core/issues)
