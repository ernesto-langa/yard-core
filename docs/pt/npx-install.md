...
Sempre execute `npx yard-core install` **a partir do diretório do seu projeto**:
...
Veja: https://yard-core.dev/docs/npx-install
```
...
- Documentação: https://yard-core.dev/docs
