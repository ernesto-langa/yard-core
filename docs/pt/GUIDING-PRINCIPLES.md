...
# Princípios Orientadores do Método YARD

> 🌐 [EN](../GUIDING-PRINCIPLES.md) | **PT** | [ES](../es/GUIDING-PRINCIPLES.md)

---

O Método YARD é um framework em linguagem natural para desenvolvimento de software assistido por IA. Estes princípios garantem que as contribuições mantenham a efetividade do método.
...
Templates seguem a especificação do [YARD Document Template](../../common/utils/yard-doc-template.md) usando formato YAML:
