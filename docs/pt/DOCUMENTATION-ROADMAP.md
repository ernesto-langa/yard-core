...
| `internal-tools-analysis.md`                      | `.yard-core/infrastructure/tools/README.md`  | Referenciar existente               |
| `.yard-core/core/registry/README.md`              | **JÁ EXISTE**                                | Nenhuma ação necessária             |
