...
| ------------------ | ---------------------------- | --------------------- | ------------------------------------ |
| **Core**           | `.yard-core/core/`           | Fundação do framework | Config, Registry, QG, MCP, Session   |
| **Development**    | `.yard-core/development/`    | Artefatos de dev      | Agentes, Tarefas, Workflows, Scripts |
| **Product**        | `.yard-core/product/`        | Artefatos PM          | Templates, Checklists, Dados         |
| **Infrastructure** | `.yard-core/infrastructure/` | Config do sistema     | Scripts, Ferramentas, Integrações    |
