...
- [Repositório Principal (yard-core)](#repositório-principal-yard-core)
...
## Repositório Principal (yard-core)
...
| Diretório                    | Descrição                                                |
| ---------------------------- | -------------------------------------------------------- |
| `.yard-core/core/`           | Fundações do framework (config, registry, gates de qualidade) |
| `.yard-core/development/`    | Definições de agentes, tarefas, workflows                |
| `.yard-core/product/`        | Templates, checklists, dados de PM                       |
| `.yard-core/infrastructure/` | Scripts, ferramentas, integrações                        |
...
2. **Dependências de Pares** - Especifique requisitos exatos de versão yard-core
