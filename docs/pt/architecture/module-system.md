...
> Guia completo para a arquitetura modular v4.2 do YARD-Framework.
...
O YARD-Framework organiza o diretório `.yard-core/` em quatro módulos principais:
...
```javascript
// Configuração
const { loadAgentConfig, globalConfigCache } = require('./.yard-core/core');

// Sessão
const { ContextDetector, SessionContextLoader } = require('./.yard-core/core');

// Elicitation
const { ElicitationEngine, ElicitationSessionManager } = require('./.yard-core/core');

// Registry
const { getRegistry, loadRegistry } = require('./.yard-core/core/registry/registry-loader');

// Quality Gates
const QualityGateManager = require('./.yard-core/core/quality-gates/quality-gate-manager');
```
...
**Caminho:** `.yard-core/infrastructure/`
...
_Arquitetura do Sistema de Módulos YARD-Framework v4_
