...
| -------------------- | -------------------------------------------------------- | ----------- | ------ |
| asset-inventory.js   | `.yard-core/infrastructure/scripts/asset-inventory.js`   | JS Script   | ✅     |
| path-analyzer.js     | `.yard-core/infrastructure/scripts/path-analyzer.js`     | JS Script   | ✅     |
| migrate-agent.js     | `.yard-core/infrastructure/scripts/migrate-agent.js`     | JS Script   | ✅     |
| agent-v3-schema.json | `.yard-core/infrastructure/schemas/agent-v3-schema.json` | JSON Schema | ✅     |
| task-v3-schema.json  | `.yard-core/infrastructure/schemas/task-v3-schema.json`  | JSON Schema | ✅     |
...
- **Todos os agents** sincronizados em `.claude/commands/YARD/agents/`
