...
| `tasks`        | Arquivos de workflow de tarefas     | `.yard-core/development/tasks/`    |
| `checklists`   | Checklists de validação             | `.yard-core/product/checklists/`   |

### Exemplo de Declaração

```yaml
# Do arquivo .yard-core/development/agents/dev.md
dependencies:
  checklists:
...
- [Definições de Agentes](../../../.yard-core/development/agents/)
