# 🔴 YARD Dashboard - Arquitetura de Observabilidade em Tempo Real
...
Este documento descreve a arquitetura para **observabilidade em tempo real** do YARD Dashboard, permitindo que usuários acompanhem comandos executados no CLI com máximo detalhe visual.
...
│                                   ▼                                      │
│  ┌─────────────────────────────────────────────────────────────────┐    │
│  │               .yard/dashboard/events.jsonl (append-only)         │    │
...
```
.yard-core/core/events/dashboard-emitter.ts
```

### Interface

```typescript
// .yard-core/core/events/types.ts
...
const EVENTS_DIR = '.yard/dashboard';
...
```typescript
// .yard-core/integrations/claude-code/hooks.ts
...
│                                                                              │
│  .yard/dashboard/events.jsonl (HIGH-LEVEL ONLY)                             │
│  ─────────────────────────────────────────────────────                      │
...
_Documentação gerada por @architect (Aria) - Yard Core v2.0_
