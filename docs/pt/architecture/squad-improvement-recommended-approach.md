...
```
.yard-core/development/scripts/squad/
...
```
.yard-core/development/agents/squad-creator.md  # Adicionar novos comandos
.yard-core/schemas/squad-schema.json            # (sem alterações necessárias)
```
