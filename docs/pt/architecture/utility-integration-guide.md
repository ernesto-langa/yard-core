...
- `.yard-core/agents/{agent}.yaml` (adicionar a dependencies.utils)
- `.yard-core/core-config.yaml` (registrar se necessário)
- `.yard-core/utils/README.md` (documentar utilitário)
...
```yaml
# .yard-core/tasks/generate-commit-message.md
...
**Arquivos Modificados:**
- `.yard-core/tasks/{task}.md` (adicionar execution.utils)
- `.yard-core/agents/{agent}.yaml` (adicionar task à lista executes)
- `.yard-core/core-config.yaml` (registrar se necessário)
- `.yard-core/utils/README.md` (documentar utilitário)
...
**Arquivos Modificados:**
- `.yard-core/core-config.yaml` (registrar em framework)
- `.yard-core/utils/README.md` (documentar como utilitário de framework)
...
```yaml
# .yard-core/agents/architect.yaml
dependencies:
  utils:
...
**Arquivos Modificados:**
- `.yard-core/agents/{agent}.yaml`
- `.yard-core/tasks/{task}.md` (se criar task)
- `.yard-core/core-config.yaml`
- `.yard-core/utils/README.md`
...
const utility = require('.yard-core/utils/{utility-name}');
...
**Localização:** `.yard-core/utils/{name}.js`
