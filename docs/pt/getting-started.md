...
# Começando com o YARD-Framework

> 🌐 [EN](../getting-started.md) | **PT** | [ES](../es/getting-started.md)

---

Bem-vindo ao YARD-Framework! Este guia irá orientá-lo nos seus primeiros passos com o framework de desenvolvimento auto-modificável alimentado por IA.
...
Antes de instalar o YARD-Framework, certifique-se de ter:
...
O YARD-Framework oferece opções flexíveis de instalação:
...
```
my-first-project/
├── .yard/                    # Configuração do framework
...
O arquivo principal de configuração (`.yard/config.json`) contém:
...
O meta-agent é o núcleo do YARD-Framework - uma IA que entende e pode modificar sua própria base de código.
...
- **[Tutoriais em Vídeo](https://yard-core.dev/tutorials)**: Aprendizado visual
...
Lembre-se: O YARD-Framework aprende e melhora com o uso. Quanto mais você interagir com ele, melhor ele entenderá seu estilo e necessidades de desenvolvimento.

Bom código com o YARD-Framework!
