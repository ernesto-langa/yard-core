...
# Guia de Instalação para macOS - YARD-Framework
...
1. Os comandos são instalados em `.claude/commands/YARD/`
...
2. O YARD-Framework lida automaticamente com sistemas de arquivos case-sensitive e case-insensitive
