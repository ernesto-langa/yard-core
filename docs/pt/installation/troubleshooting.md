...
### Problema 1: "npx yard-core is not recognized"
...
```bash
# Verifique status da instalação YARD
npx yard-core status
...
1. Execute `npx yard-core status` e anote a saída
2. Consulte este guia de solução de problemas
3. Pesquise [Issues existentes no GitHub](https://github.com/ernesto-langa/yard-core/issues)
...
- **Issues no GitHub**: [yard-core/issues](https://github.com/ernesto-langa/yard-core/issues)
