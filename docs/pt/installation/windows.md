...
# Guia de Instalação Windows para YARD-Framework
...
2. Comandos são instalados em `.claude\commands\YARD\`
...
# - Fazer backup de customizações em .yard-backup\
