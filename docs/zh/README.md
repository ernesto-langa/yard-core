...
├── framework/                 # English
├── platforms/                 # English
├── yard-agent-flows/          # Detailed agent documentation (PT)
├── yard-workflows/            # Detailed workflow documentation (PT)
│
├── pt/                        # Português
├── es/                        # Español
└── zh/                        # 中文（简体）
...
- [代理系统文档](./yard-agent-flows/README.md)
- [工作流文档](./yard-workflows/README.md)
