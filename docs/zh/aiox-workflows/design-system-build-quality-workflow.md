...
| 文档 | 路径 |
|------|------|
| 工作流定义 | `.yard-core/development/workflows/design-system-build-quality.yaml` |
| UX 设计专家代理 | `.yard-core/development/agents/ux-design-expert.md` |
| 任务: 构建组件 | `.yard-core/development/tasks/build-component.md` |
| 任务: 生成文档 | `.yard-core/development/tasks/generate-documentation.md` |
| 检查清单: WCAG A11y | `.yard-core/development/checklists/accessibility-wcag-checklist.md` |
| 任务: 计算 ROI | `.yard-core/development/tasks/calculate-roi.md` |
