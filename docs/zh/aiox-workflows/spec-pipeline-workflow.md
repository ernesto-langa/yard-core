...
| 任务 | 阶段 | 代理 | 文件 |
|------|------|------|------|
| 收集需求 | 1 | @pm | `.yard-core/development/tasks/spec-gather-requirements.md` |
| 评估复杂性 | 2 | @architect | `.yard-core/development/tasks/spec-assess-complexity.md` |
| 研究依赖 | 3 | @analyst | `.yard-core/development/tasks/spec-research-dependencies.md` |
| 编写规范 | 4 | @pm | `.yard-core/development/tasks/spec-write-spec.md` |
| 批评规范 | 5, 5c | @qa | `.yard-core/development/tasks/spec-critique.md` |
| 创建实现计划 | 6 | @architect | `.yard-core/development/tasks/plan-create-implementation.md` |
...
| 文件 | 位置 |
|------|------|
| 工作流定义 | `.yard-core/development/workflows/spec-pipeline.yaml` |
| 任务: 收集 | `.yard-core/development/tasks/spec-gather-requirements.md` |
| 任务: 评估 | `.yard-core/development/tasks/spec-assess-complexity.md` |
| 任务: 研究 | `.yard-core/development/tasks/spec-research-dependencies.md` |
| 任务: 编写规范 | `.yard-core/development/tasks/spec-write-spec.md` |
| 任务: 批评 | `.yard-core/development/tasks/spec-critique.md` |
| 任务: 创建计划 | `.yard-core/development/tasks/plan-create-implementation.md` |
