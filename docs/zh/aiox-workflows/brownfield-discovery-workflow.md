...
| 文件 | 位置 |
|------|------|
| 工作流定义 | `.yard-core/development/workflows/brownfield-discovery.yaml` |
| 任务：brownfield-create-epic | `.yard-core/development/tasks/brownfield-create-epic.md` |
| 任务：brownfield-create-story | `.yard-core/development/tasks/brownfield-create-story.md` |
| 任务：db-schema-audit | `.yard-core/development/tasks/db-schema-audit.md` |
| 任务：security-audit | `.yard-core/development/tasks/security-audit.md` |
