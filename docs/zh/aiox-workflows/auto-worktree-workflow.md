...
graph TB
    ...
    subgraph FS["文件系统"]
        WT[.yard/worktrees/{storyId}/<br/>工作树目录]
        LOG[.yard/logs/merges/<br/>合并审计日志]
    end
...
| 属性 | 值 |
|------|-----|
| **位置** | `.yard-core/development/tasks/create-worktree.md` |
| **代理** | @devops (Gage) |
| **版本** | 1.0 |
| **故事** | 1.3 |
...
3. 增加限制 (如需): 在 `.yard/config.yaml` 中
...
| 文件 | 路径 |
|------|------|
| **工作流定义** | `.yard-core/development/workflows/auto-worktree.yaml` |
| **任务创建** | `.yard-core/development/tasks/create-worktree.md` |
