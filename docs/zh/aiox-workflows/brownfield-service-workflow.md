...
| 文件 | 描述 | 路径 |
|------|------|------|
| 工作流定义 | 工作流的YAML定义 | `.yard-core/development/workflows/brownfield-service.yaml` |
| PRD模板 | 棕地PRD的模板 | `.yard-core/development/templates/brownfield-prd-tmpl.yaml` |
| 架构模板 | 架构的模板 | `.yard-core/development/templates/brownfield-architecture-tmpl.yaml` |
| 故事模板 | 故事的模板 | `.yard-core/development/templates/story-tmpl.yaml` |
| PO主清单 | 验证清单 | `.yard-core/development/checklists/po-master-checklist.md` |
| 故事草稿清单 | 故事清单 | `.yard-core/development/checklists/story-draft-checklist.md` |
| 故事DoD清单 | 完成定义 | `.yard-core/development/checklists/story-dod-checklist.md` |
