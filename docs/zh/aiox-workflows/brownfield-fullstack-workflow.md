...
> **类型：** 棕地项目开发
> **状态：** 官方文档
> **源文件：** `.yard-core/development/workflows/brownfield-fullstack.yaml`
...
**任务文件：** `.yard-core/development/tasks/document-project.md`
...
**清单文件：** `.yard-core/development/checklists/po-master-checklist.md`
...
**任务文件：** `.yard-core/development/tasks/shard-doc.md`
...
| 文件 | 目的 |
|------|------|
| `.yard-core/development/workflows/brownfield-fullstack.yaml` | 工作流定义 |
| `.yard-core/development/tasks/brownfield-create-story.md` | 创建简单故事的任务 |
| `.yard-core/development/tasks/brownfield-create-epic.md` | 创建史诗的任务 |
| `.yard-core/development/tasks/document-project.md` | 记录现有项目的任务 |
| `.yard-core/development/tasks/shard-doc.md` | 分割文档的任务 |
| `.yard-core/development/tasks/create-brownfield-story.md` | 创建棕地故事的任务 |
| `.yard-core/development/tasks/create-next-story.md` | 从PRD创建故事的任务 |
| `.yard-core/product/checklists/po-master-checklist.md` | PO验证清单 |
...
| `.yard-core/working-in-the-brownfield.md` | 棕地工作指南 |
