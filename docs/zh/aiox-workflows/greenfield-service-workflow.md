...
**版本:** 1.0
**创建:** 2026-02-04
**源:** `.yard-core/development/workflows/greenfield-service.yaml`
...
| 文件 | 描述 |
|------|------|
| `.yard-core/core-config.yaml` | 框架配置 |
| `.env` | 环境变量 |
...
| 类型 | 位置 |
|------|------|
| 代理日志 | `.yard/logs/agent.log` |
| 项目状态 | `.yard/project-registry.yaml` |
...
| 文件 | 代理 |
|------|------|
| `.yard-core/development/agents/analyst.md` | Atlas (分析师) |
| `.yard-core/development/agents/pm.md` | Morgan (PM) |
| `.yard-core/development/agents/architect.md` | Aria (架构师) |
...
| 文件 | 任务 |
|------|------|
| `.yard-core/development/tasks/create-doc.md` | 创建文档 |
| `.yard-core/development/tasks/shard-doc.md` | 分片文档 |
| `.yard-core/development/tasks/sm-create-next-story.md` | 创建故事 |
| `.yard-core/development/tasks/dev-develop-story.md` | 实施故事 |
| `.yard-core/development/tasks/qa-review-story.md` | 审阅实现 |
| `.yard-core/development/tasks/execute-checklist.md` | 执行检查列表 |

### 模板

| 文件 | 模板 |
|------|------|
| `.yard-core/development/templates/project-brief-tmpl.yaml` | 项目简报 |
| `.yard-core/development/templates/prd-tmpl.yaml` | PRD |
| `.yard-core/development/templates/architecture-tmpl.yaml` | 架构 |
| `.yard-core/development/templates/story-tmpl.yaml` | 用户故事 |
| `.yard-core/development/templates/qa-gate-tmpl.yaml` | 质量保证关卡 |

### 检查列表

| 文件 | 检查列表 |
|------|----------|
| `.yard-core/development/checklists/po-master-checklist.md` | PO 验证 |
| `.yard-core/development/checklists/story-draft-checklist.md` | 验证故事草稿 |
| `.yard-core/development/checklists/story-dod-checklist.md` | 完成定义 |
...
*文档自动从 `.yard-core/development/workflows/greenfield-service.yaml` 生成*
