...
2. **故事模板** - `.yard-core/development/templates/` 中的 `story-tmpl.yaml`
...
| 故事模板 | YAML | `.yard-core/development/templates/` | 标准模板 |
...
| 文件 | 路径 |
|------|------|
| 工作流定义 | `.yard-core/development/workflows/story-development-cycle.yaml` |
| SM 代理 | `.yard-core/development/agents/sm.md` |
| PO 代理 | `.yard-core/development/agents/po.md` |
| 开发代理 | `.yard-core/development/agents/dev.md` |
| QA 代理 | `.yard-core/development/agents/qa.md` |
| 创建故事任务 | `.yard-core/development/tasks/create-next-story.md` |
| 验证故事任务 | `.yard-core/development/tasks/validate-next-story.md` |
| 开发故事任务 | `.yard-core/development/tasks/dev-develop-story.md` |
| QA 网关任务 | `.yard-core/development/tasks/qa-gate.md` |
| 故事模板 | `.yard-core/development/templates/story-tmpl.yaml` |
