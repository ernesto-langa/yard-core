...
| 工件                     | 路径                                                          | 类型      | 状态 |
| ------------------------ | ------------------------------------------------------------- | --------- | ---- |
| worktree-manager.js      | `.yard-core/infrastructure/scripts/worktree-manager.js`       | JS 脚本   | ✅   |
| story-worktree-hooks.js  | `.yard-core/infrastructure/scripts/story-worktree-hooks.js`   | JS 脚本   | ✅   |
| project-status-loader.js | `.yard-core/infrastructure/scripts/project-status-loader.js`  | JS 脚本   | ✅   |
| auto-worktree.yaml       | `.yard-core/development/workflows/auto-worktree.yaml`         | 工作流    | ✅   |
| worktree-create.md       | `.yard-core/development/tasks/worktree-create.md`             | 任务      | ✅   |
| worktree-list.md         | `.yard-core/development/tasks/worktree-list.md`               | 任务      | ✅   |
| worktree-merge.md        | `.yard-core/development/tasks/worktree-merge.md`              | 任务      | ✅   |
