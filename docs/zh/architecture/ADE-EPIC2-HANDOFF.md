...
| 工件                 | 路径                                                      | 类型        | 状态 |
| -------------------- | --------------------------------------------------------- | ----------- | ---- |
| asset-inventory.js   | `.yard-core/infrastructure/scripts/asset-inventory.js`    | JS 脚本     | ✅   |
| path-analyzer.js     | `.yard-core/infrastructure/scripts/path-analyzer.js`      | JS 脚本     | ✅   |
| migrate-agent.js     | `.yard-core/infrastructure/scripts/migrate-agent.js`      | JS 脚本     | ✅   |
