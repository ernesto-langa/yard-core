...
| 模块 | 路径 | 目的 | 主要内容 |
| --- | --- | --- | --- |
| **核心** | `.yard-core/core/` | 框架基础 | 配置、注册表、QG、MCP、会话 |
| **开发** | `.yard-core/development/` | 开发制品 | 代理、任务、工作流、脚本 |
| **产品** | `.yard-core/product/` | PM 制品 | 模板、检查表、数据 |
| **基础设施** | `.yard-core/infrastructure/` | 系统配置 | 脚本、工具、集成 |
