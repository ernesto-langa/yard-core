...
**迁移通知:** 本文档将在 2026 Q2 迁移到 `ernesto-langa/yard-core` 仓库 (参见决策 005)
...
| 1.1  | 2025-12-14 | 更新对 ernesto-langa/yard-core 的迁移通知、semantic-release 到 v25.0.2 [故事 6.10] | Dex (dev)        |
