...
**修改的文件:**
- `.yard-core/agents/{agent}.yaml` (添加到 dependencies.utils)
- `.yard-core/core-config.yaml` (如必要则注册)
- `.yard-core/utils/README.md` (记录工具)
...
**修改的文件:**
- `.yard-core/tasks/{task}.md` (添加 execution.utils)
- `.yard-core/agents/{agent}.yaml` (添加任务到 executes 列表)
- `.yard-core/core-config.yaml` (如必要则注册)
- `.yard-core/utils/README.md` (记录工具)
...
**修改的文件:**
- `.yard-core/core-config.yaml` (在框架中注册)
- `.yard-core/utils/README.md` (记录为框架工具)
- 框架文档 (如适用)
