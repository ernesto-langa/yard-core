...
找到5个与"create story"匹配的工作者:
  ...
  [task] po-create-story
         路径: .yard-core/development/tasks/po-create-story.md
         标签: task, creation, story, product
         代理: po

  [task] dev-create-brownfield-story
         路径: .yard-core/development/tasks/dev-create-brownfield-story.md
...
**位置:** `.yard-core/development/tasks/`
...
**位置:** `.yard-core/product/templates/`
...
**位置:** `.yard-core/infrastructure/scripts/`
...
**位置:** `.yard-core/development/workflows/`
...
**位置:** `.yard-core/product/checklists/`
