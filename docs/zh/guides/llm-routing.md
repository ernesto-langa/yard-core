...
- **工具定义:** `.yard-core/infrastructure/tools/cli/llm-routing.yaml`
- **安装脚本:** `.yard-core/infrastructure/scripts/llm-routing/install-llm-routing.js`
- **任务定义:** `.yard-core/development/tasks/setup-llm-routing.md`
