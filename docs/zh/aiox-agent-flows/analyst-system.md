...
| 文件 | 命令 | 目的 |
|---------|---------|-----------|
| `.yard-core/development/tasks/facilitate-brainstorming-session.md` | `*brainstorm {topic}` | 主要任务 - 促进结构化头脑风暴会话 |
| `.yard-core/development/tasks/analyst-facilitate-brainstorming.md` | `*brainstorm {topic}` | 头脑风暴任务的交互变体 |
| `.yard-core/development/tasks/create-deep-research-prompt.md` | `*research-prompt {topic}` | 生成深度研究调查提示 |
| `.yard-core/development/tasks/advanced-elicitation.md` | `*elicit` | 高级需求获取会话 |
| `.yard-core/development/tasks/create-doc.md` | `*doc-out` | 从 YAML 模板创建文档 |
| `.yard-core/development/tasks/document-project.md` | `*create-project-brief` | 现有项目文档 |
| `.yard-core/development/tasks/calculate-roi.md` | (相关) | ROI 和成本节约计算 |

### 相关分析任务

| 文件 | 目的 |
|---------|-----------|
| `.yard-core/development/tasks/analyze-brownfield.md` | 棕地项目分析 |
| `.yard-core/development/tasks/analyze-framework.md` | 现有框架分析 |
| `.yard-core/development/tasks/analyze-performance.md` | 性能分析 |
| `.yard-core/development/tasks/analyze-project-structure.md` | 项目结构分析 |
| `.yard-core/development/tasks/analyze-cross-artifact.md` | 跨工件分析 |

### 分析师模板

| 文件 | 目的 |
|---------|-----------|
| `.yard-core/product/templates/project-brief-tmpl.yaml` | 项目简介模板 |
| `.yard-core/product/templates/market-research-tmpl.yaml` | 市场研究模板 |
| `.yard-core/product/templates/competitor-analysis-tmpl.yaml` | 竞争分析模板 |
| `.yard-core/product/templates/brainstorming-output-tmpl.yaml` | 头脑风暴会话输出模板 |
...
| 文件 | 阶段 | 目的 |
|---------|------|-----------|
| `.yard-core/development/workflows/greenfield-fullstack.yaml` | 阶段 1 | 发现与规划 - 创建 project-brief.md |
| `.yard-core/development/workflows/brownfield-discovery.yaml` | 阶段 9 | 高管意识报告 |
...
- [任务：facilitate-brainstorming-session.md](.yard-core/development/tasks/facilitate-brainstorming-session.md)
- [任务：create-deep-research-prompt.md](.yard-core/development/tasks/create-deep-research-prompt.md)
- [任务：advanced-elicitation.md](.yard-core/development/tasks/advanced-elicitation.md)
- [任务：create-doc.md](.yard-core/development/tasks/create-doc.md)
- [任务：document-project.md](.yard-core/development/tasks/document-project.md)

### 模板

- [模板：project-brief-tmpl.yaml](.yard-core/product/templates/project-brief-tmpl.yaml)
- [模板：market-research-tmpl.yaml](.yard-core/product/templates/market-research-tmpl.yaml)
- [模板：competitor-analysis-tmpl.yaml](.yard-core/product/templates/competitor-analysis-tmpl.yaml)
- [模板：brainstorming-output-tmpl.yaml](.yard-core/product/templates/brainstorming-output-tmpl.yaml)

### 工作流

- [工作流：greenfield-fullstack.yaml](.yard-core/development/workflows/greenfield-fullstack.yaml)
- [工作流：brownfield-discovery.yaml](.yard-core/development/workflows/brownfield-discovery.yaml)

### 代理

- [代理：analyst.md](.yard-core/development/agents/analyst.md)
