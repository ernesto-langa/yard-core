...
| 文件 | 命令 | 目的 |
|---------|---------|-----------|
| `.yard-core/development/tasks/create-doc.md` | `*create-prd` | 从 YAML 模板创建文档 |
| `.yard-core/development/tasks/correct-course.md` | `*correct-course` | 分析并纠正项目偏差 |
| `.yard-core/development/tasks/create-deep-research-prompt.md` | `*research` | 生成深度研究提示 |
| `.yard-core/development/tasks/brownfield-create-epic.md` | `*create-epic` | 为棕地项目创建史诗 |
| `.yard-core/development/tasks/brownfield-create-story.md` | `*create-story` | 为棕地创建故事 |
| `.yard-core/development/tasks/execute-checklist.md` | `*checklist` | 执行检查清单验证 |
| `.yard-core/development/tasks/shard-doc.md` | `*shard-prd` | 拆分大型文档 |

### @pm 模板

| 文件 | 目的 |
|---------|-----------|
| `.yard-core/product/templates/prd-tmpl.yaml` | 绿地项目 PRD 模板 |
| `.yard-core/product/templates/brownfield-prd-tmpl.yaml` | 棕地项目 PRD 模板 |

### @pm 检查清单

| 文件 | 目的 |
|---------|-----------|
| `.yard-core/product/checklists/pm-checklist.md` | PRD 验证检查清单 |
| `.yard-core/product/checklists/change-checklist.md` | 变更导航检查清单 |

### 使用 @pm 的工作流

| 文件 | 阶段 | 目的 |
|---------|------|-----------|
| `.yard-core/development/workflows/brownfield-discovery.yaml` | 阶段 10 | 发现后创建史诗和故事 |
...
**解决方案：**
- 检查 `.yard-core/product/templates/`
...
- [代理定义：pm.md](.yard-core/development/agents/pm.md)
- [任务：create-doc.md](.yard-core/development/tasks/create-doc.md)
- [任务：brownfield-create-epic.md](.yard-core/development/tasks/brownfield-create-epic.md)
- [任务：correct-course.md](.yard-core/development/tasks/correct-course.md)
- [模板：prd-tmpl.yaml](.yard-core/product/templates/prd-tmpl.yaml)
- [模板：brownfield-prd-tmpl.yaml](.yard-core/product/templates/brownfield-prd-tmpl.yaml)
- [检查清单：pm-checklist.md](.yard-core/product/checklists/pm-checklist.md)
