...
| 文件 | 命令 | 目的 |
|---------|---------|-----------|
| `.yard-core/development/tasks/sm-create-next-story.md` | `*draft` | 创建待办列表中下一个故事的主要任务 |
| `.yard-core/development/tasks/create-next-story.md` | `*draft` | 故事创建任务的完整版本 |
| `.yard-core/development/tasks/execute-checklist.md` | `*story-checklist` | 执行故事草稿验证检查清单 |
| `.yard-core/development/tasks/correct-course.md` | `*correct-course` | 分析并纠正流程偏差 |
| `.yard-core/development/tasks/collaborative-edit.md` | - | 文档协作编辑 |
| `.yard-core/development/tasks/init-project-status.md` | - | 项目状态初始化 |
...
| 文件 | 目的 |
|---------|-----------|
| `.yard-core/product/checklists/story-draft-checklist.md` | 验证故事草稿的质量和完整性 |
| `.yard-core/product/checklists/story-dod-checklist.md` | 故事完成定义 |
| `.yard-core/product/checklists/change-checklist.md` | 变更和课程纠正导航 |
| `.yard-core/product/checklists/po-master-checklist.md` | 验证中使用的主检查清单 |

### 其他代理的相关文件

| 文件 | 代理 | 目的 |
|---------|--------|-----------|
| `.yard-core/development/agents/po.md` | @po | 与 @sm 在待办和冲刺规划上协调 |
| `.yard-core/development/agents/dev.md` | @dev | 从 @sm 接收故事进行实现 |
| `.yard-core/development/agents/pm.md` | @pm | 创建 @sm 分解为故事的史诗 |
| `.yard-core/development/agents/devops.md` | @github-devops | 接收已完成故事进行 push/PR |
| `.yard-core/development/agents/qa.md` | @qa | 在风险分析上协调 |

### 使用 @sm 的工作流文件

| 文件 | 目的 |
|---------|-----------|
| `.yard-core/development/workflows/story-development-cycle.yaml` | 完整的故事开发周期 |
| `.yard-core/development/workflows/greenfield-fullstack.yaml` | 绿地全栈工作流 |
| `.yard-core/development/workflows/greenfield-service.yaml` | 绿地服务工作流 |
| `.yard-core/development/workflows/greenfield-ui.yaml` | 绿地 UI 工作流 |
| `.yard-core/development/workflows/brownfield-fullstack.yaml` | 棕地全栈工作流 |
| `.yard-core/development/workflows/brownfield-service.yaml` | 棕地服务工作流 |
| `.yard-core/development/workflows/brownfield-ui.yaml` | 棕地 UI 工作流 |

### 配置文件

| 文件 | 目的 |
|---------|-----------|
| `.yard-core/core-config.yaml` | 中央配置（devStoryLocation 等） |
| `.yard-core/development/scripts/unified-activation-pipeline.js` | 智能问候管道 |
| `.yard-core/development/scripts/agent-assignment-resolver.js` | 代理分配解析 |
...
### 代理文件
- [代理：sm.md](.yard-core/development/agents/sm.md)
- [任务：create-next-story.md](.yard-core/development/tasks/create-next-story.md)
- [任务：execute-checklist.md](.yard-core/development/tasks/execute-checklist.md)
- [任务：correct-course.md](.yard-core/development/tasks/correct-course.md)

### 检查清单
- [检查清单：story-draft-checklist.md](.yard-core/product/checklists/story-draft-checklist.md)
- [检查清单：story-dod-checklist.md](.yard-core/product/checklists/story-dod-checklist.md)
- [检查清单：change-checklist.md](.yard-core/product/checklists/change-checklist.md)

### 工作流
- [工作流：story-development-cycle.yaml](.yard-core/development/workflows/story-development-cycle.yaml)
- [工作流：greenfield-fullstack.yaml](.yard-core/development/workflows/greenfield-fullstack.yaml)
- [工作流：brownfield-fullstack.yaml](.yard-core/development/workflows/brownfield-fullstack.yaml)

### 配置
- [核心配置](../.yard-core/core-config.yaml)
