...
| 文件 | 命令 | 目的 |
|---------|---------|-----------|
| `.yard-core/development/tasks/dev-develop-story.md` | `*develop {story-id}` | 主要任务 - 使用 YOLO/Interactive/Pre-flight 模式完整开发故事 |
| `.yard-core/development/tasks/dev-improve-code-quality.md` | `*improve-code-quality <path>` | 改进代码质量(格式、linting、现代语法) |
| `.yard-core/development/tasks/dev-optimize-performance.md` | `*optimize-performance <path>` | 分析和优化代码性能 |
| `.yard-core/development/tasks/dev-suggest-refactoring.md` | `*suggest-refactoring <path>` | 建议自动重构机会 |
| `.yard-core/development/tasks/dev-backlog-debt.md` | `*backlog-debt` | 在待办事项中记录技术债务 |
| `.yard-core/development/tasks/apply-qa-fixes.md` | `*apply-qa-fixes` | 应用基于 QA 反馈的修复 |
| `.yard-core/development/tasks/execute-checklist.md` | `*execute-checklist` | 使用检查清单验证文档 |
| `.yard-core/development/tasks/validate-next-story.md` | `*validate-story-draft` | 验证故事质量和完整性 |
| `.yard-core/development/tasks/sync-documentation.md` | `*sync-documentation` | 将文档与代码变更同步 |
| `.yard-core/development/tasks/po-manage-story-backlog.md` | (内部使用) | 管理故事待办事项 |
...
| 文件 | 目的 |
|---------|-----------|
| `.yard-core/product/checklists/story-dod-checklist.md` | 故事的完成定义 |
| `.yard-core/product/checklists/pre-push-checklist.md` | 推送前检查清单 |
| `.yard-core/product/checklists/change-checklist.md` | 变更验证 |
