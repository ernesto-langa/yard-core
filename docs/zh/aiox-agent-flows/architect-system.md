...
| 文件 | 命令 | 目的 |
|---------|---------|-----------|
| `.yard-core/development/tasks/architect-analyze-impact.md` | `*analyze-impact` | 分析修改对框架组件的影响 |
| `.yard-core/development/tasks/document-project.md` | `*document-project` | 生成现有项目的 brownfield 文档 |
| `.yard-core/development/tasks/create-doc.md` | `*create-doc` | 从 YAML 模板创建文档 |
| `.yard-core/development/tasks/collaborative-edit.md` | `*collaborative-edit` | 管理协作编辑会话 |
...
| `.yard-core/development/tasks/spec-assess-complexity.md` | `*assess-complexity` | 评估故事复杂性(规范管道) |
...
| 文件 | 目的 |
|---------|-----------|
| `.yard-core/product/templates/architecture-tmpl.yaml` | 后端架构模板 |
| `.yard-core/product/templates/front-end-architecture-tmpl.yaml` | 前端架构模板 |
| `.yard-core/product/templates/fullstack-architecture-tmpl.yaml` | 全栈架构模板 |
| `.yard-core/product/templates/brownfield-architecture-tmpl.yaml` | Brownfield 项目模板 |
