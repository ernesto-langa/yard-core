...
| 文件 | 命令 | 目的 | 状态 |
|---------|---------|-----------|--------|
| `.yard-core/development/tasks/squad-creator-create.md` | `*create-squad` | 创建带完整结构的新小队 | 活跃 |
| `.yard-core/development/tasks/squad-creator-design.md` | `*design-squad` | 分析文档并生成蓝图 | 活跃 |
| `.yard-core/development/tasks/squad-creator-validate.md` | `*validate-squad` | 验证小队针对 schema 和模式 | 活跃 |
| `.yard-core/development/tasks/squad-creator-list.md` | `*list-squads` | 列出本地小队 | 活跃 |
| `.yard-core/development/tasks/squad-creator-analyze.md` | `*analyze-squad` | 分析结构并建议改进 | 活跃 |
| `.yard-core/development/tasks/squad-creator-extend.md` | `*extend-squad` | 使用新组件扩展小队 | 活跃 |
| `.yard-core/development/tasks/squad-creator-migrate.md` | `*migrate-to-v2` | 迁移小队到 v2 格式 | 活跃 |
...
| 文件 | 命令 | 目的 |
|---------|---------|-----------|
| `.yard-core/development/tasks/create-agent.md` | `*create-agent` | 创建单个代理定义 |
| `.yard-core/development/tasks/create-task.md` | `*create-task` | 创建单个任务文件 |
| `.yard-core/development/tasks/create-workflow.md` | `*create-workflow` | 创建编排工作流 |

### 支持脚本

| 文件 | 类/函数 | 目的 |
|---------|---------------|-----------|
| `.yard-core/development/scripts/squad/squad-generator.js` | `SquadGenerator` | 生成完整小队结构 |
| `.yard-core/development/scripts/squad/squad-validator.js` | `SquadValidator` | 验证小队针对 schema 和模式 |
| `.yard-core/development/scripts/squad/squad-loader.js` | `SquadLoader` | 加载和解析小队 |
| `.yard-core/development/scripts/squad/squad-designer.js` | `SquadDesigner` | 分析文档并生成蓝图 |
| `.yard-core/development/scripts/squad/squad-analyzer.js` | `SquadAnalyzer` | 分析小队结构 |
| `.yard-core/development/scripts/squad/squad-extender.js` | `SquadExtender` | 扩展现有小队 |
| `.yard-core/development/scripts/squad/squad-migrator.js` | `SquadMigrator` | 迁移小队到 v2 |
| `.yard-core/development/scripts/squad/squad-downloader.js` | `SquadDownloader` | 从仓库下载小队 |
| `.yard-core/development/scripts/squad/squad-publisher.js` | `SquadPublisher` | 发布小队 |

### JSON Schema

| 文件 | 目的 |
|---------|-----------|
| `.yard-core/schemas/squad-schema.json` | squad.yaml 验证 schema |
| `.yard-core/schemas/squad-design-schema.json` | 蓝图验证 schema |
...
- [任务：squad-creator-create.md](.yard-core/development/tasks/squad-creator-create.md)
- [任务：squad-creator-validate.md](.yard-core/development/tasks/squad-creator-validate.md)
- [任务：squad-creator-design.md](.yard-core/development/tasks/squad-creator-design.md)
- [脚本：squad-generator.js](.yard-core/development/scripts/squad/squad-generator.js)
