...
| 问题 | 可能原因 | 解决方案 |
|------|---------|---------|
| 模板未找到 | 路径不正确 | 检查 `.yard-core/development/templates/` |
...
| 模板 | 路径 |
|------|------|
| 项目简报 | `.yard-core/development/templates/project-brief-tmpl.yaml` |
| PRD | `.yard-core/development/templates/prd-tmpl.yaml` |
| 前端规范 | `.yard-core/development/templates/front-end-spec-tmpl.yaml` |
| 前端架构 | `.yard-core/development/templates/front-end-architecture-tmpl.yaml` |
| 故事 | `.yard-core/development/templates/story-tmpl.yaml` |

### 检查列表

| 检查列表 | 路径 |
|---------|------|
| PO 主检查 | `.yard-core/development/checklists/po-master-checklist.md` |
| 故事草稿 | `.yard-core/development/checklists/story-draft-checklist.md` |
| 故事完成定义 | `.yard-core/development/checklists/story-dod-checklist.md` |
...
*文档自动从 `.yard-core/development/workflows/greenfield-ui.yaml` 生成*
