...
| 文档 | 位置 | 需要用于 |
|------|------|---------|
| PRD模板 | `.yard-core/development/templates/brownfield-prd-tmpl.yaml` | 步骤2 |
| 前端模板 | `.yard-core/development/templates/front-end-spec-tmpl.yaml` | 步骤3 |
| 架构模板 | `.yard-core/development/templates/brownfield-architecture-tmpl.yaml` | 步骤4 |
| PO清单 | `.yard-core/development/checklists/po-master-checklist.md` | 步骤5 |
| 故事模板 | `.yard-core/development/templates/story-tmpl.yaml` | 步骤8 |
...
| PO主清单 | `.yard-core/development/checklists/po-master-checklist.md` | PO验证清单 |

### 代理

| 代理 | 文件 | 文档 |
|------|------|------|
| @architect | `.yard-core/development/agents/architect.md` | Aria - 整体系统架构师 |
| @pm | `.yard-core/development/agents/pm.md` | Morgan - 产品经理 |
| @ux-expert | `.yard-core/development/agents/ux-design-expert.md` | Uma - UX/UI设计师 |
| @po | `.yard-core/development/agents/po.md` | Pax - 产品所有者 |
| @sm | `.yard-core/development/agents/sm.md` | River - 敏捷主管 |
| @analyst | `.yard-core/development/agents/analyst.md` | Atlas - 业务分析师 |
| @dev | `.yard-core/development/agents/dev.md` | Dex - 全栈开发人员 |
| @qa | `.yard-core/development/agents/qa.md` | Quinn - 测试架构师 |
...
*从`.yard-core/development/workflows/brownfield-ui.yaml`自动生成的文档*
