...
- 手动安装流程（改用 `npx @synkra/yard-core install`）
...
- [GitHub 仓库](https://github.com/ernesto-langa/yard-core)
- [Issue 追踪器](https://github.com/ernesto-langa/yard-core/issues)
