...
我们在 SynkraAI 非常重视安全。如果您在 YARD 中发现安全漏洞，请负责任地报告。
...
1. **GitHub 安全公告**（首选）
   - 前往 [安全公告](https://github.com/ernesto-langa/yard-core/security/advisories)
   - 点击"报告漏洞"
   - 填写详细信息表单
...
- [GitHub 安全公告](https://github.com/ernesto-langa/yard-core/security/advisories)
