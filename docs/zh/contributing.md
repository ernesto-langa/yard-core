...
- [Squad 讨论](https://github.com/ernesto-langa/yard-core/discussions/categories/ideas) - 分享想法
...
- **GitHub Issues：** [打开一个 issue](https://github.com/ernesto-langa/yard-core/issues)
- **讨论：** [开始讨论](https://github.com/ernesto-langa/yard-core/discussions)
...
**推送顺序：** 始终先推送 `pro/` 更改，然后是 `yard-core`。
