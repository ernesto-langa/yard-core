...
4. 在 [讨论](https://github.com/ernesto-langa/yard-core/discussions) 中介绍自己

### 寻找您的第一个贡献

- 查找标记为 [`good-first-issue`](https://github.com/ernesto-langa/yard-core/labels/good-first-issue) 的 issue
- 检查 [`help-wanted`](https://github.com/ernesto-langa/yard-core/labels/help-wanted) 以获得更复杂的任务
- 浏览 [开放讨论](https://github.com/ernesto-langa/yard-core/discussions) 以帮助他人
...
所有贡献者都在我们的 [贡献者页面](https://github.com/ernesto-langa/yard-core/graphs/contributors) 上被认可。
...
1. 查看 [文档](../)
2. 搜索 [现有讨论](https://github.com/ernesto-langa/yard-core/discussions)
3. 在问答讨论中提问
4. 打开故障排除讨论

### 发现了一个 bug？

1. 搜索 [现有 issue](https://github.com/ernesto-langa/yard-core/issues)
2. 如果是新的，[打开错误报告](https://github.com/ernesto-langa/yard-core/issues/new?template=bug_report.md)

### 有想法吗？

1. 在 [想法](https://github.com/ernesto-langa/yard-core/discussions/categories/ideas) 中检查是否存在
2. 如果是新的，[分享您的想法](https://github.com/ernesto-langa/yard-core/discussions/new?category=ideas)
...
1. **投票**支持 [讨论](https://github.com/ernesto-langa/yard-core/discussions/categories/ideas) 中的想法
...
- 当前版本：见 [发布](https://github.com/ernesto-langa/yard-core/releases)
