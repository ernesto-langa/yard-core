...
npx yard-core@latest           # Run wizard
...
3. **Learn about agents:** [Agent Definitions](../../.yard-core/development/agents/)
...
3. Verify agent file exists: `ls .yard-core/development/agents/`
...
- **Documentation:** [GitHub Repository](https://github.com/ernesto-langa/yard-core)
