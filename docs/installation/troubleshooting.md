...
### Issue 1: "npx yard-core is not recognized"
...
1. Run `npx yard-core status` and note the output
2. Check this troubleshooting guide
3. Search existing [GitHub Issues](https://github.com/ernesto-langa/yard-core/issues)
