...
React with :+1: on existing [Ideas in Discussions](https://github.com/ernesto-langa/yard-core/discussions/categories/ideas) to show support.

### 2. Propose Features

Have a new idea? Open an [Idea Discussion](https://github.com/ernesto-langa/yard-core/discussions/new?category=ideas) to share it with the community.
...
5. Communicate significant changes via [Announcements](https://github.com/ernesto-langa/yard-core/discussions/categories/announcements)
