...
O agente `@devops` (Gage) e o especialista em infraestrutura e operacoes do framework YARD. Ele e responsavel por:
...
|---------|---------|-----------|
| Definição do Agente | `.yard-core/development/agents/devops.md` | Persona, comandos e comportamentos |

### Arquivos de Tasks

| Task | Caminho | Comando |
|------|---------|---------|
| Pre-Push Quality Gate | `.yard-core/development/tasks/github-devops-pre-push-quality-gate.md` | `*push` |
| Version Management | `.yard-core/development/tasks/github-devops-version-management.md` | `*version-check` |
| Repository Cleanup | `.yard-core/development/tasks/github-devops-repository-cleanup.md` | `*cleanup` |
| CI/CD Configuration | `.yard-core/development/tasks/ci-cd-configuration.md` | `*ci-cd` |
| Release Management | `.yard-core/development/tasks/release-management.md` | `*release` |
| Environment Bootstrap | `.yard-core/development/tasks/environment-bootstrap.md` | `*environment-bootstrap` |
| Search MCP | `.yard-core/development/tasks/search-mcp.md` | `*search-mcp` |
| Add MCP | `.yard-core/development/tasks/add-mcp.md` | `*add-mcp` |
| Setup MCP Docker | `.yard-core/development/tasks/setup-mcp-docker.md` | `*setup-mcp-docker` |
| Setup GitHub | `.yard-core/development/tasks/setup-github.md` | `*setup-github` |
| Security Audit | `.yard-core/development/tasks/security-audit.md` | `*security-audit` |
| Security Scan | `.yard-core/development/tasks/security-scan.md` | `*security-scan` |
...
| Task | Descrição |
|------|-----------|
| [Pre-Push Quality Gate](.yard-core/development/tasks/github-devops-pre-push-quality-gate.md) | Validacao antes do push |
| [Version Management](.yard-core/development/tasks/github-devops-version-management.md) | Gerenciamento de versoes |
| [CI/CD Configuration](.yard-core/development/tasks/ci-cd-configuration.md) | Configuracao de pipelines |
| [Release Management](.yard-core/development/tasks/release-management.md) | Gerenciamento de releases |
| [Environment Bootstrap](.yard-core/development/tasks/environment-bootstrap.md) | Bootstrap de ambientes |
...
*Documento gerado pelo Sistema YARD - 2026-02-04*
*Mantido por: @devops*
