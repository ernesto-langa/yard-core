...
|---------|---------|-----------|
| `.yard-core/development/tasks/dev-develop-story.md` | `*develop {story-id}` | Task principal - desenvolve story completa com modos YOLO/Interactive/Pre-flight |
| `.yard-core/development/tasks/dev-improve-code-quality.md` | `*improve-code-quality <path>` | Melhora qualidade do codigo (formatting, linting, modern-syntax) |
| `.yard-core/development/tasks/dev-optimize-performance.md` | `*optimize-performance <path>` | Analisa e otimiza performance do codigo |
| `.yard-core/development/tasks/dev-suggest-refactoring.md` | `*suggest-refactoring <path>` | Sugere oportunidades de refactoring automatizado |
| `.yard-core/development/tasks/dev-backlog-debt.md` | `*backlog-debt` | Registra divida tecnica no backlog |
| `.yard-core/development/tasks/apply-qa-fixes.md` | `*apply-qa-fixes` | Aplica correcoes baseadas em feedback de QA |
| `.yard-core/development/tasks/execute-checklist.md` | `*execute-checklist` | Valida documentacao usando checklists |
| `.yard-core/development/tasks/validate-next-story.md` | `*validate-story-draft` | Valida qualidade e completude de stories |
| `.yard-core/development/tasks/sync-documentation.md` | `*sync-documentation` | Sincroniza documentacao com mudancas de codigo |
| `.yard-core/development/tasks/po-manage-story-backlog.md` | (usado internamente) | Gerencia backlog de stories |

### Arquivos de Definição do Agente

| Arquivo | Propósito |
|---------|-----------|
| `.yard-core/development/agents/dev.md` | Definição core do agente @dev (persona, comandos, workflows) |
| `.claude/commands/YARD/agents/dev.md` | Comando Claude Code para ativar @dev |

### Arquivos de Checklists Usados pelo @dev

| Arquivo | Propósito |
|---------|-----------|
| `.yard-core/product/checklists/story-dod-checklist.md` | Definition of Done para stories |
| `.yard-core/product/checklists/pre-push-checklist.md` | Checklist antes de push |
| `.yard-core/product/checklists/change-checklist.md` | Validacao de mudancas |

### Arquivos Relacionados de Outros Agentes

| Arquivo | Agente | Propósito |
|---------|--------|-----------|
| `.yard-core/development/tasks/qa-backlog-add-followup.md` | @qa | QA adiciona follow-ups ao backlog |
| `.yard-core/development/tasks/qa-review-story.md` | @qa | QA revisa implementacao do @dev |
| `.yard-core/development/tasks/github-devops-pre-push-quality-gate.md` | @github-devops | Quality gate antes de push |
| `.yard-core/development/tasks/sm-create-next-story.md` | @sm | Scrum Master cria stories para @dev |

### Arquivos de Workflows que Usam @dev

| Arquivo | Propósito |
|---------|-----------|
| `.yard-core/development/workflows/brownfield-fullstack.yaml` | Workflow full-stack brownfield |
| `.yard-core/development/workflows/brownfield-service.yaml` | Workflow de servico brownfield |
| `.yard-core/development/workflows/brownfield-ui.yaml` | Workflow UI brownfield |
| `.yard-core/development/workflows/greenfield-fullstack.yaml` | Workflow full-stack greenfield |
| `.yard-core/development/workflows/greenfield-service.yaml` | Workflow de servico greenfield |
| `.yard-core/development/workflows/greenfield-ui.yaml` | Workflow UI greenfield |
...
| Arquivo | Propósito |
|---------|-----------|
| `.yard-core/core-config.yaml` | Configuracao central (devStoryLocation, coderabbit, etc.) |
| `.yard-core/development/scripts/unified-activation-pipeline.js` | Pipeline canonico de ativacao e greeting |
| `.yard-core/scripts/decision-recorder.js` | Logging de decisoes (YOLO mode) |
...
### Tasks do @dev
- [dev-develop-story.md](.yard-core/development/tasks/dev-develop-story.md)
- [dev-improve-code-quality.md](.yard-core/development/tasks/dev-improve-code-quality.md)
- [dev-optimize-performance.md](.yard-core/development/tasks/dev-optimize-performance.md)
- [dev-suggest-refactoring.md](.yard-core/development/tasks/dev-suggest-refactoring.md)
- [dev-backlog-debt.md](.yard-core/development/tasks/dev-backlog-debt.md)
- [apply-qa-fixes.md](.yard-core/development/tasks/apply-qa-fixes.md)

### Checklists
- [story-dod-checklist.md](.yard-core/product/checklists/story-dod-checklist.md)
- [pre-push-checklist.md](.yard-core/product/checklists/pre-push-checklist.md)

### Agente
- [dev.md](.yard-core/development/agents/dev.md)
