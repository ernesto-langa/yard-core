...
**Location:** `.yard-core/development/agents/qa.md` and `devops.md`
...
coderabbit_integration:
  ...
  wsl_config:
    ...
    working_directory: /mnt/c/Users/.../yard-core
```
...
# Direct command
wsl bash -c 'cd /mnt/c/.../yard-core && ~/.local/bin/coderabbit --prompt-only --base main'
```
...
- [Quality Gates Specification](../../../.yard-core/docs/standards/QUALITY-GATES-SPECIFICATION.md)
- [@qa Agent Definition](../../../.yard-core/development/agents/qa.md)
- [@devops Agent Definition](../../../.yard-core/development/agents/devops.md)
- [Pre-Push Quality Gate Task](../../../.yard-core/development/tasks/github-devops-pre-push-quality-gate.md)
