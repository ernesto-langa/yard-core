...
| Arquivo | Proposito |
|---------|-----------|
| `.yard-core/development/agents/analyst.md` | Definicao core do agente Analyst |
...
|---------|---------|-----------|
| `.yard-core/development/tasks/facilitate-brainstorming-session.md` | `*brainstorm {topic}` | Task principal - facilita sessoes de brainstorming estruturadas |
| `.yard-core/development/tasks/analyst-facilitate-brainstorming.md` | `*brainstorm {topic}` | Variante interativa da task de brainstorming |
| `.yard-core/development/tasks/create-deep-research-prompt.md` | `*research-prompt {topic}` | Gera prompts de pesquisa profunda para investigacao |
| `.yard-core/development/tasks/advanced-elicitation.md` | `*elicit` | Sessao avancada de elicitacao de requisitos |
| `.yard-core/development/tasks/create-doc.md` | `*doc-out` | Criacao de documentos a partir de templates YAML |
| `.yard-core/development/tasks/document-project.md` | `*create-project-brief` | Documentacao de projetos existentes |
| `.yard-core/development/tasks/calculate-roi.md` | (relacionada) | Calculo de ROI e economia de custos |

### Tasks Relacionadas de Analise

| Arquivo | Proposito |
|---------|-----------|
| `.yard-core/development/tasks/analyze-brownfield.md` | Analise de projetos brownfield |
| `.yard-core/development/tasks/analyze-framework.md` | Analise de frameworks existentes |
| `.yard-core/development/tasks/analyze-performance.md` | Analise de performance |
| `.yard-core/development/tasks/analyze-project-structure.md` | Analise de estrutura de projeto |
| `.yard-core/development/tasks/analyze-cross-artifact.md` | Analise cross-artifact |

### Templates do Analyst

| Arquivo | Proposito |
|---------|-----------|
| `.yard-core/product/templates/project-brief-tmpl.yaml` | Template para Project Brief |
| `.yard-core/product/templates/market-research-tmpl.yaml` | Template para Pesquisa de Mercado |
| `.yard-core/product/templates/competitor-analysis-tmpl.yaml` | Template para Analise Competitiva |
| `.yard-core/product/templates/brainstorming-output-tmpl.yaml` | Template para output de sessoes de brainstorming |
...
|---------|------|-----------|
| `.yard-core/development/workflows/greenfield-fullstack.yaml` | Fase 1 | Discovery & Planning - cria project-brief.md |
| `.yard-core/development/workflows/brownfield-discovery.yaml` | Fase 9 | Relatorio Executivo de Awareness |
...
- [Task: facilitate-brainstorming-session.md](.yard-core/development/tasks/facilitate-brainstorming-session.md)
- [Task: create-deep-research-prompt.md](.yard-core/development/tasks/create-deep-research-prompt.md)
- [Task: advanced-elicitation.md](.yard-core/development/tasks/advanced-elicitation.md)
- [Task: create-doc.md](.yard-core/development/tasks/create-doc.md)
- [Task: document-project.md](.yard-core/development/tasks/document-project.md)

### Templates

- [Template: project-brief-tmpl.yaml](.yard-core/product/templates/project-brief-tmpl.yaml)
- [Template: market-research-tmpl.yaml](.yard-core/product/templates/market-research-tmpl.yaml)
- [Template: competitor-analysis-tmpl.yaml](.yard-core/product/templates/competitor-analysis-tmpl.yaml)
- [Template: brainstorming-output-tmpl.yaml](.yard-core/product/templates/brainstorming-output-tmpl.yaml)

### Workflows

- [Workflow: greenfield-fullstack.yaml](.yard-core/development/workflows/greenfield-fullstack.yaml)
- [Workflow: brownfield-discovery.yaml](.yard-core/development/workflows/brownfield-discovery.yaml)

### Agente

- [Agent: analyst.md](.yard-core/development/agents/analyst.md)
