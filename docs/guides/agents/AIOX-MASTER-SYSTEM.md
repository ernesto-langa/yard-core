...
|---------|---------|-----------|
| `.yard-core/development/tasks/create-agent.md` | `*create agent` | Cria nova definicao de agente usando sistema de templates |
| `.yard-core/development/tasks/create-task.md` | `*create task` | Cria novo arquivo de task com estrutura padronizada |
| `.yard-core/development/tasks/create-workflow.md` | `*create workflow` | Cria nova definicao de workflow multi-agente |
| `.yard-core/development/tasks/modify-agent.md` | `*modify agent` | Modifica agente existente com backup e rollback |
| `.yard-core/development/tasks/modify-task.md` | `*modify task` | Modifica task existente preservando compatibilidade |
| `.yard-core/development/tasks/modify-workflow.md` | `*modify workflow` | Modifica workflow existente mantendo integridade |
| `.yard-core/development/tasks/analyze-framework.md` | `*analyze-framework` | Analisa estrutura do framework, redundancias e performance |
| `.yard-core/development/tasks/deprecate-component.md` | `*deprecate-component` | Deprecia componente com timeline e migracao |
| `.yard-core/development/tasks/propose-modification.md` | `*propose-modification` | Cria proposta de modificacao para revisao colaborativa |
| `.yard-core/development/tasks/execute-checklist.md` | `*execute-checklist` | Executa checklist de validacao |
| `.yard-core/development/tasks/create-doc.md` | `*create-doc` | Cria documento a partir de template YAML |
| `.yard-core/development/tasks/advanced-elicitation.md` | `*advanced-elicitation` | Executa elicitacao avancada com multiplos metodos |
| `.yard-core/development/tasks/kb-mode-interaction.md` | `*kb` | Habilita modo Knowledge Base interativo |
| `.yard-core/development/tasks/correct-course.md` | `*correct-course` | Analisa e corrige desvios de processo/qualidade |
| `.yard-core/development/tasks/update-manifest.md` | `*update-manifest` | Atualiza manifesto de equipe com novos agentes |
| `.yard-core/development/tasks/create-next-story.md` | `*create-next-story` | Cria proxima user story |
| `.yard-core/development/tasks/create-deep-research-prompt.md` | - | Gera prompts de pesquisa profunda |
| `.yard-core/development/tasks/improve-self.md` | - | Auto-melhoria do agente |
| `.yard-core/development/tasks/shard-doc.md` | `*shard-doc` | Quebra documento em partes menores |
| `.yard-core/development/tasks/document-project.md` | `*document-project` | Gera documentacao do projeto |
| `.yard-core/development/tasks/index-docs.md` | `*index-docs` | Indexa documentacao para busca |

### Arquivos de Definicao do Agente

| Arquivo | Proposito |
|---------|-----------|
| `.yard-core/development/agents/aiox-master.md` | Definicao completa do agente (persona, comandos, dependencias) |
...
| Arquivo | Proposito |
|---------|-----------|
| `.yard-core/development/templates/agent-template.yaml` | Template para criacao de novos agentes |
| `.yard-core/development/templates/task-template.md` | Template para criacao de novas tasks |
| `.yard-core/development/templates/workflow-template.yaml` | Template para criacao de novos workflows |
| `.yard-core/development/templates/prd-tmpl.yaml` | Template para PRD |
| `.yard-core/development/templates/story-tmpl.yaml` | Template para stories |
| `.yard-core/development/templates/architecture-tmpl.yaml` | Template para arquitetura |
| `.yard-core/development/templates/brownfield-prd-tmpl.yaml` | Template PRD brownfield |
| `.yard-core/development/templates/brownfield-architecture-tmpl.yaml` | Template arquitetura brownfield |
| `.yard-core/development/templates/competitor-analysis-tmpl.yaml` | Template analise de concorrentes |
| `.yard-core/development/templates/market-research-tmpl.yaml` | Template pesquisa de mercado |
| `.yard-core/development/templates/project-brief-tmpl.yaml` | Template brief de projeto |
| `.yard-core/development/templates/front-end-architecture-tmpl.yaml` | Template arquitetura frontend |
| `.yard-core/development/templates/front-end-spec-tmpl.yaml` | Template spec frontend |
| `.yard-core/development/templates/fullstack-architecture-tmpl.yaml` | Template arquitetura fullstack |
...
| `.yard-core/development/utils/security-checker.js` | Validador de seguranca |
...
| Arquivo | Proposito |
|---------|-----------|
| `.yard-core/development/workflows/brownfield-fullstack.md` | Workflow fullstack brownfield |
| `.yard-core/development/workflows/brownfield-service.md` | Workflow servico brownfield |
| `.yard-core/development/workflows/brownfield-ui.md` | Workflow UI brownfield |
| `.yard-core/development/workflows/greenfield-fullstack.md` | Workflow fullstack greenfield |
...
| Arquivo | Proposito |
|---------|-----------|
| `.yard-core/development/checklists/architect-checklist.md` | Checklist de arquitetura |
| `.yard-core/development/checklists/change-checklist.md` | Checklist de mudancas |
| `.yard-core/development/checklists/pm-checklist.md` | Checklist de PM |
| `.yard-core/development/checklists/po-master-checklist.md` | Checklist de PO |
| `.yard-core/development/checklists/story-dod-checklist.md` | Checklist DoD de stories |
| `.yard-core/development/checklists/story-draft-checklist.md` | Checklist draft de stories |

### Arquivos Relacionados de Outros Agentes

| Arquivo | Agente | Proposito |
|---------|--------|-----------|
| `.yard-core/development/tasks/brownfield-create-epic.md` | @pm | Criacao de epics (delegada) |
| `.yard-core/development/tasks/brownfield-create-story.md` | @pm | Criacao de stories (delegada) |
| `.yard-core/development/tasks/analyst-facilitate-brainstorming.md` | @analyst | Brainstorming (delegado) |
| `.yard-core/development/tasks/generate-ai-frontend-prompt.md` | @architect | Geracao de prompts AI (delegada) |
| `.yard-core/development/tasks/create-suite.md` | @qa | Criacao de suites de teste (delegada) |
...
flowchart TB
    ...
    subgraph OUTPUTS["📁 OUTPUTS"]
        AGENTS_DIR[".yard-core/agents/"]
        TASKS_DIR[".yard-core/tasks/"]
        WORKFLOWS_DIR[".yard-core/workflows/"]
        DOCS_DIR["docs/"]
    end
...
| Arquivo | Proposito |
|---------|-----------|
| `.yard-core/core-config.yaml` | Configuracao central do framework |
| `.yard-core/install-manifest.yaml` | Manifesto de instalacao |
| `.yard-core/config/agent-config-requirements.yaml` | Requisitos de configuracao de agentes |
| `.yard/project-registry.yaml` | Registry central de projetos |
...
**Solucao:**
1. Liste templates disponiveis: verifique `.yard-core/development/templates/`
...
- [Tasks Directory](.yard-core/development/tasks/)
- [Templates Directory](.yard-core/development/templates/)
- [Workflows Directory](.yard-core/development/workflows/)
