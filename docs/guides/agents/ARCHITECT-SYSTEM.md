...
|---------|---------|-----------|
| `.yard-core/development/tasks/architect-analyze-impact.md` | `*analyze-impact` | Analisa impacto de modificacoes em componentes do framework |
| `.yard-core/development/tasks/document-project.md` | `*document-project` | Gera documentacao brownfield de projeto existente |
| `.yard-core/development/tasks/create-doc.md` | `*create-doc` | Cria documentos a partir de templates YAML |
| `.yard-core/development/tasks/collaborative-edit.md` | `*collaborative-edit` | Gerencia sessoes de edicao colaborativa |
| `.yard-core/development/tasks/create-deep-research-prompt.md` | `*research` | Gera prompts de pesquisa profunda |
| `.yard-core/development/tasks/execute-checklist.md` | `*execute-checklist` | Executa checklists de validacao |
| `.yard-core/development/tasks/spec-assess-complexity.md` | `*assess-complexity` | Avalia complexidade de stories (Spec Pipeline) |

### Arquivos de Definicao do Agente

| Arquivo | Proposito |
|---------|-----------|
| `.yard-core/development/agents/architect.md` | Definicao core do agente Architect |
...
| Arquivo | Proposito |
|---------|-----------|
| `.yard-core/product/templates/architecture-tmpl.yaml` | Template para arquitetura backend |
| `.yard-core/product/templates/front-end-architecture-tmpl.yaml` | Template para arquitetura frontend |
| `.yard-core/product/templates/fullstack-architecture-tmpl.yaml` | Template para arquitetura fullstack |
| `.yard-core/product/templates/brownfield-architecture-tmpl.yaml` | Template para projetos brownfield |
...
|---------|--------|-----------|
| `.yard-core/development/tasks/spec-gather-requirements.md` | @pm | Coleta requisitos que alimentam arquitetura |
| `.yard-core/development/tasks/spec-research-dependencies.md` | @analyst | Pesquisa dependencias para arquitetura |
| `.yard-core/development/tasks/spec-critique.md` | @qa | Valida specs que impactam arquitetura |
| `.yard-core/development/tasks/plan-create-implementation.md` | @architect | Cria plano de implementacao pos-spec |
| `.yard-core/development/agents/db-sage.md` | @db-sage | Colabora em arquitetura de dados |
| `.yard-core/development/agents/ux-design-expert.md` | @ux-design-expert | Colabora em arquitetura frontend |
| `.yard-core/development/agents/devops.md` | @devops | Colabora em infraestrutura |
...
**Arquivo:** `.yard-core/development/workflows/greenfield-fullstack.yaml`
...
**Arquivo:** `.yard-core/development/workflows/brownfield-fullstack.yaml`
...
**Arquivo:** `.yard-core/development/workflows/spec-pipeline.yaml`
...
**Arquivo:** `.yard-core/development/workflows/qa-loop.yaml`
...
```bash
# Analise basica
*analyze-impact modify .yard-core/agents/weather-agent.md

# Analise profunda com testes
*analyze-impact modify .yard-core/agents/weather-agent.md --depth deep --include-tests

# Deprecacao com output visual
*analyze-impact deprecate .yard-core/scripts/old-helper.js --output-format visual --save-report reports/deprecation.html

# Refatoracao com threshold de risco
*analyze-impact refactor .yard-core/tasks/process-data.md --depth shallow --risk-threshold medium
```
...
| `.yard/project-registry.yaml` | Registro de projetos |
...
**Solucao:**
1. Verificar `.yard-core/product/templates/`
...
- [architect-analyze-impact.md](.yard-core/development/tasks/architect-analyze-impact.md)
- [document-project.md](.yard-core/development/tasks/document-project.md)
- [create-doc.md](.yard-core/development/tasks/create-doc.md)
- [execute-checklist.md](.yard-core/development/tasks/execute-checklist.md)
- [spec-assess-complexity.md](.yard-core/development/tasks/spec-assess-complexity.md)

### Templates de Arquitetura

- [fullstack-architecture-tmpl.yaml](.yard-core/product/templates/fullstack-architecture-tmpl.yaml)
- [architecture-tmpl.yaml](.yard-core/product/templates/architecture-tmpl.yaml)
- [front-end-architecture-tmpl.yaml](.yard-core/product/templates/front-end-architecture-tmpl.yaml)
- [brownfield-architecture-tmpl.yaml](.yard-core/product/templates/brownfield-architecture-tmpl.yaml)

### Workflows Relacionados

- [greenfield-fullstack.yaml](.yard-core/development/workflows/greenfield-fullstack.yaml)
- [brownfield-fullstack.yaml](.yard-core/development/workflows/brownfield-fullstack.yaml)
- [spec-pipeline.yaml](.yard-core/development/workflows/spec-pipeline.yaml)

### Agentes Colaboradores

- [@db-sage](.yard-core/development/agents/db-sage.md) - Arquitetura de dados
- [@ux-design-expert](.yard-core/development/agents/ux-design-expert.md) - Arquitetura frontend
- [@pm](.yard-core/development/agents/pm.md) - Requisitos e PRD
- [@devops](.yard-core/development/agents/devops.md) - Git push e infraestrutura
