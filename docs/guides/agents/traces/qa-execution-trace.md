...
> Agent definition: `.yard-core/development/agents/qa.md`
...
|-------|------|--------|---------|
| 1 | `.yard-core/development/agents/qa.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.yard-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.yard-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: qaLocation, dataLocation, storyBacklog |
| 4 | `.yard-core/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.yard-core/data/technical-preferences.md` | AgentConfigLoader.loadFile() | Technical preferences (always loaded, 15KB) |
| 6 | `.yard-core/product/data/test-levels-framework.md` | AgentConfigLoader.loadFile() | Test levels framework (always loaded, 8KB) |
| 7 | `.yard-core/product/data/test-priorities-matrix.md` | AgentConfigLoader.loadFile() | Test priorities matrix (always loaded, 6KB) |
| 8 | `.yard/session-state.json` | ContextDetector._detectFromFile() | Session type detection (if no conversation history) |
| 9 | `.yard/project-status.yaml` | ProjectStatusLoader.loadCache() | Cached project status (60s TTL) |
...
qa:
  config_sections:
    ...
    - storyBacklog
  files_loaded:
    - path: .yard-core/data/technical-preferences.md
      lazy: false
      size: 15KB
    - path: .yard-core/product/data/test-levels-framework.md
      lazy: false
      size: 8KB
    - path: .yard-core/product/data/test-priorities-matrix.md
      lazy: false
      size: 6KB
  lazy_loading:
...
**Task file:** `.yard-core/development/tasks/qa-run-tests.md`
...
**Task file:** `.yard-core/development/tasks/qa-review-story.md`
...
| `.yard-core/product/data/test-levels-framework.md` | Data | Loaded at activation |
| `.yard-core/product/data/test-priorities-matrix.md` | Data | Loaded at activation |
...
**Task file:** `.yard-core/development/tasks/qa-review-build.md`
...
**Task file:** `.yard-core/development/tasks/qa-gate.md`
**Template:** `.yard-core/product/templates/qa-gate-tmpl.yaml` (EXISTS in product/templates)

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `qa-gate.md` | Task | EXISTS |
| `qa-gate-tmpl.yaml` | Template | EXISTS (in `.yard-core/product/templates/`) |
| `docs/stories/{storyId}` | Input | Required |
...
**Task file:** `.yard-core/development/tasks/qa-nfr-assess.md`
...
**Task file:** `.yard-core/development/tasks/qa-risk-profile.md`
...
**Task file:** `.yard-core/development/tasks/qa-create-fix-request.md`
...
**Task file:** `.yard-core/development/tasks/qa-library-validation.md`
...
**Task file:** `.yard-core/development/tasks/qa-security-checklist.md`
...
**Task file:** `.yard-core/development/tasks/qa-migration-validation.md`
...
**Task file:** `.yard-core/development/tasks/qa-evidence-requirements.md`
...
**Task file:** `.yard-core/development/tasks/qa-false-positive-detection.md`
...
**Task file:** `.yard-core/development/tasks/qa-browser-console-check.md`
...
**Task file:** `.yard-core/development/tasks/qa-test-design.md`
...
**Task file:** `.yard-core/development/tasks/qa-trace-requirements.md`
...
**Task file:** `.yard-core/development/tasks/create-suite.md`
...
**Task file:** `.yard-core/development/tasks/spec-critique.md`
...
**Task file:** `.yard-core/development/tasks/manage-story-backlog.md` (MISSING)
...
| `qa-gate-tmpl.yaml` | Template | `*gate` (in `dependencies.templates`) | EXISTS in `.yard-core/product/templates/` but NOT in `.yard-core/development/templates/` per IDE-FILE-RESOLUTION |
| `story-tmpl.yaml` | Template | (in `dependencies.templates`) | EXISTS in `.yard-core/product/templates/` but NOT in `.yard-core/development/templates/` per IDE-FILE-RESOLUTION |
| `test-levels-framework.md` | Data | `agent-config-requirements.yaml` | EXISTS at `.yard-core/product/data/` (NOT in `.yard-core/data/` where `dependencies.data` resolves) |
| `test-priorities-matrix.md` | Data | `agent-config-requirements.yaml` | EXISTS at `.yard-core/product/data/` (NOT in `.yard-core/data/` where `dependencies.data` resolves) |

**Path Resolution Note:** The `IDE-FILE-RESOLUTION` rule in the agent definition maps `dependencies` to `.yard-core/development/{type}/{name}`. However, 2 templates and 2 data files exist under `.yard-core/product/` instead. The `agent-config-requirements.yaml` correctly references the full paths under `.yard-core/product/data/`, but the agent definition's `dependencies` block uses short names that resolve to `.yard-core/development/templates/` and `.yard-core/development/data/` respectively, where these files do not exist. Actual runtime loading uses `agent-config-requirements.yaml` paths, so functionality is preserved.
