...
> Agent definition: `.yard-core/development/agents/ux-design-expert.md`
...
|-------|------|--------|---------|
| 1 | `.yard-core/development/agents/ux-design-expert.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.yard-core/core-config.yaml` | generate-greeting.js (fs.readFile + yaml.load) | Core configuration |
| 3 | `.yard-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation, uxLocation |
| 4 | `.yard-core/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.yard/session-state.json` | SessionContextLoader.loadContext() | Session type detection (sessionType, previousAgent, lastCommands) |
| 6 | `.yard/project-status.yaml` | loadProjectStatus() | Cached project status (60s TTL) |
...
**Task file:** `.yard-core/development/tasks/ux-user-research.md`
...
**Task file:** `.yard-core/development/tasks/ux-create-wireframe.md`
...
**Task file:** `.yard-core/development/tasks/generate-ai-frontend-prompt.md`
...
**Task file:** `.yard-core/development/tasks/create-doc.md`
**Template:** `.yard-core/product/templates/front-end-spec-tmpl.yaml`
...
**Task file:** `.yard-core/development/tasks/audit-codebase.md`
...
**Task file:** `.yard-core/development/tasks/consolidate-patterns.md`
...
**Task file:** `.yard-core/development/tasks/generate-shock-report.md`
**Template:** `.yard-core/product/templates/shock-report-tmpl.html`
...
**Task file:** `.yard-core/development/tasks/extract-tokens.md`
**Template:** `.yard-core/product/templates/tokens-schema-tmpl.yaml`
...
**Task file:** `.yard-core/development/tasks/setup-design-system.md`
...
**Task file:** `.yard-core/development/tasks/generate-migration-strategy.md`
**Template:** `.yard-core/product/templates/migration-strategy-tmpl.md`
...
**Task file:** `.yard-core/development/tasks/tailwind-upgrade.md`
...
**Task file:** `.yard-core/development/tasks/audit-tailwind-config.md`
...
**Task file:** `.yard-core/development/tasks/export-design-tokens-dtcg.md`
**Templates:** `.yard-core/product/templates/token-exports-css-tmpl.css`, `.yard-core/product/templates/token-exports-tailwind-tmpl.js`
...
**Task file:** `.yard-core/development/tasks/bootstrap-shadcn-library.md`
...
**Task file:** `.yard-core/development/tasks/build-component.md`
**Template:** `.yard-core/product/templates/component-react-tmpl.tsx`
...
**Task file:** `.yard-core/development/tasks/compose-molecule.md`
...
**Task file:** `.yard-core/development/tasks/extend-pattern.md`
...
**Task file:** `.yard-core/development/tasks/generate-documentation.md`
...
**Checklist file:** `.yard-core/product/checklists/accessibility-wcag-checklist.md`
...
**Task file:** `.yard-core/development/tasks/calculate-roi.md`
...
**Task file:** `.yard-core/development/tasks/ux-ds-scan-artifact.md`
**Template:** `.yard-core/product/templates/ds-artifact-analysis.md`
...
**Task file:** `.yard-core/development/tasks/integrate-Squad.md` (MISSING)
...
The agent definition references dependencies using short names (e.g., `yard-core/tasks/...`). The actual resolution paths are:

| Dependency Type | Agent Definition Path | Actual Disk Location |
|-----------------|----------------------|---------------------|
| Tasks | `yard-core/tasks/{name}` | `.yard-core/development/tasks/{name}` |
| Templates | `yard-core/templates/{name}` | `.yard-core/product/templates/{name}` |
| Checklists | `yard-core/checklists/{name}` | `.yard-core/product/checklists/{name}` |
| Data | `yard-core/data/{name}` | `.yard-core/data/{name}` or `.yard-core/product/data/{name}` |

All 9 templates, all 4 checklists, and all 7 data files resolve correctly to files in `product/` directories. The `development/data/` directory does not exist; data files live under `.yard-core/data/` and `.yard-core/product/data/`.
...
**Template for state persistence:** `.yard-core/product/templates/state-persistence-tmpl.yaml` (EXISTS)
