...
> Agent definition: `.yard-core/development/agents/analyst.md`
...
|-------|------|--------|---------|
| 1 | `.yard-core/development/agents/analyst.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.yard-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.yard-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation, analyticsLocation |
| 4 | `.yard-core/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.yard-core/product/data/brainstorming-techniques.md` | AgentConfigLoader.loadFile() | Brainstorming techniques (always loaded, 2KB) |
...
analyst:
  config_sections:
    ...
    - analyticsLocation
  files_loaded:
    - path: .yard-core/product/data/brainstorming-techniques.md
      lazy: false
      size: 2KB
...
**Template:** `.yard-core/product/templates/project-brief-tmpl.yaml` (EXISTS)
...
| `.yard-core/product/data/elicitation-methods.md` | Data | Referenced by create-doc |
...
**Task file:** `.yard-core/development/tasks/create-doc.md`
**Template:** `.yard-core/product/templates/market-research-tmpl.yaml` (EXISTS)
...
**Task file:** `.yard-core/development/tasks/create-doc.md`
**Template:** `.yard-core/product/templates/competitor-analysis-tmpl.yaml` (EXISTS)
...
**Task file:** `.yard-core/development/tasks/facilitate-brainstorming-session.md`
**Template:** `.yard-core/product/templates/brainstorming-output-tmpl.yaml` (EXISTS)
**Data file:** `.yard-core/product/data/brainstorming-techniques.md` (EXISTS)
...
**Task file:** `.yard-core/development/tasks/spec-research-dependencies.md`
...
**Script:** `.yard-core/infrastructure/scripts/pattern-extractor.js` (EXISTS)
