...
> Agent definition: `.yard-core/development/agents/po.md`
...
|-------|------|--------|---------|
| 1 | `.yard-core/development/agents/po.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.yard-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.yard-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: devStoryLocation, prd, storyBacklog, templatesLocation |
| 4 | `.yard-core/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.yard-core/product/data/elicitation-methods.md` | AgentConfigLoader.loadFile() | Elicitation methods (always loaded, 5KB) |
...
po:
  config_sections:
    ...
    - templatesLocation
  files_loaded:
    - path: .yard-core/product/data/elicitation-methods.md
      lazy: false
      size: 5KB
  lazy_loading:
...
**Task file:** `.yard-core/development/tasks/po-backlog-add.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `po-backlog-add.md` | Task | EXISTS |
| `.yard-core/product/data/elicitation-methods.md` | Data | EXISTS (pre-loaded) |
...
**Task file:** `.yard-core/development/tasks/po-manage-story-backlog.md`
...
**Task file:** `.yard-core/development/tasks/po-stories-index.md`
...
**Task file:** `.yard-core/development/tasks/validate-next-story.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `validate-next-story.md` | Task | EXISTS |
| `.yard-core/product/templates/story-tmpl.yaml` | Template | EXISTS |
| `.yard-core/product/checklists/po-master-checklist.md` | Checklist | EXISTS |
...
**Task file:** `.yard-core/development/tasks/po-sync-story.md`
...
**Task file:** `.yard-core/development/tasks/po-pull-story.md`
