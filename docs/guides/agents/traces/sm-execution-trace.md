...
> Agent definition: `.yard-core/development/agents/sm.md`
...
|-------|------|--------|---------|
| 1 | `.yard-core/development/agents/sm.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.yard-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.yard-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: devStoryLocation, storyBacklog, dataLocation |
| 4 | `.yard-core/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.yard-core/product/data/mode-selection-best-practices.md` | AgentConfigLoader.loadFile() | Mode selection best practices (always loaded, 10KB) |
...
sm:
  config_sections:
    ...
    - dataLocation
  files_loaded:
    - path: .yard-core/product/data/mode-selection-best-practices.md
      lazy: false
      size: 10KB
    - path: .yard-core/data/workflow-patterns.yaml
      lazy: false
      size: 8KB
...
**Task file:** `.yard-core/development/tasks/sm-create-next-story.md`
**Template:** `.yard-core/development/templates/story-tmpl.yaml` (MISSING in development/, EXISTS in `.yard-core/product/templates/story-tmpl.yaml`)
...
| `.yard-core/product/data/mode-selection-best-practices.md` | Data | Referenced by sm config |
...
**Checklist:** `.yard-core/development/checklists/story-draft-checklist.md` (MISSING in development/, EXISTS in `.yard-core/product/checklists/story-draft-checklist.md`)
...
|------|------|---------------|--------|
| `story-tmpl.yaml` | Template | `*draft` (sm-create-next-story.md) | MISSING in `.yard-core/development/templates/`, EXISTS in `.yard-core/product/templates/story-tmpl.yaml` |
| `story-draft-checklist.md` | Checklist | `*story-checklist` (execute-checklist.md) | MISSING in `.yard-core/development/checklists/`, EXISTS in `.yard-core/product/checklists/story-draft-checklist.md` |
