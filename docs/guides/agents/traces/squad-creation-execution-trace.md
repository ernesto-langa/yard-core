...
> Agent definition: `.yard-core/development/agents/squad-creator.md`
...
|-------|------|--------|---------|
| 1 | `.yard-core/development/agents/squad-creator.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.yard-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.yard-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation (no squad-creator entry found) |
| 4 | `.yard-core/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.yard/session-state.json` | ContextDetector._detectFromFile() | Session type detection (if no conversation history) |
| 6 | `.yard/project-status.yaml` | ProjectStatusLoader.loadCache() | Cached project status (60s TTL) |
...
**Task file:** `.yard-core/development/tasks/squad-creator-design.md`
...
**Task file:** `.yard-core/development/tasks/squad-creator-create.md`
...
| `.yard-core/development/templates/squad-template/` | Template scaffold | EXISTS |
...
**Task file:** `.yard-core/development/tasks/squad-creator-validate.md`
...
**Task file:** `.yard-core/development/tasks/squad-creator-list.md`
...
**Task file:** `.yard-core/development/tasks/squad-creator-migrate.md`
...
**Task file:** `.yard-core/development/tasks/squad-creator-analyze.md`
...
**Task file:** `.yard-core/development/tasks/squad-creator-extend.md`
...
| `squad-validator.js` | Script | EXISTS |
| `.yard-core/development/templates/squad/agent-template.md` | Template | EXISTS |
| `.yard-core/development/templates/squad/task-template.md` | Template | EXISTS |
| `.yard-core/development/templates/squad/workflow-template.yaml` | Template | EXISTS |
| `.yard-core/development/templates/squad/checklist-template.md` | Template | EXISTS |
| `.yard-core/development/templates/squad/template-template.md` | Template | EXISTS |
| `.yard-core/development/templates/squad/tool-template.js` | Template | EXISTS |
| `.yard-core/development/templates/squad/script-template.js` | Template | EXISTS |
| `.yard-core/development/templates/squad/data-template.yaml` | Template | EXISTS |
...
**Task file:** `.yard-core/development/tasks/squad-creator-download.md`
...
**Task file:** `.yard-core/development/tasks/squad-creator-publish.md`
**Status:** Active (Sprint 8)
...
**Task file:** `.yard-core/development/tasks/squad-creator-sync-synkra.md`
**Status:** Active (Sprint 8)
...
- `.yard-core/development/tasks/squad-creator-design.md`
- `.yard-core/development/tasks/squad-creator-create.md`
- `.yard-core/development/tasks/squad-creator-validate.md`
- `.yard-core/development/tasks/squad-creator-list.md`
- `.yard-core/development/tasks/squad-creator-migrate.md`
- `.yard-core/development/tasks/squad-creator-analyze.md`
- `.yard-core/development/tasks/squad-creator-extend.md`
- `.yard-core/development/tasks/squad-creator-download.md`
- `.yard-core/development/tasks/squad-creator-publish.md`
- `.yard-core/development/tasks/squad-creator-sync-synkra.md`
- `.yard-core/development/tasks/squad-creator-sync-ide-command.md`

**Scripts (11 files in squad/ dir, all EXISTS):**
- `.yard-core/development/scripts/squad/index.js`
- `.yard-core/development/scripts/squad/squad-loader.js`
- `.yard-core/development/scripts/squad/squad-validator.js`
- `.yard-core/development/scripts/squad/squad-generator.js`
- `.yard-core/development/scripts/squad/squad-designer.js`
- `.yard-core/development/scripts/squad/squad-migrator.js`
- `.yard-core/development/scripts/squad/squad-analyzer.js`
- `.yard-core/development/scripts/squad/squad-extender.js`
- `.yard-core/development/scripts/squad/squad-downloader.js`
- `.yard-core/development/scripts/squad/squad-publisher.js`
- `.yard-core/development/scripts/squad/README.md`

**Schemas (2 files, all EXISTS):**
- `.yard-core/schemas/squad-schema.json`
- `.yard-core/schemas/squad-design-schema.json`

**Component Templates (8 files, all EXISTS):**
- `.yard-core/development/templates/squad/agent-template.md`
- `.yard-core/development/templates/squad/task-template.md`
- `.yard-core/development/templates/squad/workflow-template.yaml`
- `.yard-core/development/templates/squad/checklist-template.md`
- `.yard-core/development/templates/squad/template-template.md`
- `.yard-core/development/templates/squad/tool-template.js`
- `.yard-core/development/templates/squad/script-template.js`
- `.yard-core/development/templates/squad/data-template.yaml`

**Squad Template Scaffold (10 files, all EXISTS):**
- `.yard-core/development/templates/squad-template/squad.yaml`
- `.yard-core/development/templates/squad-template/README.md`
- `.yard-core/development/templates/squad-template/package.json`
- `.yard-core/development/templates/squad-template/.gitignore`
- `.yard-core/development/templates/squad-template/LICENSE`
- `.yard-core/development/templates/squad-template/agents/example-agent.yaml`
- `.yard-core/development/templates/squad-template/tasks/example-task.yaml`
- `.yard-core/development/templates/squad-template/workflows/example-workflow.yaml`
- `.yard-core/development/templates/squad-template/templates/example-template.md`
- `.yard-core/development/templates/squad-template/tests/example-agent.test.js`
