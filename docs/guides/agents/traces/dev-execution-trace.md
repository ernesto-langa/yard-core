...
> Agent definition: `.yard-core/development/agents/dev.md`
...
|-------|------|--------|---------|
| 1 | `.yard-core/development/agents/dev.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.yard-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration + devLoadAlwaysFiles list |
| 3 | `.yard-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: devLoadAlwaysFiles, devStoryLocation, dataLocation |
...
| 8 | `.yard-core/data/technical-preferences.md` | AgentConfigLoader.loadFile() | Technical preferences (always loaded, 15KB) |
| 9 | `.yard/session-state.json` | ContextDetector._detectFromFile() | Session type detection (if no conversation history) |
| 10 | `.yard/project-status.yaml` | ProjectStatusLoader.loadCache() | Cached project status (60s TTL) |
...
**Task file:** `.yard-core/development/tasks/dev-develop-story.md`
...
**Task file:** `.yard-core/development/tasks/plan-execute-subtask.md`
...
**Task file:** `.yard-core/development/tasks/build-autonomous.md`
...
**Task files:** `.yard-core/development/tasks/gotcha.md`, `.yard-core/development/tasks/gotchas.md`
...
**Task files:** `.yard-core/development/tasks/create-worktree.md`, `list-worktrees.md`, `remove-worktree.md`
...
**Task file:** `.yard-core/development/tasks/qa-fix-issues.md`
...
**Task file:** `.yard-core/development/tasks/waves.md`
...
**Task file:** `.yard-core/development/tasks/create-service.md`
