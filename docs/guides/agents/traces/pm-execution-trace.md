...
> Agent definition: `.yard-core/development/agents/pm.md`
...
|-------|------|--------|---------|
| 1 | `.yard-core/development/agents/pm.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.yard-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.yard-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: devStoryLocation, storyBacklog |
...
**Template:** `.yard-core/development/templates/prd-tmpl.yaml` (MISSING in development/templates/)
...
| `.yard-core/product/templates/prd-tmpl.yaml` | Template | EXISTS (fallback) |
...
**Task file:** `.yard-core/development/tasks/create-doc.md`
**Template:** `.yard-core/development/templates/brownfield-prd-tmpl.yaml` (MISSING in development/templates/)
...
| `.yard-core/product/templates/brownfield-prd-tmpl.yaml` | Template | EXISTS (fallback) |
...
**Task file:** `.yard-core/development/tasks/brownfield-create-epic.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `brownfield-create-epic.md` | Task | EXISTS |
| `.yard-core/product/templates/prd-tmpl.yaml` | Template | EXISTS (epic structure) |
| `.yard-core/product/checklists/pm-checklist.md` | Checklist | EXISTS |
...
**Task file:** `.yard-core/development/tasks/brownfield-create-story.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `brownfield-create-story.md` | Task | EXISTS |
| `.yard-core/product/templates/story-tmpl.yaml` | Template | EXISTS (in product/templates/) |
...
**Task file:** `.yard-core/development/tasks/spec-gather-requirements.md`
...
**Task file:** `.yard-core/development/tasks/spec-write-spec.md`
...
| Module | Path | Status |
|--------|------|--------|
| TerminalSpawner | `.yard-core/core/orchestration/terminal-spawner.js` | EXISTS |
| ExecutorAssignment | `.yard-core/core/orchestration/executor-assignment.js` | EXISTS |
| PM Script | `.yard-core/scripts/pm.sh` | EXISTS |
...
**Note:** All 9 task files referenced in dependencies exist in `.yard-core/development/tasks/`. The 2 templates and 2 checklists are missing from `development/` but exist in `product/` as fallback locations.
