...
| `*list-components` | (built-in, scans .yard-core/) | full | No |
...
**Task file:** `.yard-core/development/tasks/kb-mode-interaction.md`
...
**Task files:** `.yard-core/development/tasks/create-agent.md`, `create-task.md`, `create-workflow.md`
...
| `agent-template.yaml` | Template | EXISTS (in .yard-core/product/templates/) |
| `task-template.md` | Template | EXISTS (in .yard-core/product/templates/) |
| `workflow-template.yaml` | Template | EXISTS (in .yard-core/product/templates/) |
| `security-checker.js` | Util | EXISTS (in .yard-core/infrastructure/scripts/) |
| `yaml-validator.js` | Util | EXISTS (in .yard-core/infrastructure/scripts/) |
...
flowchart TD
    ...
    M --> N{Validation pass?}
    N -->|yes| O[Write component to .yard-core/development/{type}/]
...
**Task files:** `.yard-core/development/tasks/modify-agent.md`, `modify-task.md`, `modify-workflow.md`
...
**Task file:** `.yard-core/development/tasks/update-manifest.md`
...
**Task file:** `.yard-core/development/tasks/deprecate-component.md`
...
**Task file:** `.yard-core/development/tasks/propose-modification.md`
...
**Task file:** `.yard-core/development/tasks/undo-last.md`
...
**Task file:** `.yard-core/development/tasks/validate-workflow.md`
...
| `yaml-validator.js` | Util | EXISTS |
| `.yard-core/development/workflows/{name}.yaml` | Workflow | Dynamically loaded |
...
**Task files:** `.yard-core/development/tasks/run-workflow.md`, `run-workflow-engine.md`
**Template:** `.yard-core/development/templates/subagent-step-prompt.md`
...
| `subagent-step-prompt.md` | Template | EXISTS (in .yard-core/development/templates/) |
| `workflow-management.md` | Util | EXISTS (in .yard-core/scripts/) |
| `.yard-core/development/workflows/{name}.yaml` | Workflow | Dynamically loaded |
...
**Task file:** `.yard-core/development/tasks/analyze-framework.md`
...
flowchart TD
    ...
    B --> C[Scan .yard-core/ directory structure]
...
**Task file:** `.yard-core/development/tasks/execute-checklist.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `execute-checklist.md` | Task | EXISTS |
| `.yard-core/product/checklists/{checklist}.md` | Checklist | Dynamically loaded |
...
flowchart TD
    ...
    B --> C{Name provided?}
    C -->|yes| D[Resolve checklist from .yard-core/product/checklists/]
...
**Templates:** All 15 templates from `.yard-core/product/templates/`
...
| `.yard-core/product/data/elicitation-methods.md` | Data | EXISTS |
...
flowchart TD
    ...
    C -->|yes| D[Load template from .yard-core/product/templates/]
...
**Task file:** `.yard-core/development/tasks/shard-doc.md`
...
**Task file:** `.yard-core/development/tasks/document-project.md`
...
**Task file:** `.yard-core/development/tasks/add-tech-doc.md` (MISSING)
...
**Task file:** `.yard-core/development/tasks/create-next-story.md`
...
**Task file:** `.yard-core/development/tasks/advanced-elicitation.md`
...
**Task file:** `.yard-core/development/tasks/correct-course.md`
...
**Task file:** `.yard-core/development/tasks/index-docs.md`
...
|------------|---------------|-------------|
| `security-checker.js` | `.yard-core/development/utils/` | `.yard-core/infrastructure/scripts/security-checker.js` |
| `yaml-validator.js` | `.yard-core/development/utils/` | `.yard-core/infrastructure/scripts/yaml-validator.js` |
| `workflow-management.md` | `.yard-core/development/utils/` | `.yard-core/scripts/workflow-management.md` |
| `subagent-step-prompt.md` | `.yard-core/product/templates/` | `.yard-core/development/templates/subagent-step-prompt.md` |
| `elicitation-methods.md` | `.yard-core/data/` | `.yard-core/product/data/elicitation-methods.md` |
| `brainstorming-techniques.md` | `.yard-core/data/` | `.yard-core/product/data/brainstorming-techniques.md` |
