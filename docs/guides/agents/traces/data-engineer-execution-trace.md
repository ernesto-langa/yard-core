...
> Agent definition: `.yard-core/development/agents/data-engineer.md`
...
|-------|------|--------|---------|
| 1 | `.yard-core/development/agents/data-engineer.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.yard-core/core-config.yaml` | generate-greeting.js (CLI wrapper) | Core configuration |
| 3 | `.yard-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation, etlLocation |
...
| 6 | `.yard/session-state.json` | SessionContextLoader.loadContext() | Session type detection (CLI wrapper pre-loads) |
...
> to GreetingBuilder. See `.yard-core/development/scripts/generate-greeting.js`.
...
**Template:** `.yard-core/development/templates/schema-design-tmpl.yaml` (MISSING)
...
| `.yard-core/data/technical-preferences.md` | Data | Loaded at activation |
...
**Task file:** `.yard-core/development/tasks/create-doc.md`
**Template:** `.yard-core/development/templates/rls-policies-tmpl.yaml` (MISSING)
...
**Task file:** `.yard-core/development/tasks/create-doc.md`
**Template:** `.yard-core/development/templates/migration-plan-tmpl.yaml` (MISSING)
...
**Task file:** `.yard-core/development/tasks/create-doc.md`
**Template:** `.yard-core/development/templates/index-strategy-tmpl.yaml` (MISSING)
...
**Task file:** `.yard-core/development/tasks/db-domain-modeling.md`
...
**Task file:** `.yard-core/development/tasks/db-env-check.md`
...
**Task file:** `.yard-core/development/tasks/db-bootstrap.md`
...
**Task file:** `.yard-core/development/tasks/db-apply-migration.md`
...
**Task file:** `.yard-core/development/tasks/db-dry-run.md`
...
**Task file:** `.yard-core/development/tasks/db-seed.md`
...
**Task file:** `.yard-core/development/tasks/db-snapshot.md`
...
**Task file:** `.yard-core/development/tasks/db-rollback.md`
...
**Task file:** `.yard-core/development/tasks/db-smoke-test.md`
...
**Task file:** `.yard-core/development/tasks/security-audit.md`
...
**Task file:** `.yard-core/development/tasks/analyze-performance.md`
...
**Task file:** `.yard-core/development/tasks/db-policy-apply.md`
...
**Task file:** `.yard-core/development/tasks/test-as-user.md`
...
**Task file:** `.yard-core/development/tasks/db-verify-order.md`
...
**Task file:** `.yard-core/development/tasks/db-load-csv.md`
...
**Task file:** `.yard-core/development/tasks/db-run-sql.md`
...
**Task file:** `.yard-core/development/tasks/setup-database.md`
...
flowchart TD
    ...
    B --> C[Resolve checklist from .yard-core/development/checklists/]
...
**Task file:** `.yard-core/development/tasks/create-deep-research-prompt.md`
