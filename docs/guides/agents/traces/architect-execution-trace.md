...
> Agent definition: `.yard-core/development/agents/architect.md`
...
|-------|------|--------|---------|
| 1 | `.yard-core/development/agents/architect.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.yard-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.yard-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: architecture, dataLocation, templatesLocation |
...
**Template:** `.yard-core/development/templates/fullstack-architecture-tmpl.yaml` (MISSING)
...
| `.yard-core/data/elicitation-methods` | Data | Referenced by create-doc |
| `.yard-core/product/templates/` | Templates dir | Scanned dynamically |
...
**Task file:** `.yard-core/development/tasks/create-doc.md`
**Template:** `.yard-core/development/templates/architecture-tmpl.yaml` (MISSING)
...
**Task file:** `.yard-core/development/tasks/create-doc.md`
**Template:** `.yard-core/development/templates/front-end-architecture-tmpl.yaml` (MISSING)
...
**Task file:** `.yard-core/development/tasks/create-doc.md`
**Template:** `.yard-core/development/templates/brownfield-architecture-tmpl.yaml` (MISSING)
...
| `.yard-core/scripts/execute-task.js` | Script | Referenced |
...
flowchart TD
    ...
    B --> C[Resolve checklist file from .yard-core/product/checklists/]
...
**Task file:** `.yard-core/development/tasks/analyze-project-structure.md`
...
**Task file:** `.yard-core/development/tasks/validate-tech-preset.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `validate-tech-preset.md` | Task | EXISTS |
| `.yard-core/data/tech-presets/{name}.md` | Data | Validated |
| `.yard-core/data/tech-presets/_template.md` | Template | Reference |
...
flowchart TD
    ...
    B --> C[Load preset from .yard-core/data/tech-presets/{name}.md]
...
**Task file:** `.yard-core/development/tasks/spec-assess-complexity.md`
...
**Task file:** `.yard-core/development/tasks/plan-create-implementation.md`
...
**Task file:** `.yard-core/development/tasks/plan-create-context.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `plan-create-context.md` | Task | EXISTS |
| `.yard-core/core-config.yaml` | Config | Required |
...
**Script:** `.yard-core/development/scripts/codebase-mapper.js` (MISSING)
