...
> Agent definition: `.yard-core/development/agents/devops.md`
...
|-------|------|--------|---------|
| 1 | `.yard-core/development/agents/devops.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.yard-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.yard-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation, cicdLocation |
...
| 6 | `.yard/session-state.json` | ContextDetector._detectFromFile() | Session type detection (if no conversation history) |
| 7 | `.yard/project-status.yaml` | ProjectStatusLoader.loadCache() | Cached project status (60s TTL) |
...
**Task file:** `.yard-core/development/tasks/github-devops-pre-push-quality-gate.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `github-devops-pre-push-quality-gate.md` | Task | EXISTS |
| `pre-push-checklist.md` | Checklist | EXISTS (at `.yard-core/product/checklists/`) |
...
|------|------|--------|
| `github-devops-pre-push-quality-gate.md` | Task | EXISTS |
| `repository-detector.js` | Script | EXISTS (at `.yard-core/infrastructure/scripts/`) |
...
**Task file:** `.yard-core/development/tasks/github-devops-github-pr-automation.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `github-devops-github-pr-automation.md` | Task | EXISTS |
| `github-pr-template.md` | Template | EXISTS (at `.yard-core/product/templates/`) |
...
**Task file:** `.yard-core/development/tasks/github-devops-version-management.md`
...
**Task file:** `.yard-core/development/tasks/release-management.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `release-management.md` | Task | EXISTS |
| `changelog-template.md` | Template | EXISTS (at `.yard-core/product/templates/`) |
| `release-checklist.md` | Checklist | EXISTS (at `.yard-core/product/checklists/`) |
...
**Task file:** `.yard-core/development/tasks/ci-cd-configuration.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `ci-cd-configuration.md` | Task | EXISTS |
| `github-actions-ci.yml` | Template | EXISTS (at `.yard-core/product/templates/`) |
| `github-actions-cd.yml` | Template | EXISTS (at `.yard-core/product/templates/`) |
...
**Task file:** `.yard-core/development/tasks/github-devops-repository-cleanup.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `github-devops-repository-cleanup.md` | Task | EXISTS |
| `branch-manager.js` | Script | EXISTS (at `.yard-core/infrastructure/scripts/`) |
...
**Task file:** `.yard-core/development/tasks/environment-bootstrap.md`
...
**Task file:** `.yard-core/development/tasks/setup-github.md`
...
**Task file:** `.yard-core/development/tasks/check-docs-links.md`
...
**Workflow file:** `.yard-core/development/workflows/auto-worktree.yaml` (EXISTS)
...
**Scripts:** `.yard-core/infrastructure/scripts/asset-inventory.js`, `path-analyzer.js`, `migrate-agent.js`
...
**Task file:** `.yard-core/development/tasks/init-project-status.md`
...
flowchart TD
    ...
    D --> E["Create: .yard/project-status.yaml"]
...
|------|------|-------------------|-----------------|--------|
| `github-pr-template.md` | Template | `.yard-core/development/templates/` | `.yard-core/product/templates/` | Path mismatch -- file exists but at different path |
| `github-actions-ci.yml` | Template | `.yard-core/development/templates/` | `.yard-core/product/templates/` | Path mismatch -- file exists but at different path |
| `github-actions-cd.yml` | Template | `.yard-core/development/templates/` | `.yard-core/product/templates/` | Path mismatch -- file exists but at different path |
| `changelog-template.md` | Template | `.yard-core/development/templates/` | `.yard-core/product/templates/` | Path mismatch -- file exists but at different path |
| `pre-push-checklist.md` | Checklist | `.yard-core/development/checklists/` | `.yard-core/product/checklists/` | Path mismatch -- file exists but at different path |
| `release-checklist.md` | Checklist | `.yard-core/development/checklists/` | `.yard-core/product/checklists/` | Path mismatch -- file exists but at different path |
| `gitignore-manager` | Util | `.yard-core/development/utils/` | (not found anywhere) | MISSING -- command may fall back to manual gitignore handling |
| `version-tracker` | Util | `.yard-core/development/utils/` | (not found anywhere) | MISSING -- version tracking relies on git tags and package.json |

**Note on path resolution:** The `dependencies.templates` and `dependencies.checklists` in the agent YAML resolve via `IDE-FILE-RESOLUTION` to `.yard-core/development/{type}/{name}`. However, all 4 templates and 2 checklists actually reside in `.yard-core/product/{type}/`. The 3 infrastructure scripts (`asset-inventory.js`, `path-analyzer.js`, `migrate-agent.js`) and 3 utils (`branch-manager.js`, `repository-detector.js`, `git-wrapper.js`) exist at `.yard-core/infrastructure/scripts/`, not at the declared path.
