...
| Arquivo | Proposito |
|---------|-----------|
| `.yard-core/development/agents/pm.md` | Definicao core do agente PM |
...
|---------|---------|-----------|
| `.yard-core/development/tasks/create-doc.md` | `*create-prd` | Cria documentos a partir de templates YAML |
| `.yard-core/development/tasks/correct-course.md` | `*correct-course` | Analisa e corrige desvios de projeto |
| `.yard-core/development/tasks/create-deep-research-prompt.md` | `*research` | Gera prompts de pesquisa profunda |
| `.yard-core/development/tasks/brownfield-create-epic.md` | `*create-epic` | Cria epics para projetos brownfield |
| `.yard-core/development/tasks/brownfield-create-story.md` | `*create-story` | Cria stories para brownfield |
| `.yard-core/development/tasks/execute-checklist.md` | `*checklist` | Executa validacao de checklists |
| `.yard-core/development/tasks/shard-doc.md` | `*shard-prd` | Fragmenta documentos grandes |

### Templates do @pm

| Arquivo | Proposito |
|---------|-----------|
| `.yard-core/product/templates/prd-tmpl.yaml` | Template PRD para projetos greenfield |
| `.yard-core/product/templates/brownfield-prd-tmpl.yaml` | Template PRD para projetos brownfield |

### Checklists do @pm

| Arquivo | Proposito |
|---------|-----------|
| `.yard-core/product/checklists/pm-checklist.md` | Checklist de validacao de PRD |
| `.yard-core/product/checklists/change-checklist.md` | Checklist para navegacao de mudancas |

### Workflows que Utilizam o @pm

| Arquivo | Fase | Proposito |
|---------|------|-----------|
| `.yard-core/development/workflows/brownfield-discovery.yaml` | Fase 10 | Criacao de epics e stories pos-discovery |
...
**Solucao:**
- Verifique `.yard-core/product/templates/`
...
- [Agent Definition: pm.md](.yard-core/development/agents/pm.md)
- [Task: create-doc.md](.yard-core/development/tasks/create-doc.md)
- [Task: brownfield-create-epic.md](.yard-core/development/tasks/brownfield-create-epic.md)
- [Task: correct-course.md](.yard-core/development/tasks/correct-course.md)
- [Template: prd-tmpl.yaml](.yard-core/product/templates/prd-tmpl.yaml)
- [Template: brownfield-prd-tmpl.yaml](.yard-core/product/templates/brownfield-prd-tmpl.yaml)
- [Checklist: pm-checklist.md](.yard-core/product/checklists/pm-checklist.md)
