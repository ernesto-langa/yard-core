...
|---------|---------|-----------|
| `.yard-core/development/tasks/sm-create-next-story.md` | `*draft` | Task principal para criar proxima story do backlog |
| `.yard-core/development/tasks/create-next-story.md` | `*draft` | Versao completa da task de criacao de story |
| `.yard-core/development/tasks/execute-checklist.md` | `*story-checklist` | Executa checklist de validacao de story draft |
| `.yard-core/development/tasks/correct-course.md` | `*correct-course` | Analisa e corrige desvios de processo |
| `.yard-core/development/tasks/collaborative-edit.md` | - | Edicao colaborativa de documentos |
| `.yard-core/development/tasks/init-project-status.md` | - | Inicializacao de status do projeto |

### Arquivos de Definicao do Agente

| Arquivo | Proposito |
|---------|-----------|
| `.yard-core/development/agents/sm.md` | Definicao core do agente SM |
...
| Arquivo | Proposito |
|---------|-----------|
| `.yard-core/product/checklists/story-draft-checklist.md` | Valida qualidade e completude de story drafts |
| `.yard-core/product/checklists/story-dod-checklist.md` | Definition of Done para stories |
| `.yard-core/product/checklists/change-checklist.md` | Navegacao de mudancas e correcao de curso |
| `.yard-core/product/checklists/po-master-checklist.md` | Checklist mestre usado em validacao |

### Arquivos Relacionados de Outros Agentes

| Arquivo | Agente | Proposito |
|---------|--------|-----------|
| `.yard-core/development/agents/po.md` | @po | Coordena com @sm em backlog e sprint planning |
| `.yard-core/development/agents/dev.md` | @dev | Recebe stories do @sm para implementacao |
| `.yard-core/development/agents/pm.md` | @pm | Cria epics que @sm quebra em stories |
| `.yard-core/development/agents/devops.md` | @github-devops | Recebe stories completas para push/PR |
| `.yard-core/development/agents/qa.md` | @qa | Coordena em risk profiling |

### Arquivos de Workflows que Utilizam @sm

| Arquivo | Proposito |
|---------|-----------|
| `.yard-core/development/workflows/story-development-cycle.yaml` | Ciclo completo de desenvolvimento de stories |
| `.yard-core/development/workflows/greenfield-fullstack.yaml` | Workflow greenfield full-stack |
| `.yard-core/development/workflows/greenfield-service.yaml` | Workflow greenfield service |
| `.yard-core/development/workflows/greenfield-ui.yaml` | Workflow greenfield UI |
| `.yard-core/development/workflows/brownfield-fullstack.yaml` | Workflow brownfield full-stack |
| `.yard-core/development/workflows/brownfield-service.yaml` | Workflow brownfield service |
| `.yard-core/development/workflows/brownfield-ui.yaml` | Workflow brownfield UI |

### Arquivos de Configuracao

| Arquivo | Proposito |
|---------|-----------|
| `.yard-core/core-config.yaml` | Configuracao central (devStoryLocation, etc.) |
| `.yard-core/development/scripts/greeting-builder.js` | Script de saudacao inteligente |
| `.yard-core/development/scripts/agent-assignment-resolver.js` | Resolucao de assignment de agentes |
...
### Arquivos do Agente
- [Agent: sm.md](.yard-core/development/agents/sm.md)
- [Task: create-next-story.md](.yard-core/development/tasks/create-next-story.md)
- [Task: execute-checklist.md](.yard-core/development/tasks/execute-checklist.md)
- [Task: correct-course.md](.yard-core/development/tasks/correct-course.md)

### Checklists
- [Checklist: story-draft-checklist.md](.yard-core/product/checklists/story-draft-checklist.md)
- [Checklist: story-dod-checklist.md](.yard-core/product/checklists/story-dod-checklist.md)
- [Checklist: change-checklist.md](.yard-core/product/checklists/change-checklist.md)

### Workflows
- [Workflow: story-development-cycle.yaml](.yard-core/development/workflows/story-development-cycle.yaml)
- [Workflow: greenfield-fullstack.yaml](.yard-core/development/workflows/greenfield-fullstack.yaml)
- [Workflow: brownfield-fullstack.yaml](.yard-core/development/workflows/brownfield-fullstack.yaml)
