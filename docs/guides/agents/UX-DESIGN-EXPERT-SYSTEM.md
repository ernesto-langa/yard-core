...
Este documento descreve o sistema completo do agente **UX-Design Expert (Uma)**, incluindo todos os arquivos envolvidos, fluxos de trabalho, comandos disponiveis, integracoes com outros agentes e workflows YARD.
...
| Arquivo | Proposito |
|---------|-----------|
| `.yard-core/development/agents/ux-design-expert.md` | Definicao completa do agente (persona, comandos, workflows) |
| `.claude/commands/YARD/agents/ux-design-expert.md` | Comando Claude Code para ativar @ux-design-expert |
...
|---------|---------|-----------|
| `.yard-core/development/tasks/ux-user-research.md` | `*research` | Conduzir pesquisa de usuario, criar personas e jornadas |
| `.yard-core/development/tasks/ux-create-wireframe.md` | `*wireframe` | Criar wireframes low/mid/high fidelity |
| `.yard-core/development/tasks/generate-ai-frontend-prompt.md` | `*generate-ui-prompt` | Gerar prompts para v0.dev, Lovable.ai |
| `.yard-core/development/tasks/create-doc.md` | `*create-front-end-spec` | Criar especificacao frontend detalhada |

#### Fase 2: Design System Audit (3 tasks)

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.yard-core/development/tasks/audit-codebase.md` | `*audit {path}` | Escanear codebase para redundancias UI |
| `.yard-core/development/tasks/consolidate-patterns.md` | `*consolidate` | Reduzir redundancia com clustering HSL |
| `.yard-core/development/tasks/generate-shock-report.md` | `*shock-report` | Gerar relatorio visual HTML |

#### Fase 3: Design Tokens & Setup (7 tasks)

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.yard-core/development/tasks/extract-tokens.md` | `*tokenize` | Extrair design tokens (YAML, JSON, CSS, DTCG) |
| `.yard-core/development/tasks/setup-design-system.md` | `*setup` | Inicializar estrutura do design system |
| `.yard-core/development/tasks/generate-migration-strategy.md` | `*migrate` | Gerar estrategia de migracao em 4 fases |
| `.yard-core/development/tasks/tailwind-upgrade.md` | `*upgrade-tailwind` | Upgrade para Tailwind CSS v4 |
| `.yard-core/development/tasks/audit-tailwind-config.md` | `*audit-tailwind-config` | Validar configuracao Tailwind |
| `.yard-core/development/tasks/export-design-tokens-dtcg.md` | `*export-dtcg` | Exportar tokens W3C DTCG |
| `.yard-core/development/tasks/bootstrap-shadcn-library.md` | `*bootstrap-shadcn` | Instalar Shadcn/Radix UI |

#### Fase 4: Atomic Component Building (3 tasks)

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.yard-core/development/tasks/build-component.md` | `*build {component}` | Construir componente atomico (React + TypeScript) |
| `.yard-core/development/tasks/compose-molecule.md` | `*compose {molecule}` | Compor molecule de atoms existentes |
| `.yard-core/development/tasks/extend-pattern.md` | `*extend {component}` | Adicionar variante a componente existente |

#### Fase 5: Quality & Documentation (3 tasks)

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.yard-core/development/tasks/generate-documentation.md` | `*document` | Gerar documentacao do pattern library |
| `.yard-core/development/tasks/calculate-roi.md` | `*calculate-roi` | Calcular ROI e cost savings |
| `.yard-core/development/checklists/accessibility-wcag-checklist.md` | `*a11y-check` | Auditoria de acessibilidade WCAG |

#### Tasks Universais (2 tasks)

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.yard-core/development/tasks/ux-ds-scan-artifact.md` | `*scan {path\|url}` | Analisar HTML/React para extrair padroes |
| `.yard-core/development/tasks/integrate-Squad.md` | `*integrate {squad}` | Conectar com expansion squad |

### Templates

| Arquivo | Proposito |
|---------|-----------|
| `.yard-core/development/templates/front-end-spec-tmpl.yaml` | Template de especificacao frontend |
| `.yard-core/development/templates/tokens-schema-tmpl.yaml` | Schema de design tokens |
| `.yard-core/development/templates/component-react-tmpl.tsx` | Template de componente React |
| `.yard-core/development/templates/state-persistence-tmpl.yaml` | Template de persistencia de estado |
| `.yard-core/development/templates/shock-report-tmpl.html` | Template de shock report HTML |
| `.yard-core/development/templates/migration-strategy-tmpl.md` | Template de estrategia de migracao |
| `.yard-core/development/templates/token-exports-css-tmpl.css` | Template de export CSS |
| `.yard-core/development/templates/token-exports-tailwind-tmpl.js` | Template de export Tailwind |
| `.yard-core/development/templates/ds-artifact-analysis.md` | Template de analise de artefato |

### Checklists

| Arquivo | Proposito |
|---------|-----------|
| `.yard-core/development/checklists/pattern-audit-checklist.md` | Checklist de auditoria de padroes |
| `.yard-core/development/checklists/component-quality-checklist.md` | Checklist de qualidade de componente |
| `.yard-core/development/checklists/accessibility-wcag-checklist.md` | Checklist WCAG AA/AAA |
| `.yard-core/development/checklists/migration-readiness-checklist.md` | Checklist de readiness para migracao |

### Data Files

| Arquivo | Proposito |
|---------|-----------|
| `.yard-core/development/data/technical-preferences.md` | Preferencias tecnicas padrao |
| `.yard-core/development/data/atomic-design-principles.md` | Principios Atomic Design |
| `.yard-core/development/data/design-token-best-practices.md` | Best practices de design tokens |
| `.yard-core/development/data/consolidation-algorithms.md` | Algoritmos de consolidacao |
| `.yard-core/development/data/roi-calculation-guide.md` | Guia de calculo de ROI |
| `.yard-core/development/data/integration-patterns.md` | Padroes de integracao |
| `.yard-core/development/data/wcag-compliance-guide.md` | Guia de conformidade WCAG |

### Workflows Relacionados

| Arquivo | Proposito |
|---------|-----------|
| `.yard-core/development/workflows/design-system-build-quality.yaml` | Pipeline pos-migracao (build, docs, a11y, ROI) |
| `.yard-core/development/workflows/brownfield-ui.yaml` | Workflow para UI brownfield |
| `.yard-core/development/workflows/brownfield-discovery.yaml` | Discovery para projetos existentes |
| `.yard-core/development/workflows/greenfield-ui.yaml` | Workflow para UI greenfield |
...
- [ux-user-research.md](../../.yard-core/development/tasks/ux-user-research.md)
- [ux-create-wireframe.md](../../.yard-core/development/tasks/ux-create-wireframe.md)
- [audit-codebase.md](../../.yard-core/development/tasks/audit-codebase.md)
- [consolidate-patterns.md](../../.yard-core/development/tasks/consolidate-patterns.md)
- [extract-tokens.md](../../.yard-core/development/tasks/extract-tokens.md)
- [build-component.md](../../.yard-core/development/tasks/build-component.md)
- [calculate-roi.md](../../.yard-core/development/tasks/calculate-roi.md)

### Arquivos de Workflow

- [design-system-build-quality.yaml](../../.yard-core/development/workflows/design-system-build-quality.yaml)
- [brownfield-ui.yaml](../../.yard-core/development/workflows/brownfield-ui.yaml)

### Definicao do Agente

- [ux-design-expert.md](../../.yard-core/development/agents/ux-design-expert.md)
