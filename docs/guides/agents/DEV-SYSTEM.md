...
| Arquivo | Proposito |
|---------|-----------|
| `.yard-core/development/agents/dev.md` | Definicao core do agente @dev (persona, comandos, workflows) |
...
| `.yard-core/development/scripts/greeting-builder.js` | Constroi greeting adaptativo |
