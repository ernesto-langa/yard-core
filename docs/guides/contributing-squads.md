...
2. **Yard Marketplace** - Premium squads via Yard API
...
This will:
1. Fork `YardAI/yard-squads` (if needed)
...
## Publishing to Yard Marketplace
...
- **Questions**: [GitHub Discussions](https://github.com/ernesto-langa/yard-core/discussions)
