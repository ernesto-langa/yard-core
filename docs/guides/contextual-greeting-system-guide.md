...
### Configuration
- `.yard-core/core-config.yaml` - Configuração global (git + agentIdentity sections)

### Agents (Updated)
- `.yard-core/agents/dev.md` - ✅ Command visibility metadata
- `.yard-core/agents/po.md` - ✅ Command visibility metadata
- `.yard-core/agents/*.md` - ⏳ Remaining 9 agents (pending update)
...
A: Use o script de teste: `node .yard-core/development/scripts/test-greeting-system.js`
