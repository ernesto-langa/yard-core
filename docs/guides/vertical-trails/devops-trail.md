...
✅ Repositório criado: github.com/seu-user/my-yard-project
...
📋 CI Pipeline triggered:
  https://github.com/seu-user/my-yard-project/actions/runs/xxxxx
```
...
Release URL:
  https://github.com/seu-user/my-yard-project/releases/tag/v1.1.0
```
