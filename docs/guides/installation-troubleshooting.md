...
2. **Run diagnostics**: `npx yard-core@latest doctor`
3. **Check system info**: `npx yard-core@latest info`
...
| Command | Description |
|---------|-------------|
| `npx yard-core@latest` | Install/run wizard |
| `npx yard-core@latest --version` | Show version |
| `npx yard-core@latest --help` | Show help |
| `npx yard-core@latest install` | Install in current dir |
