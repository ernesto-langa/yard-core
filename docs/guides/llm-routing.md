...
**Option 1: If you have yard-core cloned**
```bash
# From yard-core directory
node .yard-core/infrastructure/scripts/llm-routing/install-llm-routing.js
```
...
**Windows:** `.yard-core/infrastructure/scripts/llm-routing/templates/claude-free.cmd`
**Unix:** `.yard-core/infrastructure/scripts/llm-routing/templates/claude-free.sh`
...
- **Tool Definition:** `.yard-core/infrastructure/tools/cli/llm-routing.yaml`
- **Install Script:** `.yard-core/infrastructure/scripts/llm-routing/install-llm-routing.js`
- **Task Definition:** `.yard-core/development/tasks/setup-llm-routing.md`
...
*Generated by YARD Framework - Story 6.7*
