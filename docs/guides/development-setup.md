...
1. Navigate to [github.com/ernesto-langa/yard-core](https://github.com/ernesto-langa/yard-core)
...
Understanding the `yard-core` directory structure:

```
yard-core/
├── .yard-core/                    # Framework source (committed)
...
| ----------------------------------- | ---------------------------- | ----------------------- |
| `.yard-core/development/agents/`    | Agent personas and behaviors | Adding/modifying agents |
| `.yard-core/development/tasks/`     | Executable task workflows    | Adding/modifying tasks  |
| `.yard-core/development/workflows/` | Multi-step orchestrations    | Creating workflows      |
...
Create a new file in `.yard-core/development/agents/`:

```bash
# File: .yard-core/development/agents/my-agent.md
```
...
dependencies:
  tasks:
    - my-agent-task.md       # Create in .yard-core/development/tasks/
  checklists:
    - my-agent-checklist.md  # Create in .yard-core/development/checklists/
  tools:
    - git
    - context7
````
...
Create a new file in `.yard-core/development/tasks/`:
...
# Examples:
# .yard-core/development/tasks/dev-build-component.md  (dev agent)
# .yard-core/development/tasks/create-doc.md          (shared)
```
...
Create a new file in `.yard-core/development/workflows/`:

```bash
# File: .yard-core/development/workflows/my-workflow.yaml
```
