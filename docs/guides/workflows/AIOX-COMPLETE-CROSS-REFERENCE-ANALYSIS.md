# YARD Complete Cross-Reference Analysis
...
This document is the result of a comprehensive cross-reference analysis of every artifact in the YARD-Framework framework. The analysis was conducted in 7 phases, examining 25 entity types totaling approximately 745 tracked files.
...
|-------------|-------|----------|
| Agents | 12 | `.yard-core/development/agents/` |
| Tasks | 191 | `.yard-core/development/tasks/` |
| Workflows | 12 | `.yard-core/development/workflows/` |
| Product Templates | 92 | `.yard-core/product/templates/` |
| Development Templates | 29 | `.yard-core/development/templates/` |
| Product Checklists | 16 | `.yard-core/product/checklists/` |
| Product Data | 16 | `.yard-core/product/data/` |
| Framework Data | 8 | `.yard-core/data/` |
| Dev Scripts | 37 | `.yard-core/development/scripts/` |
| Infra Scripts | 90 | `.yard-core/infrastructure/scripts/` |
| Infra Integrations | 5 | `.yard-core/infrastructure/integrations/` |
| Infra Tools | 15 | `.yard-core/infrastructure/tools/` |
| Infra Templates | 15 | `.yard-core/infrastructure/templates/` |
| Core Modules | 130 | `.yard-core/core/` |
| CLI Commands | 37 | `.yard-core/cli/commands/` |
| Schemas | 6 | `.yard-core/schemas/` |
| Manifests | 4 | `.yard-core/manifests/` |
| Monitor Hooks | 10 | `.yard-core/monitor/hooks/` |
| Quality Gates | 10 | `.yard-core/core/quality-gates/` |
| Quality Metrics | 4 | `.yard-core/quality/` |
| Workflow Intelligence | 19 | `.yard-core/workflow-intelligence/` |
| Docs/Standards | 16 | `.yard-core/docs/standards/` |
| Root Config | 8 | `.yard-core/` root |
| Elicitation | 8 | `.yard-core/core/elicitation/` + `.yard-core/elicitation/` |
| **TOTAL** | **~745** | |
...
### 3.11 @yard-master (Orion) - Meta Orchestrator
...
DATA FILES (4):
  yard-kb.md, agent-config-requirements.yaml,
...
| File | Location |
|------|----------|
| `YARD-LIVRO-DE-OURO.md` | `docs/standards/` |
| `YARD-LIVRO-DE-OURO-V2.1.md` | `docs/standards/` |
| `YARD-LIVRO-DE-OURO-V2.1-SUMMARY.md` | `docs/standards/` |
| `YARD-FRAMEWORK-MASTER.md` | `docs/standards/` |
...
|-----------|--------|---------------|
| `.yard-core/agent-teams/` | Does not exist | install-manifest, source-tree docs, core-architecture |
| `.yard-core/tools/` | Exists but empty | core-config.yaml, framework-config.yaml |
| `.yard-core/processes/` | Does not exist | Not referenced |
...
- **infrastructure/** has ZERO dependencies on other YARD modules
...
10. **Populate or remove `.yard-core/tools/`** -- Currently empty despite config references.
