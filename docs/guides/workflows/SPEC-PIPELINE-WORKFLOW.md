...
|------|------|--------|---------|
| Gather Requirements | 1 | @pm | `.yard-core/development/tasks/spec-gather-requirements.md` |
| Assess Complexity | 2 | @architect | `.yard-core/development/tasks/spec-assess-complexity.md` |
| Research Dependencies | 3 | @analyst | `.yard-core/development/tasks/spec-research-dependencies.md` |
| Write Specification | 4 | @pm | `.yard-core/development/tasks/spec-write-spec.md` |
| Critique Specification | 5, 5c | @qa | `.yard-core/development/tasks/spec-critique.md` |
| Create Implementation Plan | 6 | @architect | `.yard-core/development/tasks/plan-create-implementation.md` |
...
| Arquivo | Localizacao |
|---------|-------------|
| Definicao do Workflow | `.yard-core/development/workflows/spec-pipeline.yaml` |
| Task: Gather | `.yard-core/development/tasks/spec-gather-requirements.md` |
| Task: Assess | `.yard-core/development/tasks/spec-assess-complexity.md` |
| Task: Research | `.yard-core/development/tasks/spec-research-dependencies.md` |
| Task: Write Spec | `.yard-core/development/tasks/spec-write-spec.md` |
| Task: Critique | `.yard-core/development/tasks/spec-critique.md` |
| Task: Create Plan | `.yard-core/development/tasks/plan-create-implementation.md` |
...
metadata:
  ...
  baseado_em:
    - .yard-core/development/workflows/spec-pipeline.yaml
    - .yard-core/development/tasks/spec-*.md
