...
4. **Templates Disponiveis**
   - `.yard-core/development/templates/brownfield-prd-tmpl.yaml`
   - `.yard-core/development/templates/brownfield-architecture-tmpl.yaml`
   - `.yard-core/development/templates/story-tmpl.yaml`

5. **Checklists Disponiveis**
   - `.yard-core/development/checklists/po-master-checklist.md`
   - `.yard-core/development/checklists/story-draft-checklist.md`
   - `.yard-core/development/checklists/story-dod-checklist.md`
...
|---------|-----------|---------|
| Workflow Definition | Definicao YAML do workflow | `.yard-core/development/workflows/brownfield-service.yaml` |
| PRD Template | Template para brownfield PRD | `.yard-core/development/templates/brownfield-prd-tmpl.yaml` |
| Architecture Template | Template para arquitetura | `.yard-core/development/templates/brownfield-architecture-tmpl.yaml` |
| Story Template | Template para stories | `.yard-core/development/templates/story-tmpl.yaml` |
| PO Master Checklist | Checklist de validacao | `.yard-core/development/checklists/po-master-checklist.md` |
| Story Draft Checklist | Checklist de story | `.yard-core/development/checklists/story-draft-checklist.md` |
| Story DoD Checklist | Definition of Done | `.yard-core/development/checklists/story-dod-checklist.md` |

### Agentes

| Agente | Arquivo | Caminho |
|--------|---------|---------|
| @architect | Aria | `.yard-core/development/agents/architect.md` |
| @pm | Morgan | `.yard-core/development/agents/pm.md` |
| @po | Pax | `.yard-core/development/agents/po.md` |
| @sm | River | `.yard-core/development/agents/sm.md` |
| @analyst | Atlas | `.yard-core/development/agents/analyst.md` |
| @dev | Dex | `.yard-core/development/agents/dev.md` |
| @qa | Quinn | `.yard-core/development/agents/qa.md` |

### Documentacao Relacionada

- [AIOX Knowledge Base](../../../.yard-core/data/aiox-kb.md) - Base de conhecimento do framework
- [Technical Preferences](../../../.yard-core/development/data/technical-preferences.md) - Preferencias tecnicas do projeto
