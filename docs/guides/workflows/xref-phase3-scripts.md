...
> **Scope:** `.yard-core/development/scripts/` (38 files)
...
| 26 | `workflow-validator.js` | Validates workflow YAML files against YARD conventions (9 checks) | `fs.promises`, `path`, `js-yaml` | 18 files: `validate-workflow.md`, `squad-validator.js`, tasks | @qa, @architect | No |
...
| S6 | `squad-migrator.js` | Migrates legacy squad formats to YARD 2.1 standard (SQS-7) | `fs.promises`, `path`, `js-yaml` | `index.js`, `squad-creator-migrate.md`, tests | @squad-creator | No |
| S7 | `squad-downloader.js` | Downloads squads from yard-squads GitHub repository (SQS-6) | `https`, `fs.promises`, `path` | `index.js`, `squad-creator-download.md`, tests | @squad-creator | No |
| S8 | `squad-publisher.js` | Publishes squads to yard-squads GitHub repo via PR (SQS-6) | `child_process`, `fs.promises`, `path` | `index.js`, `squad-creator-publish.md`, tests | @squad-creator | No |
...
The YARD greeting system generates contextual, session-aware greetings when agents are activated. It consists of **8 greeting-related files** in the development scripts directory plus supporting infrastructure.
...
| `.yard-core/product/templates/activation-instructions-inline-greeting.yaml` | Template | ~64 | YAML template for inline greeting logic in agent files |
| `.claude/commands/greet.md` | Slash Command | ~102 | `/greet` slash command definition for Claude Code |

**External copies (in `.claude/commands/YARD/scripts/`):**
| File | Purpose |
|------|---------|
...
The preference is stored in `.yard-core/core-config.yaml` under `agentIdentity.greeting.preference`.
...
Used by: @dev, @qa, @architect, @pm, @po, @sm, @analyst, @yard-master, @squad-creator

```yaml
activation-instructions:
  - STEP 3: |
      Build intelligent greeting using .yard-core/development/scripts/greeting-builder.js
...
| @yard-master | `\U0001f9e0` | Orchestrator | Leo | "YARD Master Orchestrator ready!" |
...
```
greeting-builder.js
  |-- context-detector.js          (.yard-core/core/session/)
  |-- git-config-detector.js       (.yard-core/infrastructure/scripts/)
  |-- workflow-navigator.js        (sibling in development/scripts/)
  |-- greeting-preference-manager.js (sibling)
  |-- project-status-loader.js     (.yard-core/infrastructure/scripts/)
  |-- PermissionMode               (.yard-core/core/permissions/)
  |-- js-yaml
  |-- fs, path

generate-greeting.js
  |-- greeting-builder.js          (sibling)
  |-- session-context-loader.js    (.yard-core/scripts/)
  |-- project-status-loader.js     (.yard-core/infrastructure/scripts/)
...
| @yard-master | greeting-builder, agent-config-loader | 2 |
...
```
.yard-core/development/scripts/agent-assignment-resolver.js
.yard-core/development/scripts/agent-config-loader.js
.yard-core/development/scripts/agent-exit-hooks.js
.yard-core/development/scripts/apply-inline-greeting-all-agents.js
.yard-core/development/scripts/audit-agent-config.js
.yard-core/development/scripts/backlog-manager.js
.yard-core/development/scripts/batch-update-agents-session-context.js
.yard-core/development/scripts/decision-context.js
.yard-core/development/scripts/decision-log-generator.js
.yard-core/development/scripts/decision-log-indexer.js
.yard-core/development/scripts/decision-recorder.js
.yard-core/development/scripts/dev-context-loader.js
.yard-core/development/scripts/generate-greeting.js
.yard-core/development/scripts/greeting-builder.js
.yard-core/development/scripts/greeting-config-cli.js
.yard-core/development/scripts/greeting-preference-manager.js
.yard-core/development/scripts/migrate-task-to-v2.js
.yard-core/development/scripts/story-index-generator.js
.yard-core/development/scripts/story-manager.js
.yard-core/development/scripts/story-update-hook.js
.yard-core/development/scripts/task-identifier-resolver.js
.yard-core/development/scripts/test-greeting-system.js
.yard-core/development/scripts/validate-task-v2.js
.yard-core/development/scripts/verify-workflow-gaps.js
.yard-core/development/scripts/workflow-navigator.js
.yard-core/development/scripts/workflow-state-manager.js
.yard-core/development/scripts/workflow-validator.js
```
...
*Cross-Reference Phase 3 Analysis - YARD Framework*
*Generated: 2026-02-05*
