...
|-----------|-------------|-----------------|
| Templates de PRD | `.yard-core/development/templates/brownfield-prd-tmpl.yaml` | Step 2 |
| Template Frontend | `.yard-core/development/templates/front-end-spec-tmpl.yaml` | Step 3 |
| Template Arquitetura | `.yard-core/development/templates/brownfield-architecture-tmpl.yaml` | Step 4 |
| Checklist PO | `.yard-core/development/checklists/po-master-checklist.md` | Step 5 |
| Template Story | `.yard-core/development/templates/story-tmpl.yaml` | Step 8 |
...
```bash
ls .yard-core/development/templates/
```

2. Verificar nome correto do template no workflow
3. Se necessario, reinstalar templates do Yard core
...
| PO Master Checklist | `.yard-core/development/checklists/po-master-checklist.md` | Checklist de validacao PO |

### Agentes

| Agente | Arquivo | Documentacao |
|--------|---------|--------------|
| @architect | `.yard-core/development/agents/architect.md` | Aria - Holistic System Architect |
| @pm | `.yard-core/development/agents/pm.md` | Morgan - Product Manager |
| @ux-expert | `.yard-core/development/agents/ux-design-expert.md` | Uma - UX/UI Designer |
| @po | `.yard-core/development/agents/po.md` | Pax - Product Owner |
| @sm | `.yard-core/development/agents/sm.md` | River - Scrum Master |
| @analyst | `.yard-core/development/agents/analyst.md` | Atlas - Business Analyst |
| @dev | `.yard-core/development/agents/dev.md` | Dex - Full Stack Developer |
| @qa | `.yard-core/development/agents/qa.md` | Quinn - Test Architect |
...
*Documentacao gerada automaticamente a partir de `.yard-core/development/workflows/brownfield-ui.yaml`*
