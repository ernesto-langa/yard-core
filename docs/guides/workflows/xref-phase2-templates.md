...
**Scope:** All templates, checklists, and data files in `.yard-core/` mapped to consuming tasks, agents, and workflows.
...
15. [Framework Data Files (.yard-core/data/)](#15-framework-data-files)
...
Location: `.yard-core/product/templates/ide-rules/`
...
Location: `.yard-core/product/templates/engine/`
...
Location: `.yard-core/development/templates/squad/`
...
Location: `.yard-core/development/templates/service-template/`
...
Location: `.yard-core/development/templates/squad-template/`
...
Location: `.yard-core/development/templates/`
...
Location: `.yard-core/product/data/`
...
These files exist in `.yard-core/product/templates/` and are listed in the install-manifest, but are not referenced by any task, agent, workflow, or script:
...
The `create-doc.md` task is the primary template consumer. It dynamically loads templates from `.yard-core/product/templates/` based on user selection at runtime. The following templates are consumable through `create-doc`:
