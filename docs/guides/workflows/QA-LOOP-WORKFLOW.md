...
**Localizacao:** `.yard-core/development/tasks/qa-review-story.md`
...
**Localizacao:** `.yard-core/development/tasks/qa-create-fix-request.md`
...
**Localizacao:** `.yard-core/development/tasks/dev-apply-qa-fixes.md`
