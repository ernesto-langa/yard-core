...
| Arquivo | Proposito |
|---------|-----------|
| `.yard-core/development/workflows/brownfield-fullstack.yaml` | Definicao do workflow |
...
| `.yard-core/product/checklists/po-master-checklist.md` | Checklist de validacao PO |
