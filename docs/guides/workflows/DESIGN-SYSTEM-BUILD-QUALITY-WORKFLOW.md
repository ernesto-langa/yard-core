...
| Documento | Caminho |
|-----------|---------|
| Definicao do Workflow | `.yard-core/development/workflows/design-system-build-quality.yaml` |
| Agente UX-Design Expert | `.yard-core/development/agents/ux-design-expert.md` |
| Task: Build Component | `.yard-core/development/tasks/build-component.md` |
| Task: Generate Documentation | `.yard-core/development/tasks/generate-documentation.md` |
| Checklist: WCAG A11y | `.yard-core/development/checklists/accessibility-wcag-checklist.md` |
| Task: Calculate ROI | `.yard-core/development/tasks/calculate-roi.md` |
