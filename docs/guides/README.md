...
Complete documentation index for YARD system guides.
...
> **Note:** 1MCP documentation has been deprecated. YARD now uses Docker MCP Toolkit exclusively (Story 5.11). Archived docs available in `.github/deprecated-docs/guides/`.
