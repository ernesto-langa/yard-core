...
> **EN** | [PT](../../yard-agent-flows/dev-system.md) | [ES](../../es/yard-agent-flows/dev-system.md)

---

## Summary

**@dev** (Dex) is the **Builder** of the YARD agent system. This agent is responsible for:
...
**[View Full Documentation (PT)](../../yard-agent-flows/dev-system.md)**

---

*YARD Agent Flows - @dev System v1.0*
