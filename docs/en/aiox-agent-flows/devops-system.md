...
> **EN** | [PT](../../yard-agent-flows/devops-system.md) | [ES](../../es/yard-agent-flows/devops-system.md)

---

## Summary

**@devops** (Gage) is the **Guardian** of the YARD agent system. This agent is responsible for:
...
**[View Full Documentation (PT)](../../yard-agent-flows/devops-system.md)**

---

*YARD Agent Flows - @devops System v1.0*
