...
**Repository:** ernesto-langa/yard-core
...
- [Framework Core (.yard-core/)](#framework-core-yard-core)
...
```
yard-core/                             # Root project
├── .yard-core/                        # Framework core (modular)
...
### Shared Data Files (.yard-core/data/)
...
### Product Data Files (.yard-core/product/data/)
...
```
yard-core/
├── .yard-core/                        # Framework assets (modular v2.0)
│   ├── cli/                           # CLI commands and utilities
│   ├── core/                          # Framework essentials
│   │   ├── config/                    # Configuration system
...
### REPO 4: YardAI/certified-partners (Private)
...
### REPO 5: YardAI/mmos (Private + NDA)
...
Location: .yard-core/development/agents/{agent-name}.md
Example: .yard-core/development/agents/security-expert.md

# I'm creating a new task:
Location: .yard-core/development/tasks/{task-name}.md
Example: .yard-core/development/tasks/deploy-to-production.md

# I'm creating a new workflow:
Location: .yard-core/development/workflows/{workflow-name}.yaml
Example: .yard-core/development/workflows/continuous-deployment.yaml

# I'm creating a new template:
Location: .yard-core/product/templates/{template-name}-tmpl.{yaml|md}
Example: .yard-core/product/templates/deployment-plan-tmpl.yaml

# I'm creating a new checklist:
Location: .yard-core/product/checklists/{checklist-name}-checklist.md
Example: .yard-core/product/checklists/security-review-checklist.md

# I'm creating a CLI command:
Location: .yard-core/cli/commands/{category}/{command-name}.js
Example: .yard-core/cli/commands/generate/workflow.js

# I'm creating a core utility:
Location: .yard-core/core/utils/{utility-name}.js
Example: .yard-core/core/utils/performance-monitor.js

# I'm creating an infrastructure script:
Location: .yard-core/infrastructure/scripts/{category}/{script-name}.js
Example: .yard-core/infrastructure/scripts/llm-routing/router.js

# I'm adding a PM tool adapter:
Location: .yard-core/infrastructure/integrations/pm-adapters/{adapter-name}.js
Example: .yard-core/infrastructure/integrations/pm-adapters/monday-adapter.js
...
The ADE is configured via `.yard-core/core-config.yaml`:
...
ade:
  ...
  memoryLayer:
    enabled: true
    patternStore: .yard/patterns/
```

### ADE Runtime State

Runtime state is persisted in `.yard/`:
...
| 1.1     | 2025-12-14 | Updated org to YardAI, replaced Squads with Squads system [Story 6.10]                                                                                           | Dex (dev)        |
...
| 3.1     | 2026-02-06 | Added Data File Governance section: documented 7 missing data files with owner, fill rule, and update trigger. Expanded .yard-core/data/ and product/data/ tree listings. [Story ACT-8] | Dex (dev) |
