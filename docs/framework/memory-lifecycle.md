...
|---|---|---|---|
| Constitution | Framework | L1 | Generated by installer, references `.yard-core/constitution.md` |
...
| Sistema de Agentes | Framework | L2 | Agent definitions from `.yard-core/development/agents/` |
...
- `<!-- FRAMEWORK-OWNED: Generated by YARD installer, do not customize -->` for L1/L2 sections
...
Use `.yard-core/development/checklists/memory-audit-checklist.md` periodically to:
