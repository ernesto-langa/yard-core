...
- Agentes canonicos: `.yard-core/development/agents/*.md`
- Regras de projeto Codex: `AGENTS.md`

### Pipeline de ativacao

- Runtime: `.yard-core/development/scripts/activation-runtime.js`
- Entrada de greeting: `.yard-core/development/scripts/generate-greeting.js`
...
- Integracao estrutural: `.yard-core/infrastructure/scripts/validate-codex-integration.js`
- Skills: `.yard-core/infrastructure/scripts/codex-skills-sync/validate.js`
- Paths/contratos: `.yard-core/infrastructure/scripts/validate-paths.js`
...
- garantir skill apontando para agente canonico em `.yard-core/development/agents/`
