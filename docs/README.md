...
├── framework/                 # English
├── platforms/                 # English
├── yard-agent-flows/          # Detailed agent documentation (PT) — legacy root location
├── yard-workflows/            # Detailed workflow documentation (PT) — legacy root location
│
...
- [代理系统文档](./zh/yard-agent-flows/README.md)
- [工作流文档](./zh/yard-workflows/README.md)
