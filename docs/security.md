...
We take security seriously at SynkraAI. If you discover a security vulnerability in YARD, please report it responsibly.
...
1. **GitHub Security Advisories** (Preferred)
   - Go to [Security Advisories](https://github.com/ernesto-langa/yard-core/security/advisories)
   - Click "Report a vulnerability"
   - Fill out the form with details

2. **GitHub Issues (Private)**
   - Open a [private security advisory](https://github.com/ernesto-langa/yard-core/security/advisories)
...
When using YARD Framework, we recommend:
...
YARD Framework executes AI-generated code and commands. Users should:
...
- YARD may process sensitive data through AI providers
...
- [GitHub Security Advisories](https://github.com/ernesto-langa/yard-core/security/advisories)
