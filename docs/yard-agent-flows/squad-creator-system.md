...
O **Squad Creator** (Craft) e o agente especializado do YARD para criação, validação, publicacao e gerenciamento de squads. Squads sao pacotes modulares de agentes, tasks, workflows e recursos que podem ser reutilizados entre projetos.
...
| Arquivo | Propósito |
|---------|-----------|
| `.yard-core/development/agents/squad-creator.md` | Definição core do agente Squad Creator |
...
|---------|---------|-----------|--------|
| `.yard-core/development/tasks/squad-creator-create.md` | `*create-squad` | Cria novo squad com estrutura completa | Ativo |
| `.yard-core/development/tasks/squad-creator-design.md` | `*design-squad` | Analisa documentacao e gera blueprint | Ativo |
| `.yard-core/development/tasks/squad-creator-validate.md` | `*validate-squad` | Valida squad contra schema e padroes | Ativo |
| `.yard-core/development/tasks/squad-creator-list.md` | `*list-squads` | Lista squads locais | Ativo |
| `.yard-core/development/tasks/squad-creator-analyze.md` | `*analyze-squad` | Analisa estrutura e sugere melhorias | Ativo |
| `.yard-core/development/tasks/squad-creator-extend.md` | `*extend-squad` | Estende squad com novos componentes | Ativo |
| `.yard-core/development/tasks/squad-creator-migrate.md` | `*migrate-to-v2` | Migra squad para formato v2 | Ativo |
...
|---------|---------|-----------|
| `.yard-core/development/tasks/create-agent.md` | `*create-agent` | Cria definicao de agente individual |
| `.yard-core/development/tasks/create-task.md` | `*create-task` | Cria arquivo de task individual |
| `.yard-core/development/tasks/create-workflow.md` | `*create-workflow` | Cria workflow de orquestracao |

### Scripts de Suporte

| Arquivo | Classe/Funcao | Propósito |
|---------|---------------|-----------|
| `.yard-core/development/scripts/squad/squad-generator.js` | `SquadGenerator` | Gera estrutura de squad completa |
| `.yard-core/development/scripts/squad/squad-validator.js` | `SquadValidator` | Valida squad contra schema e padroes |
| `.yard-core/development/scripts/squad/squad-loader.js` | `SquadLoader` | Carrega e resolve squads |
| `.yard-core/development/scripts/squad/squad-designer.js` | `SquadDesigner` | Analisa docs e gera blueprints |
| `.yard-core/development/scripts/squad/squad-analyzer.js` | `SquadAnalyzer` | Analisa estrutura de squads |
| `.yard-core/development/scripts/squad/squad-extender.js` | `SquadExtender` | Estende squads existentes |
| `.yard-core/development/scripts/squad/squad-migrator.js` | `SquadMigrator` | Migra squads para v2 |
| `.yard-core/development/scripts/squad/squad-downloader.js` | `SquadDownloader` | Baixa squads do repositorio |
| `.yard-core/development/scripts/squad/squad-publisher.js` | `SquadPublisher` | Publica squads |

### Schemas JSON

| Arquivo | Propósito |
|---------|-----------|
| `.yard-core/schemas/squad-schema.json` | Schema de validação do squad.yaml |
| `.yard-core/schemas/squad-design-schema.json` | Schema de validação de blueprints |
...
- [Task: squad-creator-create.md](.yard-core/development/tasks/squad-creator-create.md)
- [Task: squad-creator-validate.md](.yard-core/development/tasks/squad-creator-validate.md)
- [Task: squad-creator-design.md](.yard-core/development/tasks/squad-creator-design.md)
- [Script: squad-generator.js](.yard-core/development/scripts/squad/squad-generator.js)
