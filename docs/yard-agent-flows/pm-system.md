...
| `.yard-core/development/tasks/execute-checklist.md` | `*checklist` | Executa validação de checklists |
...
| Arquivo | Propósito |
|---------|-----------|
| `.yard-core/product/checklists/pm-checklist.md` | Checklist de validação de PRD |
