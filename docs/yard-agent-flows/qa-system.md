...
|---------|---------|-----------|
| `.yard-core/development/tasks/qa-gate.md` | `*gate {story}` | Criar arquivo de decisao de quality gate |
| `.yard-core/development/tasks/qa-review-story.md` | `*review {story}` | Revisao completa de story com decisao de gate |
| `.yard-core/development/tasks/qa-test-design.md` | `*test-design {story}` | Criar cenarios de teste abrangentes |
| `.yard-core/development/tasks/qa-risk-profile.md` | `*risk-profile {story}` | Gerar matriz de avaliacao de risco |
| `.yard-core/development/tasks/qa-nfr-assess.md` | `*nfr-assess {story}` | Validar requisitos não-funcionais |
| `.yard-core/development/tasks/qa-trace-requirements.md` | `*trace {story}` | Mapear requisitos para testes (Given-When-Then) |
| `.yard-core/development/tasks/qa-generate-tests.md` | `*generate-tests` | Gerar suites de teste automaticamente |
| `.yard-core/development/tasks/qa-run-tests.md` | `*run-tests` | Executar suite de testes com gate de qualidade |
| `.yard-core/development/tasks/qa-backlog-add-followup.md` | `*backlog-add` | Adicionar follow-ups ao backlog |
| `.yard-core/development/tasks/qa-create-fix-request.md` | `*create-fix-request {story}` | Gerar documento de fix request para @dev |

### Arquivos de Tasks Secundarias do @qa

| Arquivo | Propósito |
|---------|-----------|
| `.yard-core/development/tasks/qa-browser-console-check.md` | Verificar erros no console do browser |
| `.yard-core/development/tasks/qa-evidence-requirements.md` | Requisitos de evidencia para QA |
| `.yard-core/development/tasks/qa-false-positive-detection.md` | Deteccao de falsos positivos |
| `.yard-core/development/tasks/qa-fix-issues.md` | Task para @dev aplicar fixes de QA |
| `.yard-core/development/tasks/qa-library-validation.md` | Validacao de bibliotecas |
| `.yard-core/development/tasks/qa-migration-validation.md` | Validacao de migracoes |
| `.yard-core/development/tasks/qa-review-build.md` | Revisao de builds |
| `.yard-core/development/tasks/qa-security-checklist.md` | Checklist de seguranca |
| `.yard-core/development/tasks/qa-review-proposal.md` | Revisao de propostas |

### Arquivos de Definição do Agente

| Arquivo | Propósito |
|---------|-----------|
| `.yard-core/development/agents/qa.md` | Definição completa do agente QA |
...
| Arquivo | Propósito |
|---------|-----------|
| `.yard-core/development/workflows/qa-loop.yaml` | Orquestrador do loop QA (Review -> Fix -> Re-review) |

### Arquivos de Time

| Arquivo | Propósito |
|---------|-----------|
| `.yard-core/development/agent-teams/team-qa-focused.yaml` | Configuracao do time focado em QA (@dev, @qa, @github-devops) |
...
| Arquivo | Propósito |
|---------|-----------|
| `.yard-core/core-config.yaml` | Configuracao central (qa.qaLocation, etc.) |
| `.yard-core/development/data/technical-preferences.md` | Preferencias tecnicas para QA |
...
wsl bash -c 'cd /mnt/c/.../yard-core && ~/.local/bin/coderabbit --prompt-only -t uncommitted'

# Story review (committed changes vs main)
wsl bash -c 'cd /mnt/c/.../yard-core && ~/.local/bin/coderabbit --prompt-only -t committed --base main'
```
...
- [qa-gate.md](/.yard-core/development/tasks/qa-gate.md)
- [qa-review-story.md](/.yard-core/development/tasks/qa-review-story.md)
- [qa-test-design.md](/.yard-core/development/tasks/qa-test-design.md)
- [qa-risk-profile.md](/.yard-core/development/tasks/qa-risk-profile.md)
- [qa-nfr-assess.md](/.yard-core/development/tasks/qa-nfr-assess.md)
- [qa-trace-requirements.md](/.yard-core/development/tasks/qa-trace-requirements.md)

### Workflows

- [qa-loop.yaml](/.yard-core/development/workflows/qa-loop.yaml)

### Teams

- [team-qa-focused.yaml](/.yard-core/development/agent-teams/team-qa-focused.yaml)

### Agente

- [qa.md](/.yard-core/development/agents/qa.md)
