...
| `.yard-core/development/tasks/execute-checklist.md` | `*execute-checklist` | Executa checklist de validação |
...
| Arquivo | Propósito |
|---------|-----------|
| `.yard-core/development/templates/agent-template.yaml` | Template para criação de novos agentes |
| `.yard-core/development/templates/task-template.md` | Template para criação de novas tasks |
| `.yard-core/development/templates/workflow-template.yaml` | Template para criação de novos workflows |
