...
You can also revoke consent at any time through the consent management interface or by deleting the `.yard/telemetry/` directory.
...
- **Delete** all local data by removing the `.yard/` and `.ai/` directories
...
- Repository: [github.com/ernesto-langa/yard-core](https://github.com/ernesto-langa/yard-core)
