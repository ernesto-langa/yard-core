...
| Problema | Causa Provável | Solução |
|----------|----------------|---------|
| Templates nao encontrados | Path incorreto | Verificar `.yard-core/development/templates/` |
...
| Arquivo | Caminho |
|---------|---------|
| Definição do Workflow | `.yard-core/development/workflows/greenfield-ui.yaml` |
...
| Agente | Caminho |
|--------|---------|
| @analyst | `.yard-core/development/agents/analyst.md` |
| @pm | `.yard-core/development/agents/pm.md` |
| @ux-expert | `.yard-core/development/agents/ux-design-expert.md` |
| @architect | `.yard-core/development/agents/architect.md` |
| @po | `.yard-core/development/agents/po.md` |
| @sm | `.yard-core/development/agents/sm.md` |
| @dev | `.yard-core/development/agents/dev.md` |
| @qa | `.yard-core/development/agents/qa.md` |

### Templates Principais

| Template | Caminho |
|----------|---------|
| Project Brief | `.yard-core/development/templates/project-brief-tmpl.yaml` |
| PRD | `.yard-core/development/templates/prd-tmpl.yaml` |
| Frontend Spec | `.yard-core/development/templates/front-end-spec-tmpl.yaml` |
| Frontend Architecture | `.yard-core/development/templates/front-end-architecture-tmpl.yaml` |
| Story | `.yard-core/development/templates/story-tmpl.yaml` |

### Checklists

| Checklist | Caminho |
|-----------|---------|
| PO Master | `.yard-core/development/checklists/po-master-checklist.md` |
| Story Draft | `.yard-core/development/checklists/story-draft-checklist.md` |
| Story DoD | `.yard-core/development/checklists/story-dod-checklist.md` |
...
*Documento gerado automaticamente a partir de `.yard-core/development/workflows/greenfield-ui.yaml`*
