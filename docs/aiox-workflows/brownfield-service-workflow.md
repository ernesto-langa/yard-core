...
|---------|-----------|---------|
| Workflow Definition | Definição YAML do workflow | `.yard-core/development/workflows/brownfield-service.yaml` |
...
| PO Master Checklist | Checklist de validação | `.yard-core/development/checklists/po-master-checklist.md` |
