...
> **Arquivo Fonte:** `.yard-core/development/workflows/brownfield-fullstack.yaml`
...
**Arquivo de Task:** `.yard-core/development/tasks/document-project.md`
...
**Arquivo de Checklist:** `.yard-core/product/checklists/po-master-checklist.md`
...
**Arquivo de Task:** `.yard-core/development/tasks/shard-doc.md`
...
**Arquivos de Task:**
- `.yard-core/development/tasks/create-next-story.md`
- `.yard-core/development/tasks/create-brownfield-story.md`
...
| Arquivo | Propósito |
|---------|-----------|
| `.yard-core/development/workflows/brownfield-fullstack.yaml` | Definição do workflow |
| `.yard-core/development/tasks/brownfield-create-story.md` | Task para criar story simples |
| `.yard-core/development/tasks/brownfield-create-epic.md` | Task para criar epic |
| `.yard-core/development/tasks/document-project.md` | Task para documentar projeto existente |
| `.yard-core/development/tasks/shard-doc.md` | Task para fragmentar documentos |
| `.yard-core/development/tasks/create-brownfield-story.md` | Task para criar story brownfield |
| `.yard-core/development/tasks/create-next-story.md` | Task para criar story de PRD |
| `.yard-core/product/checklists/po-master-checklist.md` | Checklist de validação PO |

### Arquivos de Agentes

| Arquivo | Agente |
|---------|--------|
| `.yard-core/development/agents/analyst.md` | @analyst (Atlas) |
| `.yard-core/development/agents/architect.md` | @architect (Aria) |
| `.yard-core/development/agents/pm.md` | @pm (Morgan) |
| `.yard-core/development/agents/po.md` | @po (Pax) |
| `.yard-core/development/agents/sm.md` | @sm (River) |
| `.yard-core/development/agents/dev.md` | @dev (Dex) |
| `.yard-core/development/agents/qa.md` | @qa (Quinn) |
...
| `.yard-core/working-in-the-brownfield.md` | Guia de trabalho brownfield |
