...
**Estrutura Criada:**
```
.yard/worktrees/{storyId}/     # Diretório de trabalho
...
| Propriedade | Valor |
|-------------|-------|
| **Localização** | `.yard-core/development/tasks/create-worktree.md` |
| **Agente** | @devops (Gage) |
| **Versão** | 1.0 |
| **Story** | 1.3 |
...
3. Aumentar limite (se necessário) em `.yard/config.yaml`
