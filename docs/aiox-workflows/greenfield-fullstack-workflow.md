...
**Arquivo Fonte:** `.yard-core/development/workflows/greenfield-fullstack.yaml`

---

## Visão Geral

O **Greenfield Full-Stack Workflow** e o fluxo de trabalho principal do YARD para construcao de aplicacoes full-stack desde o conceito ate o desenvolvimento. Este workflow suporta tanto planejamento abrangente para projetos complexos quanto prototipagem rapida para projetos simples.
...
flowchart TD
    subgraph FASE0["FASE 0: Environment Bootstrap"]
        ...
        CHECK -->|Verificar| ENV_REPORT[".yard/environment-report.json existe?"]
...
|------|--------|------|---------|-------|-------------|
| 1 | @devops (Gage) | `environment-bootstrap.md` | `project_name`, `project_path.join(process.cwd(), '.yard', environment-report.json`, `.gitignore`, `README.md`, `package.json` | Sim |

### Artefatos Criados

| Arquivo | Descricao |
|---------|-----------|
| `.yard/config.yaml` | Configuracao do projeto YARD |
| `.yard/environment-report.json` | Relatorio completo do ambiente |
...
- Pular apenas se o projeto ja tiver `.yard/environment-report.json`
...
| Fase | Entrada | Saida |
|------|---------|-------|
| 0 | Nome do projeto, organizacao GitHub | Config YARD, repo Git, estrutura de pastas |
...
|------|------------------|--------|----------|
| 0 | Ambiente pronto? | Pular / Executar bootstrap | Existencia de `.yard/environment-report.json` |
...
flowchart TD
    D1{Ambiente pronto?}
    D1 -->|Verificar .yard/environment-report.json| D1_CHECK
...
| Problema | Causa | Solucao |
|----------|-------|---------|
| Template nao encontrado | Caminho incorreto | Verificar `.yard-core/development/templates/` |
...
```bash
# Verificar ambiente
cat .yard/environment-report.json
...
|------|---------|-----------|
| Workflow | `.yard-core/development/workflows/greenfield-fullstack.yaml` | Definicao do workflow |
| Task | `.yard-core/development/tasks/environment-bootstrap.md` | Bootstrap do ambiente |
| Task | `.yard-core/development/tasks/shard-doc.md` | Fragmentacao de documentos |
| Task | `.yard-core/development/tasks/sm-create-next-story.md` | Criacao de stories |
| Agente | `.yard-core/development/agents/*.md` | Definicoes de agentes |
| Template | `.yard-core/development/templates/*.yaml` | Templates de documentos |
| Checklist | `.yard-core/development/checklists/*.md` | Checklists de validacao |
...
**Mantido por:** YARD Development Team
