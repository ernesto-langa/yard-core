...
| Arquivo | Localizacao |
|---------|-------------|
| Definicao do Workflow | `.yard-core/development/workflows/brownfield-discovery.yaml` |
| Task: brownfield-create-epic | `.yard-core/development/tasks/brownfield-create-epic.md` |
| Task: brownfield-create-story | `.yard-core/development/tasks/brownfield-create-story.md` |
| Task: db-schema-audit | `.yard-core/development/tasks/db-schema-audit.md` |
| Task: security-audit | `.yard-core/development/tasks/security-audit.md` |
...
| @data-engineer | `.yard-core/development/agents/data-engineer.md` |
| @ux-design-expert | `.yard-core/development/agents/ux-design-expert.md` |
...
- [Guia de Workflows YARD](../YARD-WORKFLOWS-GUIDE.md)
