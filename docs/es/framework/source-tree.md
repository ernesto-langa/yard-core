...
# Estructura del Árbol de Código Fuente YARD
...
**Repositorio:** ernesto-langa/yard-core
...
- [Core del Framework (.yard-core/)](#core-del-framework-yard-core)
...
YARD utiliza una **arquitectura modular** con clara separación de responsabilidades:

1. **Core del Framework** (`.yard-core/`) - Componentes portables del framework organizados por dominio
...
```
yard-core/                             # Proyecto raíz
├── .yard-core/                        # Core del framework (modular)
...
│
├── bin/                               # Ejecutables CLI
│   └── yard.js                        # Punto de entrada principal CLI
│
...
│   ├── yard migration/                # Stories de migración YARD
│   │   ├── story-6.1.2.1.md
│   │   ├── story-6.1.2.2.md
│   │   ├── story-6.1.2.3.md
│   │   ├── story-6.1.2.4.md
...
Los Squads son extensiones modulares que agregan capacidades especializadas a YARD. A diferencia de los Squads deprecados, los Squads siguen una estructura de template estandarizada.
...
### REPO 1: ernesto-langa/yard-core (MIT)

```
yard-core/
├── .yard-core/                        # Assets del framework (modular v2.0)
│   ├── cli/                           # Comandos CLI y utilidades
│   ├── core/                          # Esenciales del framework
│   │   ├── config/                    # Sistema de configuración
...
Ubicación: .yard-core/development/agents/{agent-name}.md
Ejemplo: .yard-core/development/agents/security-expert.md

# Estoy creando una nueva tarea:
Ubicación: .yard-core/development/tasks/{task-name}.md
Ejemplo: .yard-core/development/tasks/deploy-to-production.md

# Estoy creando un nuevo workflow:
Ubicación: .yard-core/development/workflows/{workflow-name}.yaml
Ejemplo: .yard-core/development/workflows/continuous-deployment.yaml

# Estoy creando un nuevo template:
Ubicación: .yard-core/product/templates/{template-name}-tmpl.{yaml|md}
Ejemplo: .yard-core/product/templates/deployment-plan-tmpl.yaml

# Estoy creando un nuevo checklist:
Ubicación: .yard-core/product/checklists/{checklist-name}-checklist.md
Ejemplo: .yard-core/product/checklists/security-review-checklist.md

# Estoy creando un comando CLI:
Ubicación: .yard-core/cli/commands/{category}/{command-name}.js
Ejemplo: .yard-core/cli/commands/generate/workflow.js

# Estoy creando una utilidad core:
Ubicación: .yard-core/core/utils/{utility-name}.js
Ejemplo: .yard-core/core/utils/performance-monitor.js

# Estoy creando un script de infraestructura:
Ubicación: .yard-core/infrastructure/scripts/{category}/{script-name}.js
Ejemplo: .yard-core/infrastructure/scripts/llm-routing/router.js

# Estoy agregando un adaptador de herramienta PM:
Ubicación: .yard-core/infrastructure/integrations/pm-adapters/{adapter-name}.js
Ejemplo: .yard-core/infrastructure/integrations/pm-adapters/monday-adapter.js
...
_Este es un estándar oficial del framework YARD. Toda colocación de archivos debe seguir esta estructura._
