...
**Aviso de Migración:** Este documento migrará al repositorio `ernesto-langa/yard-core` en Q2 2026 (ver Decision 005)
...
| 1.1     | 2025-12-14 | Actualizado aviso de migración a ernesto-langa/yard-core, semantic-release a v25.0.2 [Story 6.10] | Dex (dev)        |
