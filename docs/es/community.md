...
4. Preséntate en [Discussions](https://github.com/ernesto-langa/yard-core/discussions)

### Encuentra tu Primera Contribución

- Busca issues etiquetados como [`good-first-issue`](https://github.com/ernesto-langa/yard-core/labels/good-first-issue)
- Revisa [`help-wanted`](https://github.com/ernesto-langa/yard-core/labels/help-wanted) para tareas más complejas
- Explora las [Discussions abiertas](https://github.com/ernesto-langa/yard-core/discussions) para ayudar a otros
...
Todos los contribuidores son reconocidos en nuestra [página de Contribuidores](https://github.com/ernesto-langa/yard-core/graphs/contributors).
...
2. Busca en [Discussions existentes](https://github.com/ernesto-langa/yard-core/discussions)
3. Pregunta en Q&A Discussions
4. Abre una discusión de Troubleshooting

### ¿Encontraste un bug?

1. Busca en [issues existentes](https://github.com/ernesto-langa/yard-core/issues)
2. Si es nuevo, [abre un reporte de bug](https://github.com/ernesto-langa/yard-core/issues/new?template=bug_report.md)

### ¿Tienes una idea?

1. Verifica si existe en [Ideas](https://github.com/ernesto-langa/yard-core/discussions/categories/ideas)
2. Si es nueva, [comparte tu idea](https://github.com/ernesto-langa/yard-core/discussions/new?category=ideas)
...
1. **Votando** en ideas en [Discussions](https://github.com/ernesto-langa/yard-core/discussions/categories/ideas)
...
- [Guía de Usuario](.yard-core/user-guide.md)
...
- Versión Actual: Ver [releases](https://github.com/ernesto-langa/yard-core/releases)
