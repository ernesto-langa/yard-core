...
# Guía de Solución de Problemas de YARD-Framework
...
### Problema 1: "npx yard-core no se reconoce"
...
npm ERR! network request to https://registry.npmjs.org/yard-core failed
```
...
```bash
# Verificar estado de instalación de YARD
npx yard-core status
...
```bash
# Verificar estructura de .yard-core
...
1. Ejecute `npx yard-core status` y anote la salida
2. Revise esta guía de solución de problemas
3. Busque [Issues de GitHub](https://github.com/ernesto-langa/yard-core/issues) existentes
...
- **Issues de GitHub**: [yard-core/issues](https://github.com/ernesto-langa/yard-core/issues)
