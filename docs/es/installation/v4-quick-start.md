...
npx yard-core@latest init mi-proyecto
cd mi-proyecto
```
...
```bash
# Instalación y setup
npx yard-core@latest           # Ejecutar wizard
npx yard-core@latest doctor    # Ejecutar diagnósticos
npx yard-core@latest info      # Mostrar info del sistema
...
3. **Aprende sobre agentes:** [Definiciones de Agentes](../../../.yard-core/development/agents/)
...
3. Verifica que el archivo del agente existe: `ls .yard-core/development/agents/`
...
- **Documentación:** [Repositorio GitHub](https://github.com/ernesto-langa/yard-core)
