...
**Aviso de Migracion:** Este documento migrara al repositorio `ernesto-langa/yard-core` en Q2 2026 (ver Decision 005)
...
- [Estructura Actual (yard-core Brownfield)](#estructura-actual-yard-core-brownfield)
...
## Estructura Actual (yard-core Brownfield)

```
yard-core/                             # Raiz (proyecto brownfield)
├── .yard-core/                        # Framework core (portable)
...
│   └── cli/                           # Interfaz CLI
│
├── .yard-core/                        # Assets del framework (estructura actual)
│   ├── agents/
│   ├── tasks/
│   ├── templates/
│   └── ...
...
Ubicacion: .yard-core/agents/{nombre-agente}.md
Ejemplo: .yard-core/agents/security-expert.md

# Estoy creando una nueva tarea:
Ubicacion: .yard-core/tasks/{nombre-tarea}.md
Ejemplo: .yard-core/tasks/deploy-to-production.md

# Estoy creando un nuevo workflow:
Ubicacion: .yard-core/workflows/{nombre-workflow}.yaml
Ejemplo: .yard-core/workflows/continuous-deployment.yaml

# Estoy creando una nueva plantilla:
Ubicacion: .yard-core/product/templates/{nombre-plantilla}-tmpl.{yaml|md}
...
Ubicacion: .yard-core/utils/{nombre-utilidad}.js
Ejemplo: .yard-core/utils/performance-monitor.js
