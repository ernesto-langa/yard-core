...
- `.yard-core/agents/{agent}.yaml` (agregar a dependencies.utils)
- `.yard-core/core-config.yaml` (registrar si es necesario)
- `.yard-core/utils/README.md` (documentar utilidad)
...
**Archivos Modificados:**
- `.yard-core/tasks/{task}.md` (agregar execution.utils)
- `.yard-core/agents/{agent}.yaml` (agregar tarea a lista executes)
- `.yard-core/core-config.yaml` (registrar si es necesario)
- `.yard-core/utils/README.md` (documentar utilidad)
...
**Archivos Modificados:**
- `.yard-core/core-config.yaml` (registrar bajo framework)
- `.yard-core/utils/README.md` (documentar como utilidad de framework)
...
- `.yard-core/tasks/{task}.md` (si se crea tarea)
- `.yard-core/core-config.yaml`
...
**Ubicación:** `.yard-core/utils/{name}.js`
