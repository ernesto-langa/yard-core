...
- [Repositorio Central (yard-core)](#repositorio-central-yard-core)
...
| ---------------------------- | ------------------------------------------------------- |
| `.yard-core/core/`           | Fundamentos del marco (config, registry, puertas de calidad) |
| `.yard-core/development/`    | Definiciones de agentes, tareas, flujos de trabajo                     |
| `.yard-core/product/`        | Plantillas, listas de verificación, datos de PM                          |
| `.yard-core/infrastructure/` | Scripts, herramientas, integraciones                            |
...
### YardAI/certified-partners (Propietario)
...
2. **Dependencias Entre Iguales** - Especifica los requisitos exactos de versión de yard-core
