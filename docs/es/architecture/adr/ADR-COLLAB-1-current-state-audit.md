...
**Fuente:** `gh api repos/ernesto-langa/yard-core/branches/main/protection`
...
**Fuente:** `gh api repos/ernesto-langa/yard-core`
...
**Fuente:** `gh api repos/ernesto-langa/yard-core/actions/workflows`
...
1. Crear `.coderabbit.yaml` con reglas especificas de YARD
...
- `.yard/audit/branch-protection.json`
- `.yard/audit/repo-settings.json`
