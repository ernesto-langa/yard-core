...
| **Al instalar/bootstrap**    | `npx yard-core install` | 60-120s  | Esperado                 | Validación de setup         | ✅ **Requerido**  |
...
**Veredicto:** Requerido. Parte de `npx yard-core install` y `*bootstrap-setup`.
