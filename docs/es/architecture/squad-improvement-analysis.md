...
| **Icono** | 🏗️ |
| **Archivo** | `.yard-core/development/agents/squad-creator.md` |
...
| `*publish-squad` | squad-creator-publish.md | ⏳ Placeholder | Publicar a yard-squads |
...
| SquadPublisher | squad-publisher.js | Publicar a yard-squads |
