...
**Archivo:** `.yard-core/development/agents/devops.md`
...
**Archivo:** `.yard-core/development/agents/pm.md`
...
**Archivo:** `.yard-core/development/agents/architect.md`
...
**Archivo:** `.yard-core/development/agents/analyst.md`
...
**Archivo:** `.yard-core/development/agents/qa.md`
...
**Archivo:** `.yard-core/development/agents/dev.md`
...
- name: list-gotchas
  visibility: [full, quick]
  description: 'Listar gotchas conocidos de .yard/gotchas.md'
```
...
- `.yard-core/infrastructure/schemas/agent-v3-schema.json`

**Comando para validar:**

```bash
node .yard-core/infrastructure/scripts/migrate-agent.js --validate
```
