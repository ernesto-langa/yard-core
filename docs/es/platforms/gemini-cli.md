...
```markdown
# Reglas de YARD-Framework para Gemini CLI
...
## Rol
Eres un Desarrollador Full Stack Senior trabajando con YARD-Framework.
...
*YARD-Framework - Guía de Plataforma Gemini CLI v1.0*
