...
# Guía de Optimización de Rendimiento de YARD-Framework
...
Esta guía completa proporciona estrategias, herramientas y mejores prácticas para optimizar el rendimiento de YARD-Framework en todos los componentes críticos.
...
const profiler = new PerformanceProfiler({
  enabled: true,
  reportPath: '.yard/reports/performance.json'
});
