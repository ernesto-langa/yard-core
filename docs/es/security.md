...
1. **GitHub Security Advisories** (Preferido)
   - Ve a [Security Advisories](https://github.com/ernesto-langa/yard-core/security/advisories)
   - Haz clic en "Report a vulnerability"
   - Completa el formulario con los detalles

2. **GitHub Issues (Privado)**
   - Abre un [security advisory privado](https://github.com/ernesto-langa/yard-core/security/advisories)
...
Al usar YARD Framework, recomendamos:
...
YARD Framework ejecuta código y comandos generados por AI. Los usuarios deben:
...
- YARD puede procesar datos sensibles a través de proveedores de AI
