...
```
my-first-project/
├── .yard/                    # Configuracion del framework
...
El archivo de configuracion principal (`.yard/config.json`) contiene:
...
- **[Tutoriales en Video](https://yard-core.dev/tutorials)**: Aprendizaje visual
...
- **Twitter**: Sigue [@yardfullstack](https://twitter.com/yardfullstack)
