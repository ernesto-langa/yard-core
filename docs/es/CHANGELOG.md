...
- **Estructura de Directorios**: Renombrado `.legacy-core/` a `.yard-core/`
...
- **Configuracion de IDE**: Agentes de Claude Code movidos a `.claude/commands/YARD/agents/`
...
- Proceso de instalacion manual (usar `npx yard-core install` en su lugar)
...
**Cambios clave:**
1. Directorio renombrado: `.legacy-core/` → `.yard-core/`
...
- [Repositorio GitHub](https://github.com/ernesto-langa/yard-core)
