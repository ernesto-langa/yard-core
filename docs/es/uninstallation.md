...
Esta guía proporciona instrucciones completas para desinstalar YARD-Framework de su sistema.
...
⚠️ **Advertencia**: Desinstalar YARD-Framework:
...
La forma más rápida de desinstalar YARD-Framework:
...
```bash
# Eliminar hooks de git específicos de YARD
rm -f .git/hooks/*yard*
...
Si desea reinstalar YARD-Framework:
...
- [ ] Todos los procesos YARD detenidos
...
- [ ] No se encontraron archivos YARD restantes
...
1. **Consultar Documentación**
   ...
   - [Solución de Problemas](https://github.com/ernesto-langa/yard-core/wiki/troubleshooting)
