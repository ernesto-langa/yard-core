...
Reacciona con :+1: en [Ideas en Discussions](https://github.com/ernesto-langa/yard-core/discussions/categories/ideas) existentes para mostrar apoyo.

### 2. Propón Características

¿Tienes una nueva idea? Abre una [Discusión de Idea](https://github.com/ernesto-langa/yard-core/discussions/new?category=ideas) para compartirla con la comunidad.
...
5. Comunicar cambios significativos vía [Anuncios](https://github.com/ernesto-langa/yard-core/discussions/categories/announcements)
