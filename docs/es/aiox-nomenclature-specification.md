...
**Características:**
- **Alcance:** Interno a un único archivo de tarea (`.yard-core/tasks/*.md`)
...
- **Ubicación:** Definido en `.yard-core/workflows/*.yaml` o secciones de workflow de stories
...
**Archivos de Tarea:**
- Ubicación: `.yard-core/tasks/{task-name}.md`
- Contiene: Task workflow (Step-by-Step Execution)
- Ejemplo: `.yard-core/tasks/security-scan.md`

**Archivos de Workflow:**
- Ubicación: `.yard-core/workflows/{workflow-name}.yaml`
- Contiene: Definición de orquestación multi-tarea
- Ejemplo: `.yard-core/workflows/story-development-workflow.yaml`
