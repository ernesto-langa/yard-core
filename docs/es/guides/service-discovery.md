...
Encontrados 5 workers que coinciden con "create story":
  ...
  [task] po-create-story
         Ruta: .yard-core/development/tasks/po-create-story.md
         Etiquetas: task, creation, story, product
         Agentes: po

  [task] dev-create-brownfield-story
         Ruta: .yard-core/development/tasks/dev-create-brownfield-story.md
...
**Ubicación:** `.yard-core/development/tasks/`
...
**Ubicación:** `.yard-core/product/templates/`
...
**Ubicación:** `.yard-core/development/workflows/`
...
**Ubicación:** `.yard-core/product/checklists/`
...
_Guía de Descubrimiento de Servicios de YARD-Framework v4_
