...
**Opcion 1: Si tienes yard-core clonado**
```bash
# Desde el directorio yard-core
...
- **Definicion de Herramienta:** `.yard-core/infrastructure/tools/cli/llm-routing.yaml`
- **Script de Instalacion:** `.yard-core/infrastructure/scripts/llm-routing/install-llm-routing.js`
- **Definicion de Tarea:** `.yard-core/development/tasks/setup-llm-routing.md`
