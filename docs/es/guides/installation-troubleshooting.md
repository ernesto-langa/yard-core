...
# Guía de Instalación y Solución de Problemas de YARD-Core
...
Este comando descarga y ejecuta la última versión del instalador de YARD-Core.
...
# Show version
npx yard-core@latest --version

# Show help
npx yard-core@latest --help
```

### Método 2: Desde GitHub

```bash
npx github:ernesto-langa/yard-core install
```
...
### Windows (CMD)
```cmd
curl -o diagnose.cmd https://raw.githubusercontent.com/ernesto-langa/yard-core/main/tools/quick-diagnose.cmd && diagnose.cmd
```

### Windows (PowerShell)
```powershell
irm https://raw.githubusercontent.com/ernesto-langa/yard-core/main/tools/quick-diagnose.ps1 | iex
```

### macOS/Linux
```bash
curl -fsSL https://raw.githubusercontent.com/ernesto-langa/yard-core/main/tools/diagnose-installation.js | node
```
...
npx --ignore-existing yard-core@latest
...
1. **GitHub Issues**: https://github.com/ernesto-langa/yard-core/issues
2. **Ejecutar diagnósticos**: `npx yard-core@latest doctor`
3. **Verificar información del sistema**: `npx yard-core@latest info`
...
| Comando | Descripción |
|---------|-------------|
| `npx yard-core@latest` | Instalar/ejecutar asistente |
| `npx yard-core@latest --version` | Mostrar versión |
| `npx yard-core@latest --help` | Mostrar ayuda |
| `npx yard-core@latest install` | Instalar en directorio actual |
| `npx yard-core@latest init <name>` | Crear nuevo proyecto |
| `npx yard-core@latest doctor` | Ejecutar diagnósticos |
| `npx yard-core@latest info` | Mostrar información del sistema |

---

*Última actualización: Diciembre 2025 | YARD-Core v2.2.0*
