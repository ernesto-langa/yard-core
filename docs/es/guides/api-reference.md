# Referencia de API YARD

> [EN](../../guides/api-reference.md) | [PT](../../pt/guides/api-reference.md) | **ES**

---

Referencia completa de la API para YARD-Framework - el Sistema Orquestado por IA para Desarrollo Full Stack.
...
YARD proporciona una API unificada para interactuar con agentes de IA especializados a través de dos mecanismos principales:
...
| `@yard-master`   | Orion  | Orchestrator | Orquestación del framework, meta-operaciones   |

### Comportamiento de Activación

Cuando se activa un agente:

1. Se carga el archivo de definición del agente desde `.yard-core/development/agents/{id}.md`
...
*develop story-1.2.3
    │
    ▼
.yard-core/development/tasks/dev-develop-story.md
    │
    ▼
...
### @yard-master (Orquestador)

**Desarrollo del Framework:**

| Comando                | Argumentos      | Descripción                                    |
| ---------------------- | --------------- | ---------------------------------------------- |
| `*create`              | `{type} {name}` | Crear componente YARD (agent/task/workflow)    |
...
| `*kb`   | -                          | Alternar modo KB (conocimiento YARD Method)   |
...
| -------------------- | ---------------------------------- | -------------------------------------- |
| `AGENT_NOT_FOUND`    | Definición de agente faltante      | Verificar `.yard-core/development/agents/` |
...
/yard-master  → Activa agente @yard-master
```
...
- [Guía de Usuario](./user-guide.md) - Comenzando con YARD
...
- [Guía de Squads](./squads-guide.md) - Extendiendo YARD con squads

---

_YARD-Framework API Reference v4.2.11_
