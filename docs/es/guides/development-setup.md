...
Guia completa para desarrolladores que quieren contribuir al proyecto YARD-Framework.
...
| -------------------- | ------------------------------------------- |
| **Claude Code**      | Desarrollo potenciado por IA con agentes YARD |
| **VS Code / Cursor** | IDE con integracion YARD                    |
...
1. Navega a [github.com/ernesto-langa/yard-core](https://github.com/ernesto-langa/yard-core)
...
```bash
# Clonar tu fork
git clone https://github.com/YOUR_USERNAME/yard-core.git
cd yard-core

# Agregar remote upstream
git remote add upstream https://github.com/ernesto-langa/yard-core.git

# Verificar remotes
git remote -v
# origin    https://github.com/YOUR_USERNAME/yard-core.git (fetch)
# origin    https://github.com/YOUR_USERNAME/yard-core.git (push)
# upstream  https://github.com/ernesto-langa/yard-core.git (fetch)
# upstream  https://github.com/ernesto-langa/yard-core.git (push)
```
...
Sincroniza los agentes YARD con tu IDE:
...
Entendiendo la estructura de directorios de `yard-core`:

```
yard-core/
├── .yard-core/                    # Fuente del framework (committed)
...
│   ├── commands/YARD/agents/      # Comandos skill de agentes
...
| ----------------------------------- | -------------------------------- | ------------------------- |
| `.yard-core/development/agents/`    | Personas y comportamientos de agentes | Agregar/modificar agentes |
| `.yard-core/development/tasks/`     | Workflows de tasks ejecutables   | Agregar/modificar tasks   |
| `.yard-core/development/workflows/` | Orquestaciones multi-paso        | Crear workflows           |
...
Crea un nuevo archivo en `.yard-core/development/agents/`:

```bash
# Archivo: .yard-core/development/agents/my-agent.md
```
...
dependencies:
  tasks:
    - my-agent-task.md       # Crear en .yard-core/development/tasks/
  checklists:
    - my-agent-checklist.md  # Crear en .yard-core/development/checklists/
  tools:
    - git
    - context7
````
...
Crea un nuevo archivo en `.yard-core/development/tasks/`:
...
# Ejemplos:
# .yard-core/development/tasks/dev-build-component.md  (agente dev)
# .yard-core/development/tasks/create-doc.md          (compartida)
```
...
## Definicion de Task (YARD Task Format V1.0)
...
Crea un nuevo archivo en `.yard-core/development/workflows/`:

```bash
# Archivo: .yard-core/development/workflows/my-workflow.yaml
```
...
npx js-yaml .yard-core/development/agents/my-agent.md

# Verificar que existan dependencias
ls .yard-core/development/tasks/my-task.md
```
...
- **GitHub Discussions:** [github.com/ernesto-langa/yard-core/discussions](https://github.com/ernesto-langa/yard-core/discussions)
- **Issue Tracker:** [github.com/ernesto-langa/yard-core/issues](https://github.com/ernesto-langa/yard-core/issues)
...
- Etiquetar `@YardAI/core-team` para issues urgentes
...
_YARD-Framework Guia de Configuracion para Desarrollo v1.0.0_
