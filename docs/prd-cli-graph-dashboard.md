...
O CLI Graph Dashboard será adicionado ao monorepo existente `yard-core`, como um novo módulo em `.yard-core/core/graph-dashboard/` com entrypoint em `bin/aiox-graph.js`.
