---
name: Squad Proposal
about: Propose a new YARD Squad for the framework
title: '[SQUAD] '
...
### 📋 Description
A clear and concise description of what this YARD Squad does and what domain it covers.

> YARD Squads are modular teams of AI agents that work together to accomplish specialized tasks.
...
# Or via CLI
yard squad activate my-domain
```

### 📦 Dependencies
- **Core Framework:** Required yard-core version?
- **Other Squads:** Any dependencies on other YARD Squads?
- **External Services:** Any API keys or external services needed?

### 🔒 License & Distribution
- [ ] This squad will be open-source (MIT) in `yard-squads` repo
...
### ✅ Checklist
- [ ] Squad follows YARD structure (`{squad}/agents/`, `{squad}/tasks/`, etc.)
...
**Note:** All squad proposals are reviewed by maintainers. Approved squads may be included in the official `yard-squads` repository.
