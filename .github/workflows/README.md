...
This directory contains automated workflows for the YARD project.
...
> **Note:** Legacy 1MCP metrics have been deprecated. YARD now uses Docker MCP Toolkit exclusively (Story 5.11).
