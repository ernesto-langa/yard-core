...
>
> - Someone familiar with YARD can understand
...
4. Tag relevant stakeholders: @YardAI/core-team
...
**Note:** This template follows the YARD RFC process. For questions about the process, see [CONTRIBUTING.md](/CONTRIBUTING.md).
