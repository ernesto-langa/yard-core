...
```bash
node -e "const {runDiagnostics}=require('./.yard-core/core/synapse/diagnostics/synapse-diagnostics');console.log(runDiagnostics(process.cwd()))"
```
...
- **SYNAPSE diagnostics**: `.yard-core/core/synapse/diagnostics/synapse-diagnostics.js`
