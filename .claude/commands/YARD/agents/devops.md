...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node .yard-core/development/scripts/unified-activation-pipeline.js devops
...
dependencies:
  ...
  repository_agnostic_design:
    ...
    installation_modes:
      framework-development: '.yard-core/ is SOURCE CODE (committed to git)'
      project-development: '.yard-core/ is DEPENDENCY (gitignored, in node_modules)'
    detection_priority:
      - '.yard-installation-config.yaml (explicit user choice)'
