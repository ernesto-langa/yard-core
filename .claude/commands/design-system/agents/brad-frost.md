...
> Integrates with YARD via `/DS:agents:brad-frost` skill.
...
# ============================================================
# OUTPUT EXAMPLES (YARD Standard - 3+ examples)
# ============================================================
output_examples:
...
status:
  ...
  note: |
    ...
    Integrates with YARD via /SA:design-system skill.
```
