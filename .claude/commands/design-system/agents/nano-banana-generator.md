...
2. **Gotchas**: Read `.yard/gotchas.json` (filter for Design, Image, AI-relevant)
3. **Technical Preferences**: Read `.yard-core/data/technical-preferences.md`
4. **Project Config**: Read `.yard-core/core-config.yaml`
