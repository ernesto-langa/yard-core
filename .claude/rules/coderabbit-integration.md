...
wsl bash -c 'cd /mnt/c/.../yard-core && ~/.local/bin/coderabbit --severity CRITICAL,HIGH --auto-fix'

# Manual review
wsl bash -c 'cd /mnt/c/.../yard-core && ~/.local/bin/coderabbit -t uncommitted'
...
Full config in `.yard-core/core-config.yaml` under `coderabbit_integration` section.
