...
- **Pre-commit:** `wsl bash -c 'cd /mnt/c/.../yard-core && ~/.local/bin/coderabbit --prompt-only -t uncommitted'`
- **Pre-PR:** `wsl bash -c 'cd /mnt/c/.../yard-core && ~/.local/bin/coderabbit --prompt-only --base main'`
...
Full examples registry: `.yard-core/data/mcp-tool-examples.yaml`
Tool registry: `.yard-core/data/tool-registry.yaml`
