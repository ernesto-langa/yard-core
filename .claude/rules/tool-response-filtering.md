---
paths:
  - .yard-core/data/tool-registry.yaml
  - .mcp.json
---
...
configuration defined in `.yard-core/data/tool-registry.yaml` for the tool that
...
`.yard-core/utils/filters/` are available for batch post-processing of
