...
Handoff artifacts are stored at `.yard/handoffs/` (runtime, gitignored). Format: `handoff-{from}-to-{to}-{timestamp}.yaml`.

## Template Reference

Full template: `.yard-core/development/templates/agent-handoff-tmpl.yaml`
