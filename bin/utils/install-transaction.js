...
class InstallTransaction {
   ...
   */
  constructor(options = {}) {
    this.backupDir = options.backupDir || path.join(process.cwd(), '.yard-core', 'backup', this._generateTimestamp());
    this.logFile = options.logFile || path.join(process.cwd(), '.yard-core', 'install.log');
   ...
   *
   * @example
   * await transaction.backupDirectory('.yard-core/');
   */
