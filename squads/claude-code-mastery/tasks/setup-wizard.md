...
1. Check for project markers:
   ...
   - `go.mod` -> Go project
   - `.yard-core/` -> YARD-managed project
...
| yard | .yard-core/ directory | acceptEdits |
...
5. If YARD project: include YARD-specific sections (agent system, workflows)
...
3. If YARD project: add L1-L4 boundary protection deny rules
