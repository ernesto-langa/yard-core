...
| integration | integrate, repository, project setup, CI/CD, headless, brownfield, monorepo, YARD, git workflow | project-integrator | Conduit |
...
1. Synthesize knowledge from the quick_reference section and YARD awareness
