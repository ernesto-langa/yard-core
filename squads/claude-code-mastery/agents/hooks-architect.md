...
IDE-FILE-RESOLUTION:
  ...
  - Example: create-hook.md -> .yard-core/development/tasks/create-hook.md
...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node .yard-core/development/scripts/unified-activation-pipeline.js hooks-architect
