...
IDE-FILE-RESOLUTION:
  ...
  - Example: create-agent.md → .yard-core/development/tasks/create-agent.md
...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node .yard-core/development/scripts/unified-activation-pipeline.js swarm-orchestrator
