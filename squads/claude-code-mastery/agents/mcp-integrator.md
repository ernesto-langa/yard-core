...
IDE-FILE-RESOLUTION:
  ...
  - Example: mcp-workflow.md -> .yard-core/development/tasks/mcp-workflow.md
...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node .yard-core/development/scripts/unified-activation-pipeline.js mcp-integrator
