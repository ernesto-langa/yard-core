...
IDE-FILE-RESOLUTION:
  ...
  - Example: update-knowledge.md -> .yard-core/development/tasks/update-knowledge.md
...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node .yard-core/development/scripts/unified-activation-pipeline.js roadmap-sentinel
