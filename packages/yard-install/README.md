# @ernesto-langa/yard-install

NPX installer for Yard - AI-Orchestrated System for Full Stack Development.

## Quick Start

```bash
npx @ernesto-langa/yard-install
```

That's it! The installer will guide you through setting up Yard in less than 5 minutes.
...
- **Brownfield support**: Detects existing Yard installations and offers migration
...
```bash
npx @ernesto-langa/yard-install --help
...
```bash
npx @ernesto-langa/yard-install --dry-run
```
...
```bash
npx @ernesto-langa/yard-install --profile bob
npx @ernesto-langa/yard-install --profile advanced
```
...
If you have an existing Yard installation, the installer will:
...
- Documentation: https://github.com/ernesto-langa/yard-core
