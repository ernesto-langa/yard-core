...
const nodeVersionCheck = require('../../../../../.yard-core/core/doctor/checks/node-version');
const npmPackagesCheck = require('../../../../../.yard-core/core/doctor/checks/npm-packages');
const settingsJsonCheck = require('../../../../../.yard-core/core/doctor/checks/settings-json');
const rulesFilesCheck = require('../../../../../.yard-core/core/doctor/checks/rules-files');
const agentMemoryCheck = require('../../../../../.yard-core/core/doctor/checks/agent-memory');
const entityRegistryCheck = require('../../../../../.yard-core/core/doctor/checks/entity-registry');
const gitHooksCheck = require('../../../../../.yard-core/core/doctor/checks/git-hooks');
const coreConfigCheck = require('../../../../../.yard-core/core/doctor/checks/core-config');
const claudeMdCheck = require('../../../../../.yard-core/core/doctor/checks/claude-md');
const graphDashboardCheck = require('../../../../../.yard-core/core/doctor/checks/graph-dashboard');
const codeIntelCheck = require('../../../../../.yard-core/core/doctor/checks/code-intel');
const ideSyncCheck = require('../../../../../.yard-core/core/doctor/checks/ide-sync');
const skillsCountCheck = require('../../../../../.yard-core/core/doctor/checks/skills-count');
const commandsCountCheck = require('../../../../../.yard-core/core/doctor/checks/commands-count');
const hooksClaudeCountCheck = require('../../../../../.yard-core/core/doctor/checks/hooks-claude-count');
const { loadChecks } = require('../../../../../.yard-core/core/doctor/checks');
...
describe('settings-json check', () => {
  it('should PASS with valid settings and sufficient deny rules', async () => {
    ...
    const mockSettings = {
      permissions: {
        deny: new Array(50).fill('Edit(.yard-core/core/)'),
        allow: ['Edit(docs/)'],
      },
    };
...
describe('code-intel check', () => {
  ...
  it('should PASS with RegistryProvider when entity-registry exists', async () => {
    ...
    const registryPath = path.join(realProjectRoot, '.yard-core', 'data', 'entity-registry.yaml');
...
describe('skills-count check', () => {
  ...
  it('should FAIL when 0 skills found', async () => {
    ...
    const result = await skillsCountCheck.run(mockContext);
    expect(result.status).toBe('FAIL');
    expect(result.fixCommand).toBe('npx yard-core install --force');
  });
