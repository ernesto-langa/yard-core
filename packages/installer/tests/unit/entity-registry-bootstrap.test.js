...
const POPULATE_SCRIPT = path.join(
  __dirname, '..', '..', '..', '..', '.yard-core', 'development', 'scripts', 'populate-entity-registry.js'
);
const DOCTOR_CHECK = path.join(
  __dirname, '..', '..', '..', '..', '.yard-core', 'core', 'doctor', 'checks', 'entity-registry.js'
);
const REGISTRY_PATH = path.join(
  __dirname, '..', '..', '..', '..', '.yard-core', 'data', 'entity-registry.yaml'
);
const PRE_PUSH_HOOK = path.join(__dirname, '..', '..', '..', '..', '.husky', 'pre-push');
const IDS_PRE_PUSH = path.join(
  __dirname, '..', '..', '..', '..', '.yard-core', 'hooks', 'ids-pre-push.js'
);
