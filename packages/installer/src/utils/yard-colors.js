/**
 * YARD Color Palette v5.0.0
 *
 * Brand color system for CLI tools and terminal output.
 * Colors derived from YARD brand identity: Orange + Cream on Dark surfaces.
 *
 * @see docs/standards/YARD-COLOR-PALETTE-V2.1.md
 * @module yard-colors
 */
...
const colors = {
   ...
   * YARD identity: Orange → Cream
   */
  gradient: {
    /** Gradient start - Orange (brand primary) */
    start: chalk.hex('#FF6600'),

    /** Gradient middle - Orange dim */
    middle: chalk.hex('#CC5200'),
  ...
  /**
   * Highlighted text - Bold orange for key information
   */
  highlight: chalk.hex('#FF6600').bold,

  /**
   * Primary branding - Bold orange for YARD brand moments
   */
  brandPrimary: chalk.hex('#FF6600').bold,
...
const examples = {
  welcome: () => {
    console.log(headings.h1('🎉 Welcome to Yard Installer!'));
  ...
  complete: () => {
    ...
    console.log(colors.info('Your Yard project is ready to use.'));
