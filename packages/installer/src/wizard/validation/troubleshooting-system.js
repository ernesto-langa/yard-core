...
const TROUBLESHOOTING_DATABASE = {
  ENV_FILE_MISSING: {
    ...
    solutions: [
      'Re-run wizard: npx @YardAI/yard@latest init',
      'Manually create .env from template: cp .env.example .env',
      'Check file permissions in project directory',
    ],
    docs: 'https://docs.YardAI.com/installation/environment',
    priority: 'critical',
  },
  ...
  CORE_CONFIG_MISSING: {
    ...
    causes: [
      'Environment configuration step failed',
      '.yard-core directory missing',
      'File creation failed',
    ],
    solutions: [
      'Re-run wizard: npx @YardAI/yard@latest init',
      'Check .yard-core directory exists',
      'Manually create from template',
    ],
    docs: 'https://docs.YardAI.com/configuration/core-config',
    priority: 'high',
  },
  ...
  MCP_HEALTH_CHECK_FAILED: {
    ...
    docs: 'https://docs.YardAI.com/mcps/troubleshooting',
    priority: 'medium',
  },
  ...
  GITIGNORE_CRITICAL_MISSING: {
    ...
    docs: 'https://docs.YardAI.com/security/gitignore',
    priority: 'high',
  },
  ...
  DEPS_INSTALL_FAILED: {
    ...
    docs: 'https://docs.YardAI.com/installation/dependencies',
    priority: 'critical',
  },
  ...
  ENV_PERMISSIONS_INSECURE: {
    ...
    docs: 'https://docs.YardAI.com/security/file-permissions',
    priority: 'medium',
  },
};
...
async function offerTroubleshooting(errors) {
  ...
  if (viewLogs) {
    ...
    console.log(chalk.dim('  - .yard/install-log.txt'));
    console.log(chalk.dim('  - .yard/install-errors.log'));
    console.log('');
    console.log(chalk.dim('View with: cat .yard/install-log.txt'));
  }
  ...
  if (openDocs) {
    ...
    console.log(chalk.green('  https://docs.YardAI.com/troubleshooting'));
    console.log('');
  }
  ...
  console.log(chalk.dim('  - GitHub Issues: https://github.com/YardAI/yard/issues'));
  console.log(chalk.dim('  - Documentation: https://docs.YardAI.com'));
  console.log('');
}
...
function displayGenericTroubleshooting(code, errorInstances) {
  ...
  console.log(chalk.green('  2. Check installation logs in .yard/'));
