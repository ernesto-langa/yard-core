...
async function validateFiles(fileContext = {}) {
  ...
  try {
    ...
    const coreConfigPath = fileContext.coreConfig || '.yard-core/core-config.yaml';
    ...
    // Validate directory structure - only .yard-core is required
    const requiredDirs = ['.yard-core'];
