/**
 * Internationalization (i18n) for Yard Wizard
 *
...
const TRANSLATIONS = {
  en: {
    ...
    // Progress messages
    installingCore: 'Installing Yard core...',
    ...
    readyToUse: 'Your Yard project is ready.',
    ...
    tryAgain: 'Run `npx yard-core init` to try again.',
    ...
    proNoAccess: 'No Yard Pro access found for this email.',
    ...
    proModuleNotAvailable: 'Pro license module not available. Ensure @ernesto-langa/yard-pro is installed.',
    proModuleBootstrap: 'Pro license module not found locally. Installing @ernesto-langa/yard-pro to bootstrap...',
    ...
    proInstallingPackage: 'Installing @ernesto-langa/yard-pro...',
    proPackageInstalled: 'Pro package installed',
    proPackageInstallFailed: 'Failed to install Pro package',
    proScaffolderNotAvailable: 'Pro scaffolder not available. Ensure @ernesto-langa/yard-pro is installed.',
    ...
    proNpmInstallFailed: 'npm install @ernesto-langa/yard-pro failed: {message}. Try manually: npm install @ernesto-langa/yard-pro',
  },
  ...
  pt: {
    ...
    // Progress messages
    installingCore: 'Instalando Yard core...',
    ...
    readyToUse: 'Seu projeto Yard está pronto.',
    ...
    tryAgain: 'Execute `npx yard-core init` para tentar novamente.',
    continuing: 'Continuando instalação...',

    // Pro Installation Wizard (pro-setup.js)
    proWizardTitle: 'Assistente de Instalação Yard Pro',
    ...
    proNoAccess: 'Nenhum acesso Yard Pro encontrado para este email.',
    ...
    proModuleNotAvailable: 'Módulo de licença Pro não disponível. Certifique-se de que @ernesto-langa/yard-pro está instalado.',
    proModuleBootstrap: 'Módulo de licença Pro não encontrado localmente. Instalando @ernesto-langa/yard-pro...',
    ...
    proInstallingPackage: 'Instalando @ernesto-langa/yard-pro...',
    proPackageInstalled: 'Pacote Pro instalado',
    proPackageInstallFailed: 'Falha ao instalar pacote Pro',
    proScaffolderNotAvailable: 'Scaffolder Pro não disponível. Certifique-se de que @ernesto-langa/yard-pro está instalado.',
    ...
    proNpmInstallFailed: 'npm install @ernesto-langa/yard-pro falhou: {message}. Tente manualmente: npm install @ernesto-langa/yard-pro',
  },
  ...
  es: {
    ...
    readyToUse: 'Tu proyecto Yard está listo.',
    ...
    tryAgain: 'Ejecute `npx yard-core init` para intentar nuevamente.',
    continuing: 'Continuando instalación...',

    // Pro Installation Wizard (pro-setup.js)
    proWizardTitle: 'Asistente de Instalación Yard Pro',
    ...
    proNoAccess: 'No se encontró acceso Yard Pro para este email.',
    ...
    proModuleNotAvailable: 'Módulo de licencia Pro no disponible. Asegúrese de que @ernesto-langa/yard-pro esté instalado.',
    proModuleBootstrap: 'Módulo de licencia Pro no encontrado localmente. Instalando @ernesto-langa/yard-pro...',
    ...
    proScaffolderNotAvailable: 'Scaffolder Pro no disponible. Asegúrese de que @ernesto-langa/yard-pro esté instalado.',
    ...
    proNpmInstallFailed: 'npm install @ernesto-langa/yard-pro falló: {message}. Intente manualmente: npm install @ernesto-langa/yard-pro',
  },
};
