 ...
 * @param {string} sourceDir - Source package directory (.yard-core from npm)
 ...
 * @param {string} sourceDir - Source directory (npm package .yard-core)
 * @param {string} targetDir - Target project directory
...
function updateInstalledManifest(targetDir, sourceManifest, sourcePackage) {
  const installedManifestPath = path.join(targetDir, '.yard-core', '.installed-manifest.yaml');
