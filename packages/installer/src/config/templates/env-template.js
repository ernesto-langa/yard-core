...
/**
 * Get the current YARD version from package.json
 * @returns {string} The version string
 */
function getYardVersion() {
  try {
...
const YARD_VERSION = getYardVersion();
