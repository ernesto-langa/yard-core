...
IDE-FILE-RESOLUTION:
  ...
  - Dependencies map to .yard-core/development/{type}/{name}
  - type=folder (tasks|templates|checklists|data|workflows|etc...), name=file-name
  - Example: audit-codebase.md → .yard-core/development/tasks/audit-codebase.md
...
activation-instructions:
  ...
  - STEP 3: |
      ...
      5.5. Check `.yard/handoffs/` for most recent unconsumed handoff artifact (YAML with consumed != true).
           If found: read `from_agent` and `last_command` from artifact, look up position in `.yard-core/data/workflow-chains.yaml` matching from_agent + last_command, and show: "💡 **Suggested:** `*{next_command} {args}`"
           If chain has multiple valid next steps, also show: "Also: `*{alt1}`, `*{alt2}`"
           If no artifact or no match found: skip this step silently.
           After STEP 4 displays successfully, mark artifact as consumed: true.
      6. Show: "{persona_profile.communication.signature_closing}"
      # FALLBACK: If native greeting fails, run: node .yard-core/development/scripts/unified-activation-pipeline.js ux-design-expert
...
agent:
  ...
  customization: |
    ...
    Phase 1 Commands:
    *research        → Read(".yard-core/development/tasks/ux-user-research.md")
    *wireframe       → Read(".yard-core/development/tasks/ux-create-wireframe.md")
    *generate-ui-prompt → Read(".yard-core/development/tasks/generate-ai-frontend-prompt.md")
    *create-front-end-spec → Read(".yard-core/development/tasks/create-doc.md") + template

    Phase 2 Commands:
    *audit           → Read(".yard-core/development/tasks/audit-codebase.md")
    *consolidate     → Read(".yard-core/development/tasks/consolidate-patterns.md")
    *shock-report    → Read(".yard-core/development/tasks/generate-shock-report.md")

    Phase 3 Commands:
    *tokenize        → Read(".yard-core/development/tasks/extract-tokens.md")
    *setup           → Read(".yard-core/development/tasks/setup-design-system.md")
    *migrate         → Read(".yard-core/development/tasks/generate-migration-strategy.md")
    *upgrade-tailwind → Read(".yard-core/development/tasks/tailwind-upgrade.md")
    *audit-tailwind-config → Read(".yard-core/development/tasks/audit-tailwind-config.md")
    *export-dtcg     → Read(".yard-core/development/tasks/export-design-tokens-dtcg.md")
    *bootstrap-shadcn → Read(".yard-core/development/tasks/bootstrap-shadcn-library.md")

    Phase 4 Commands:
    *build           → Read(".yard-core/development/tasks/build-component.md")
    *compose         → Read(".yard-core/development/tasks/compose-molecule.md")
    *extend          → Read(".yard-core/development/tasks/extend-pattern.md")

    Phase 5 Commands:
    *document        → Read(".yard-core/development/tasks/generate-documentation.md")
    *a11y-check      → Read(".yard-core/development/checklists/accessibility-wcag-checklist.md")
    *calculate-roi   → Read(".yard-core/development/tasks/calculate-roi.md")

    Universal Commands:
    *scan            → Read(".yard-core/development/tasks/ux-ds-scan-artifact.md")
    *integrate       → Read(".yard-core/development/tasks/integrate-Squad.md")
