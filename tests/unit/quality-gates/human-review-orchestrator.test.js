...
describe('HumanReviewOrchestrator', () => {
  ...
  beforeEach(() => {
    orchestrator = new HumanReviewOrchestrator({
      statusPath: '.yard/qa-status-test.json',
      reviewRequestsPath: '.yard/human-review-requests-test',
    });
  });
  ...
  describe('constructor', () => {
    ...
    it('should create orchestrator with custom config', () => {
      expect(orchestrator.statusPath).toBe('.yard/qa-status-test.json');
      expect(orchestrator.reviewRequestsPath).toBe('.yard/human-review-requests-test');
    });
  });
