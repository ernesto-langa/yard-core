...
const { RegistryProvider, LAYER_PRIORITY } = require('../../../.yard-core/core/code-intel/providers/registry-provider');
const { CodeIntelProvider } = require('../../../.yard-core/core/code-intel/providers/provider-interface');
const { CodeGraphProvider } = require('../../../.yard-core/core/code-intel/providers/code-graph-provider');
const { CodeIntelClient, CB_CLOSED } = require('../../../.yard-core/core/code-intel/code-intel-client');
...
entities:
  tasks:
    create-story:
      path: .yard-core/development/tasks/create-story.md
      layer: L2
      type: task
      ...
      dependencies:
        - story-template
    validate-story:
      path: .yard-core/development/tasks/validate-story.md
      layer: L2
      type: task
  ...
  agents:
    dev-agent:
      path: .yard-core/development/agents/dev.md
      layer: L2
      type: agent
      ...
      dependencies:
        - create-story
    sm-agent:
      path: .yard-core/development/agents/sm.md
      layer: L2
      type: agent
  ...
  templates:
    story-template:
      path: .yard-core/development/templates/story-tmpl.yaml
      layer: L2
      type: template
  ...
  core:
    code-intel-client:
      path: .yard-core/core/code-intel/code-intel-client.js
      layer: L1
      type: module
...
entities:
  tasks:
    yaml-validator:
      path: .yard-core/development/tasks/yaml-validator.md
      layer: L2
      type: task
      ...
      dependencies: []
    index:
      path: .yard-core/development/tasks/index.md
      layer: L2
      type: task
  ...
  scripts:
    yaml-validator:
      path: .yard-core/development/scripts/yaml-validator.js
      layer: L2
      type: script
      ...
      dependencies: []
    backup-manager:
      path: .yard-core/development/scripts/backup-manager.js
      layer: L2
      type: script
  ...
  core:
    yaml-validator:
      path: .yard-core/core/yaml-validator.js
      layer: L1
      type: module
    ...
    index:
      ...
      dependencies: []
    backup-manager:
      path: .yard-core/core/backup-manager.js
      layer: L1
      type: module
  ...
  templates:
    yaml-validator:
      path: .yard-core/development/templates/yaml-validator.yaml
      layer: L3
      type: template
      ...
      dependencies: []
    index:
      path: .yard-core/development/templates/index.yaml
      layer: L3
      type: template
      ...
      dependencies: []
    backup-manager:
      path: .yard-core/development/templates/backup-manager.yaml
      layer: L3
      type: template
...
describe('RegistryProvider — 5 Implemented Primitives', () => {
  ...
  describe('findDefinition()', () => {
    test('finds entity by exact name', async () => {
      ...
      expect(result.file).toBe('.yard-core/development/tasks/create-story.md');
  ...
  describe('findReferences()', () => {
    ...
    test('finds references via dependencies field', async () => {
      ...
      expect(paths).toContain('.yard-core/development/tasks/create-story.md');
    });
...
describe('RegistryProvider — Entity Name Disambiguation', () => {
  ...
  test('yaml-validator has 4 entries, all preserved in index', async () => {
    ...
    expect(result.file).toBe('.yard-core/core/yaml-validator.js');
  });
  ...
  test('disambiguation scoring: L1 > L2 > L3', async () => {
    ...
    const result = await provider.findDefinition('yaml-validator');
    expect(result.file).toContain('.yard-core/core/');
  });
});
