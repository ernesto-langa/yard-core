...
// Test modules
const { searchKeyword, fuzzyMatchScore, levenshteinDistance } = require('../../.yard-core/cli/commands/workers/search-keyword');
const { applyFilters, filterByCategory, filterByTags } = require('../../.yard-core/cli/commands/workers/search-filters');
const { formatOutput, formatTable, formatJSON, formatYAML } = require('../../.yard-core/cli/utils/output-formatter-cli');
const { calculateScores, sortByScore, calculateSearchAccuracy } = require('../../.yard-core/cli/utils/score-calculator');
const { isSemanticAvailable, cosineSimilarity, buildSearchText } = require('../../.yard-core/cli/commands/workers/search-semantic');
...
const mockWorkers = [
  {
    ...
    path: '.yard-core/development/tasks/data/json-csv-transformer.md',
  },
  {
    ...
    subcategory: 'transformation',
    tags: ['etl', 'data', 'json', 'csv'],
    path: '.yard-core/development/tasks/data/csv-json-transformer.md',
  },
  {
    id: 'json-validator',
    ...
    path: '.yard-core/development/tasks/validation/json-validator.md',
  },
  {
    id: 'api-generator',
    ...
    path: '.yard-core/development/tasks/code/api-generator.md',
  },
  {
    id: 'test-runner',
    name: 'Test Runner',
    ...
    path: '.yard-core/development/tasks/testing/test-runner.md',
  },
];
  ...
  const testResults = [
    {
      ...
      tags: ['etl', 'json', 'csv'],
      score: 95,
      path: '.yard-core/tasks/json-csv-transformer.md',
    },
  ];
