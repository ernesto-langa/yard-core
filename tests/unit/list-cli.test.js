...
// Test modules
const { formatTree, formatTreeCollapsed, groupWorkers } = require('../../.yard-core/cli/commands/workers/formatters/list-tree');
const { formatTable, formatJSON, formatYAML, formatList, formatCount, truncate } = require('../../.yard-core/cli/commands/workers/formatters/list-table');
const { paginate, formatPaginationInfo, formatPaginationHint } = require('../../.yard-core/cli/commands/workers/utils/pagination');
...
const mockWorkers = [
  ...
  },
  {
    ...
    subcategory: 'transformation',
    tags: ['etl', 'json', 'csv'],
    path: '.yard-core/tasks/csv-json-transformer.md',
  },
  {
    id: 'json-validator',
    ...
    path: '.yard-core/tasks/json-validator.md',
  },
  {
    id: 'unit-test-runner',
    ...
    path: '.yard-core/tasks/unit-test-runner.md',
  },
  {
    id: 'api-generator',
    ...
    path: '.yard-core/tasks/api-generator.md',
  },
];
...
describe('Performance Requirements', () => {
  ...
  const largeMockWorkers = Array.from({ length: 250 }, (_, i) => ({
    ...
    tags: ['tag1', 'tag2', 'tag3'],
    path: `.yard-core/tasks/worker-${i}.md`,
  }));
