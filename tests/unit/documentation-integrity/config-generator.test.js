...
const {
  ...
  DeploymentWorkflow,
  DeploymentPlatform,
} = require('../../../.yard-core/infrastructure/scripts/documentation-integrity/config-generator');
...
describe('Config Generator', () => {
  ...
  describe('generateConfig', () => {
    ...
    it('should create .yard-core directory', () => {
      const context = buildConfigContext('test', 'greenfield', {});

      generateConfig(tempDir, 'greenfield', context);

      expect(fs.existsSync(path.join(tempDir, '.yard-core'))).toBe(true);
      expect(fs.existsSync(path.join(tempDir, '.yard-core', 'core-config.yaml'))).toBe(true);
    });
    ...
    it('should support dry run mode', () => {
      ...
      expect(result.success).toBe(true);
      expect(result.content).toBeTruthy();
      expect(fs.existsSync(path.join(tempDir, '.yard-core'))).toBe(false);
    });
