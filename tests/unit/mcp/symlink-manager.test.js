...
jest.mock('../../../.yard-core/core/mcp/os-detector', () => ({
  isWindows: jest.fn(),
...
const {
  ...
  createLink,
  removeLink,
} = require('../../../.yard-core/core/mcp/symlink-manager');

const osDetector = require('../../../.yard-core/core/mcp/os-detector');

describe('Symlink Manager', () => {
  const mockProjectRoot = '/mock/project';
  const mockGlobalMcpDir = '/mock/home/.yard/mcp';
  const mockLinkPath = path.join(mockProjectRoot, '.yard-core', 'tools', 'mcp');
  ...
  describe('getProjectMcpPath', () => {
    it('should return correct path for project root', () => {
      ...
      expect(result).toBe(path.join(mockProjectRoot, '.yard-core', 'tools', 'mcp'));
    });

    it('should use current directory when no root provided', () => {
      const cwd = process.cwd();
      const result = getProjectMcpPath();
      expect(result).toBe(path.join(cwd, '.yard-core', 'tools', 'mcp'));
    });
  });
