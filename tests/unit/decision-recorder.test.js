 ...
 *
 * @see .yard-core/scripts/decision-recorder.js
 */
...
const {
  ...
  getCurrentContext,
} = require('../../.yard-core/development/scripts/decision-recorder');

// Mock decision-log-generator
jest.mock('../../.yard-core/development/scripts/decision-log-generator', () => ({
...
describe('decision-recorder', () => {
  ...
  describe('completeDecisionLogging', () => {
    it('should complete logging and generate log file', async () => {
      const { generateDecisionLog } = require('../../.yard-core/development/scripts/decision-log-generator');
