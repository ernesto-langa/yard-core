...
const { validatePaths } = require('../../.yard-core/infrastructure/scripts/validate-paths');
  ...
  it('passes with relative canonical paths', () => {
    ...
    write(
      ...
      [
        ...
        'Run node .yard-core/development/scripts/generate-greeting.js dev',
      ].join('\n'),
    );
    ...
    const result = validatePaths({
      ...
      requiredFiles: [
        ...
        path.join(tmpRoot, '.yard-core', 'product', 'templates', 'ide-rules', 'codex-rules.md'),
      ],
    });
