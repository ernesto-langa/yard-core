...
const { resolveConfig: mockResolveConfig } = require('../../.yard-core/core/config/config-resolver');
...
const { loadProjectStatus, formatStatusDisplay } = require('../../.yard-core/infrastructure/scripts/project-status-loader');
