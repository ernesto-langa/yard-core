...
const PersonalizedOutputFormatter = require('../../.yard-core/infrastructure/scripts/output-formatter');
const OutputPatternValidator = require('../../.yard-core/infrastructure/scripts/validate-output-pattern');
const fs = require('fs');
...
- .yard-core/scripts/output-formatter.js
- .yard-core/scripts/validate-output-pattern.js
- .yard-core/templates/task-execution-report.md
