...
describe('Pattern Learning Integration', () => {
  ...
  beforeAll(() => {
    learningModule = require('../../../.yard-core/workflow-intelligence/learning');
  });
  ...
  describe('Capture Hook Integration', () => {
    ...
    beforeAll(() => {
      captureHook = require('../../../.yard-core/workflow-intelligence/learning/capture-hook');
    });
  ...
  describe('WIS Integration', () => {
    it('should be accessible from main WIS module', () => {
      const wis = require('../../../.yard-core/workflow-intelligence');
