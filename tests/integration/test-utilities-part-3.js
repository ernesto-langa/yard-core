...
utilities.forEach(util => {
  try {
    const utilPath = path.join(__dirname, '../../yard-core/utils', `${util}.js`);
    require(utilPath);
...
const agents = [
  { name: 'qa', path: '.yard-core/development/agents/qa.md' },
  { name: 'po', path: '.yard-core/development/agents/po.md' },
  { name: 'devops', path: '.yard-core/development/agents/devops.md' },
  { name: 'dev', path: '.yard-core/development/agents/dev.md' },
];
