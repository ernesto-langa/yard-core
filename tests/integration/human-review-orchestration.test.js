...
const { HumanReviewOrchestrator } = require('../../.yard-core/core/quality-gates/human-review-orchestrator');
const { FocusAreaRecommender } = require('../../.yard-core/core/quality-gates/focus-area-recommender');
const { NotificationManager } = require('../../.yard-core/core/quality-gates/notification-manager');
  ...
  describe('HUMAN-01: Orchestration Flow', () => {
    ...
    beforeEach(() => {
      orchestrator = new HumanReviewOrchestrator({
        statusPath: '.yard/qa-status-integration-test.json',
        reviewRequestsPath: '.yard/human-review-requests-integration-test',
      });
