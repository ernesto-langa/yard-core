...
describeIntegration('Google Workspace Tool Validators', () => {
  ...
  beforeAll(async () => {
    // Set search path to yard-core/tools
    const toolsPath = path.join(__dirname, '../../yard-core/tools');
  ...
  describeIntegration('Tool Resolution', () => {
    test('should resolve google-workspace tool from yard-core/tools/mcp', async () => {
