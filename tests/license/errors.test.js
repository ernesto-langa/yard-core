...
describe('errors', () => {
  describe('ProFeatureError', () => {
    ...
    it('should include activation instructions in message', () => {
      ...
      expect(error.message).toContain('Premium Squads requires an active YARD Pro license');
      expect(error.message).toContain('yard pro activate --key <KEY>');
    ...
    describe('toCliMessage', () => {
      it('should return formatted CLI message', () => {
        ...
        expect(cliMsg).toContain('Premium Squads requires an active YARD Pro license');
    ...
    describe('toJSON', () => {
      it('should return JSON-serializable object', () => {
        ...
        expect(json.message).toContain('requires an active YARD Pro license');
