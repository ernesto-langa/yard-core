...
const os = require('os');
const HealerManager = require('../../.yard-core/core/health-check/healers');
const { HealingTier, BackupManager } = require('../../.yard-core/core/health-check/healers');
const { CheckStatus } = require('../../.yard-core/core/health-check/base-check');
