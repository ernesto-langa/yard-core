...
const claudeCode = require('../../.yard-core/infrastructure/scripts/ide-sync/transformers/claude-code');
const cursor = require('../../.yard-core/infrastructure/scripts/ide-sync/transformers/cursor');
const antigravity = require('../../.yard-core/infrastructure/scripts/ide-sync/transformers/antigravity');
...
describe('IDE Transformers', () => {
  ...
  describe('claude-code transformer', () => {
    ...
    it('should add sync footer if not present', () => {
      const result = claudeCode.transform(sampleAgent);
      expect(result).toContain('Synced from .yard-core/development/agents/dev.md');
    });
