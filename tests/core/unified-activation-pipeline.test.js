...
jest.mock('../../.yard-core/development/scripts/agent-config-loader', () => ({
  AgentConfigLoader: jest.fn().mockImplementation(() => ({
    loadComplete: jest.fn().mockResolvedValue({
      config: { dataLocation: '.yard-core/data' },
...
jest.mock('../../.yard-core/core/session/context-loader', () => {
...
jest.mock('../../.yard-core/infrastructure/scripts/project-status-loader', () => ({
  loadProjectStatus: jest.fn().mockResolvedValue(mockProjectStatus),
}));

// Mock git config detector
jest.mock('../../.yard-core/infrastructure/scripts/git-config-detector', () => {
  return jest.fn().mockImplementation(() => ({
...
jest.mock('../../.yard-core/core/permissions', () => ({
...
jest.mock('../../.yard-core/core/config/config-resolver', () => ({
...
jest.mock('../../.yard-core/infrastructure/scripts/validate-user-profile', () => ({
...
jest.mock('../../.yard-core/development/scripts/greeting-preference-manager', () => {
  return jest.fn().mockImplementation(() => ({
...
jest.mock('../../.yard-core/core/session/context-detector', () => {
  return jest.fn().mockImplementation(() => ({
...
jest.mock('../../.yard-core/development/scripts/workflow-navigator', () => {
  return jest.fn().mockImplementation(() => ({
...
// Mock config cache
jest.mock('../../.yard-core/core/config/config-cache', () => ({
  globalConfigCache: {
...
jest.mock('../../.yard-core/infrastructure/scripts/performance-tracker', () => ({
  trackConfigLoad: jest.fn(),
}));

// --- Require modules AFTER mocks ---
const { UnifiedActivationPipeline, ALL_AGENT_IDS, LOADER_TIERS, DEFAULT_PIPELINE_TIMEOUT_MS, FALLBACK_PHRASE } = require('../../.yard-core/development/scripts/unified-activation-pipeline');
const { AgentConfigLoader } = require('../../.yard-core/development/scripts/agent-config-loader');
const SessionContextLoader = require('../../.yard-core/core/session/context-loader');
const { loadProjectStatus } = require('../../.yard-core/infrastructure/scripts/project-status-loader');
const GitConfigDetector = require('../../.yard-core/infrastructure/scripts/git-config-detector');
const { PermissionMode } = require('../../.yard-core/core/permissions');
...
describe('UnifiedActivationPipeline', () => {
  ...
  beforeEach(() => {
    ...
    const ContextDetector = require('../../.yard-core/core/session/context-detector');
  ...
  describe('generate-greeting.js backward compatibility', () => {
    it('should export generateGreeting function', () => {
      const { generateGreeting } = require('../../.yard-core/development/scripts/generate-greeting');
