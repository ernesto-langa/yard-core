...
const {
  BobOrchestrator,
  ProjectState,
} = require('../../../.yard-core/core/orchestration/bob-orchestrator');
...
jest.mock('../../../.yard-core/core/orchestration/message-formatter', () => ({
...
jest.mock('../../../.yard-core/core/orchestration/brownfield-handler', () => ({
...
jest.mock('../../../.yard-core/core/orchestration/executor-assignment', () => ({
...
jest.mock('../../../.yard-core/core/orchestration/terminal-spawner', () => ({
  spawnAgent: jest.fn().mockResolvedValue({ success: true, output: 'done' }),
  isSpawnerAvailable: jest.fn().mockReturnValue(true),
}));

jest.mock('../../../.yard-core/core/orchestration/workflow-executor', () => {
  return {
...
jest.mock('../../../.yard-core/core/ui/observability-panel', () => ({
...
jest.mock('../../../.yard-core/core/orchestration/bob-status-writer', () => ({
...
jest.mock('../../../.yard-core/core/events/dashboard-emitter', () => ({
...
jest.mock('../../../.yard-core/core/orchestration/lock-manager', () => {
...
jest.mock('../../../.yard-core/core/orchestration/data-lifecycle-manager', () => {
...
const { resolveConfig } = require('../../../.yard-core/core/config/config-resolver');
...
describe('BobOrchestrator', () => {
  ...
  beforeEach(async () => {
    ...
    await fs.mkdir(path.join(process.cwd(), '.yard', 'locks'), { recursive: true });
  ...
  describe('orchestrate', () => {
    it('should return lock_failed when lock cannot be acquired', async () => {
      // Given
      const LockManager = require('../../../.yard-core/core/orchestration/lock-manager');
  ...
  describe('constraint: router not god class (AC13)', () => {
    it('should have less than 50 lines of other-agent-specific logic', async () => {
      ...
      const sourcePath = path.join(
        __dirname,
        '../../../.yard-core/core/orchestration/bob-orchestrator.js',
      );
  ...
  describe('Educational Mode (Story 12.7)', () => {
    ...
    describe('handleEducationalModeToggle (AC6)', () => {
      ...
      it('should persist to user config for permanent type', async () => {
        // Given
        const { setUserConfigValue } = require('../../../.yard-core/core/config/config-resolver');
