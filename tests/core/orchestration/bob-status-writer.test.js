...
} = require('../../../.yard-core/core/orchestration/bob-status-writer');
...
describe('BobStatusWriter', () => {
  ...
  describe('constructor', () => {
    ...
    it('should set correct paths', () => {
      ...
      expect(writer.dashboardDir).toBe(path.join(tempDir, '.yard', 'dashboard'));
      expect(writer.statusPath).toBe(path.join(tempDir, '.yard', 'dashboard', 'bob-status.json'));
    });
  });
