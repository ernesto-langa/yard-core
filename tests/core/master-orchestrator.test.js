...
const MasterOrchestrator = require('../../.yard-core/core/orchestration/master-orchestrator');
...
describe('MasterOrchestrator', () => {
  ...
  beforeEach(async () => {
    ...
    // Create .yard/dashboard directory for dashboard integration
    await fs.ensureDir(path.join(tempDir, '.yard', 'dashboard'));
  ...
  describe('State Persistence (Story 0.2)', () => {
    describe('saveState (AC1, AC3)', () => {
      it('should save state to correct path', async () => {
        ...
        expect(normalizedPath).toContain('.yard/master-orchestrator/TEST-001.json');
