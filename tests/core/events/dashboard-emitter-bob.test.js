...
const { DashboardEmitter, getDashboardEmitter } = require('../../../.yard-core/core/events/dashboard-emitter');
const { DashboardEventType } = require('../../../.yard-core/core/events/types');
...
describe('DashboardEmitter Bob-specific methods', () => {
  ...
  beforeEach(async () => {
    ...
    emitter.fallbackPath = path.join(tempDir, '.yard', 'dashboard', 'events.jsonl');
  });
