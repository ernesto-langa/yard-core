...
const { validateUserProfile } = require('../../.yard-core/infrastructure/scripts/validate-user-profile');

// Import modules under test after mocks
const GreetingPreferenceManager = require('../../.yard-core/development/scripts/greeting-preference-manager');
...
describe('validate-user-profile standalone', () => {
  ...
  const actualValidateUserProfile = jest.requireActual(
    '../../.yard-core/infrastructure/scripts/validate-user-profile',
  ).validateUserProfile;
