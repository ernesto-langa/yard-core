...
jest.mock('../../.yard-core/workflow-intelligence/engine/wave-analyzer', () => null);
jest.mock('../../.yard-core/infrastructure/scripts/worktree-manager', () => { throw new Error('not available'); });
jest.mock('../../.yard-core/core/memory/gotchas-memory', () => { throw new Error('not available'); });
...
const {
  ...
  Phase,
  DEFAULT_CONFIG,
} = require('../../.yard-core/core/execution/build-orchestrator');
