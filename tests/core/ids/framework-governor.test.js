...
const { IncrementalDecisionEngine } = require('../../../.yard-core/core/ids/incremental-decision-engine');
const { FrameworkGovernor, TIMEOUT_MS, RISK_THRESHOLDS } = require('../../../.yard-core/core/ids/framework-governor');
...
describe('FrameworkGovernor', () => {
  ...
  describe('postRegister()', () => {
    ...
    it('should use onAgentTaskComplete (not processChanges) per SF-1', async () => {
      await governor.postRegister('.yard-core/development/tasks/new-task.md', {});
      ...
      it('should include recommendations when matches found', () => {
        const result = {
          ...
          recommendations: [{
            ...
            decision: 'ADAPT',
            relevanceScore: 0.75,
            entityPath: '.yard-core/development/tasks/create-doc.md',
          }],
        };
        const output = FrameworkGovernor.formatPreCheckOutput(result);
    ...
    describe('formatImpactOutput()', () => {
      ...
      it('should show safe-to-modify for zero consumers', () => {
        const result = {
          entityId: 'po',
          found: true,
          entityPath: '.yard-core/development/agents/po.md',
          entityType: 'agent',
          riskLevel: 'NONE',
          directConsumers: [],
          indirectConsumers: [],
