...
jest.mock('../../.yard-core/development/scripts/unified-activation-pipeline', () => ({
...
const { ActivationRuntime, activateAgent } = require('../../.yard-core/development/scripts/activation-runtime');
