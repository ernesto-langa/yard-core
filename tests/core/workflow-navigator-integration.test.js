...
// Mock SessionState
jest.mock('../../.yard-core/core/orchestration/session-state', () => ({
...
// Mock SurfaceChecker
jest.mock('../../.yard-core/core/orchestration/surface-checker', () => ({
...
const { SessionState } = require('../../.yard-core/core/orchestration/session-state');
const { SurfaceChecker } = require('../../.yard-core/core/orchestration/surface-checker');
...
describe('WorkflowNavigator Integration (Story ACT-5)', () => {
  ...
  describe('AC5: Bob orchestration patterns in workflow-patterns.yaml', () => {
    ...
    beforeAll(() => {
      const patternsPath = path.join(
        __dirname,
        '../../.yard-core/data/workflow-patterns.yaml',
      );
  ...
  describe('UnifiedActivationPipeline _detectWorkflowState relaxation', () => {
    ...
    beforeEach(() => {
      ...
      jest.mock('../../.yard-core/development/scripts/greeting-builder');
      ...
      const { UnifiedActivationPipeline } = require('../../.yard-core/development/scripts/unified-activation-pipeline');
      const MockWorkflowNavigator = require('../../.yard-core/development/scripts/workflow-navigator');
