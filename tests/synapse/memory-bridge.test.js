...
jest.mock('../../.yard-core/core/synapse/memory/synapse-memory-provider', () => ({
...
const { MemoryBridge, BRACKET_LAYER_MAP, BRIDGE_TIMEOUT_MS } = require('../../.yard-core/core/synapse/memory/memory-bridge');
