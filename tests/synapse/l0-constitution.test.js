...
const os = require('os');
const LayerProcessor = require('../../.yard-core/core/synapse/layers/layer-processor');
const L0ConstitutionProcessor = require('../../.yard-core/core/synapse/layers/l0-constitution');
