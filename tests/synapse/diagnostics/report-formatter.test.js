...
const { formatReport } = jest.requireActual(
  '../../../.yard-core/core/synapse/diagnostics/report-formatter',
);
...
jest.mock('../../../.yard-core/core/synapse/diagnostics/collectors/hook-collector');
jest.mock('../../../.yard-core/core/synapse/diagnostics/collectors/session-collector');
jest.mock('../../../.yard-core/core/synapse/diagnostics/collectors/manifest-collector');
jest.mock('../../../.yard-core/core/synapse/diagnostics/collectors/pipeline-collector');
jest.mock('../../../.yard-core/core/synapse/diagnostics/collectors/uap-collector');
jest.mock('../../../.yard-core/core/synapse/diagnostics/report-formatter');
jest.mock('../../../.yard-core/core/synapse/domain/domain-loader');

const { collectHookStatus } = require('../../../.yard-core/core/synapse/diagnostics/collectors/hook-collector');
const { collectSessionStatus } = require('../../../.yard-core/core/synapse/diagnostics/collectors/session-collector');
const { collectManifestIntegrity } = require('../../../.yard-core/core/synapse/diagnostics/collectors/manifest-collector');
const { collectPipelineSimulation } = require('../../../.yard-core/core/synapse/diagnostics/collectors/pipeline-collector');
const { collectUapBridgeStatus } = require('../../../.yard-core/core/synapse/diagnostics/collectors/uap-collector');
const { formatReport: mockFormatReport } = require('../../../.yard-core/core/synapse/diagnostics/report-formatter');
const { parseManifest } = require('../../../.yard-core/core/synapse/domain/domain-loader');

const { runDiagnostics, runDiagnosticsRaw } = require('../../../.yard-core/core/synapse/diagnostics/synapse-diagnostics');
