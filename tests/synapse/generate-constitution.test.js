...
const {
  ...
  main,
  ROMAN_TO_ARABIC,
} = require('../../.yard-core/core/synapse/scripts/generate-constitution');
const { parseManifest, loadDomainFile } = require('../../.yard-core/core/synapse/domain/domain-loader');
 ...
 */
const FULL_CONSTITUTION = `# YARD Constitution
...
describe('generateConstitution', () => {
  ...
  test('should include header comments', () => {
    ...
    expect(output).toContain('# Auto-generated from .yard-core/constitution.md');
...
describe('integration: real constitution.md', () => {
  const realConstitutionPath = path.join(__dirname, '..', '..', '.yard-core', 'constitution.md');
