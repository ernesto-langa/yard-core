...
const PIPELINE_MODULES = [
  '.yard-core/development/scripts/unified-activation-pipeline',
  '.yard-core/development/scripts/greeting-builder',
  '.yard-core/development/scripts/agent-config-loader',
  '.yard-core/development/scripts/greeting-preference-manager',
  '.yard-core/development/scripts/workflow-navigator',
  '.yard-core/core/session/context-loader',
  '.yard-core/core/session/context-detector',
  '.yard-core/core/permissions',
  '.yard-core/infrastructure/scripts/project-status-loader',
  '.yard-core/infrastructure/scripts/git-config-detector',
  '.yard-core/core/config/config-resolver',
  '.yard-core/core/config/config-cache',
];
...
async function runBenchmark(options) {
  const pipelinePath = path.resolve(
    PROJECT_ROOT, '.yard-core/development/scripts/unified-activation-pipeline',
  );
