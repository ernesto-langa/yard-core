...
1. **Instale o AIOX**: Execute `npx yard-core init meu-projeto`
...
npx yard-core uninstall   Remover AIOX
```
...
> **Disponibilidade restrita:** O Yard Pro está disponível exclusivamente para membros do **Yard Cohort Advanced**. [Saiba mais sobre o programa](https://aioxsquad.ai).
...
# Validador AIOX
node .yard-core/utils/aiox-validator.js pre-commit   # Validação pre-commit
node .yard-core/utils/aiox-validator.js pre-push     # Validação pre-push
node .yard-core/utils/aiox-validator.js stories      # Validar todas stories
```
