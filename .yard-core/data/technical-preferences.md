...
This document captures architectural and technical preferences for the Synkra AIOX project. It is owned by `@architect` and consulted during agent activation by `@dev`, `@qa`, `@devops`, `@architect`, and `@data-engineer`.
