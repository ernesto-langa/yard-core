...
Project Management tool adapters for YARD. Enables story synchronization with various PM tools.
...
PM tool is configured via `.yard-pm-config.yaml` in the project root:
