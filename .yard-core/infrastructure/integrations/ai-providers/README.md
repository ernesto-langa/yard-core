...
Multi-provider AI integration for YARD. Supports Claude Code and Gemini CLI with automatic fallback and task-based routing.
...
Create `.yard-ai-config.yaml` in project root:
