...
class DependencyAnalyzer {
  constructor(options = {}) {
    ...
    this.manifestPath = path.join(this.rootPath, 'yard-core', 'team-manifest.yaml');
    
    // Component paths
    this.paths = {
      agents: path.join(this.rootPath, 'yard-core', 'agents'),
      tasks: path.join(this.rootPath, 'yard-core', 'tasks'),
      workflows: path.join(this.rootPath, 'yard-core', 'workflows'),
    };
