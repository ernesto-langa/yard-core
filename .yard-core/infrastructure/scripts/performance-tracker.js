...
function generateReport() {
  ...
  let report = `# YARD Performance Report
...
`;
  ...
  report += '\n---\n\n*Auto-generated by YARD Performance Tracker (Story 6.1.2.6)*\n';
 ...
 */
async function savePerformanceData(filepath = '.yard-core/performance-data.json') {
  const data = {
    ...performanceData,
 ...
 */
async function loadPerformanceData(filepath = '.yard-core/performance-data.json') {
  try {
