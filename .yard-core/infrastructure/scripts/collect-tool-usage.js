...
// Purpose: Collect tool usage data per session, store in .yard/analytics/,
//          enforce data governance (sanitization, retention, schema).
//
// Usage:
//   node .yard-core/infrastructure/scripts/collect-tool-usage.js [options]
//
// Options:
...
// --- Configuration ---
const ANALYTICS_DIR = path.resolve(process.cwd(), '.yard', 'analytics');
