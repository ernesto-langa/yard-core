...
/**
 * Framework structure analyzer for YARD
...
class FrameworkAnalyzer {
  ...
  async discoverAgents() {
    const agents = [];
    const agentsDir = path.join(process.cwd(), '.yard-core', 'agents');
  ...
  async discoverTasks() {
    const tasks = [];
    const tasksDir = path.join(process.cwd(), '.yard-core', 'tasks');
  ...
  async discoverWorkflows() {
    const workflows = [];
    const workflowsDir = path.join(process.cwd(), '.yard-core', 'workflows');
  ...
  async discoverUtils() {
    const utils = [];
    const utilsDir = path.join(process.cwd(), '.yard-core', 'utils');
  ...
  async discoverTemplates() {
    const templates = [];
    const templatesDir = path.join(process.cwd(), '.yard-core', 'templates');
