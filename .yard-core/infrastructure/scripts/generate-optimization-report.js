...
// Layer: L2 (.yard-core/infrastructure/scripts/)
// Purpose:
...
//
// Usage:
//   node .yard-core/infrastructure/scripts/generate-optimization-report.js [options]
//
// Options:
...
const ANALYTICS_DIR = path.resolve(ROOT, '.yard', 'analytics');
...
const TOOL_REGISTRY_FILE = path.resolve(ROOT, '.yard-core', 'data', 'tool-registry.yaml');
