...
npm run sync:ide
# or
node .yard-core/infrastructure/scripts/ide-sync/index.js sync
```
...
# or
node .yard-core/infrastructure/scripts/ide-sync/index.js validate
```
...
# or
node .yard-core/infrastructure/scripts/ide-sync/index.js validate --strict
```
...
Configure in `.yard-core/core-config.yaml`:
...
```
.yard-core/infrastructure/scripts/ide-sync/
