...
class TransactionManager {
  constructor(options = {}) {
    ...
    this.transactionPath = path.join(this.rootPath, 'yard-core', 'transactions');
    this.backupPath = path.join(this.rootPath, 'yard-core', 'backups');
  ...
  async rollbackManifestUpdate(operation, results) {
    try {
      const manifestPath = path.join(this.rootPath, 'yard-core', 'team-manifest.yaml');
