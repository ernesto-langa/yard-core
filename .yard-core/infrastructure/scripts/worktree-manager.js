 ...
 * @property {string} [worktreeDir='.yard/worktrees'] - Directory for worktrees
 ...
 * @property {string} [mergeLogDir='.yard/logs/merges'] - Directory for merge audit logs
 */
...
class WorktreeManager {
  ...
  constructor(projectRoot, options = {}) {
    ...
    this.worktreeDir = options.worktreeDir || '.yard/worktrees';
    this.branchPrefix = options.branchPrefix || 'auto-claude/';
    this.staleDays = options.staleDays || 30;
    this.mergeLogDir = options.mergeLogDir || '.yard/logs/merges';
    this.gitPath = 'git';
  }
