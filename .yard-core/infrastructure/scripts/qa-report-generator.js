...
const CONFIG = {
  ...
  // Template path
  templatePath: '.yard-core/product/templates/qa-report-tmpl.md',
...
*Generated by YARD QA Report Generator v1.0*
`;
  }
...
async function main() {
  ...
  if (args.length < 1 || args.includes('--help') || args.includes('-h')) {
    console.log(`
QA Report Generator - YARD QA Evolution (Story 6.2)
...
Acceptance Criteria Coverage:
  ...
  AC7: Integrates with .yard/dashboard/status.json
`);
