 ...
 * - AC2: Generates `.yard/gotchas.md` consolidated
...
const CONFIG = {
  ...
  outputJsonPath: '.yard/gotchas.json',
...
*Generated by YARD Gotchas Documenter v${CONFIG.version}*
`;
  ...
  static showHelp() {
    console.log(`
Gotchas Documenter - YARD Memory Layer (Story 7.4)
