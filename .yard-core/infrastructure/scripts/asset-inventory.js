...
const ASSET_PATHS = {
  ...
  templates: '.yard-core/product/templates',
  checklists: '.yard-core/product/checklists',
  scripts: '.yard-core/infrastructure/scripts',
  schemas: '.yard-core/schemas',
...
Options:
  ...
  // Find project root (look for .yard-core directory)
