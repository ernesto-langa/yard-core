...
## Activation Protocol
1. Load \`.yard-core/development/agents/${agentData.filename}\` as source of truth (fallback: \`.codex/agents/${agentData.filename}\`).
2. Adopt this agent persona and command system.
3. Generate greeting via \`node .yard-core/development/scripts/generate-greeting.js ${agentData.id}\` and show it first.
