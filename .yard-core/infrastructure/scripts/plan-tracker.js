 ...
 *
 * Features:
 * - AC1: Located in `.yard-core/infrastructure/scripts/`
...
class PlanTracker {
   ...
   *
   * Updates `.yard/dashboard/status.json` for dashboard integration.
   * Also updates legacy `.yard/status.json` for backwards compatibility.
   *
