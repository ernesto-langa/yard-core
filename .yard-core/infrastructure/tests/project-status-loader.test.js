  ...
  describe('formatStatusDisplay', () => {
    ...
    it('should display worktrees summary in status', () => {
      const status = {
        ...
        worktrees: {
          'STORY-42': {
            path: path.join(process.cwd(), '.yard', 'worktrees', 'STORY-42'),
          ...
          'STORY-43': {
            path: path.join(process.cwd(), '.yard', 'worktrees', 'STORY-43'),
  ...
  describe('getWorktreesStatus', () => {
    ...
    it('should return worktree info with required fields', async () => {
      ...
      try {
        ...
        const worktreePath = path.join(testRoot, '.yard', 'worktrees', 'STORY-TEST');
  ...
  describe('generateStatus with worktrees', () => {
    it('should include worktrees in generated status', async () => {
      ...
      try {
        ...
        // Create worktree
        const worktreePath = path.join(testRoot, '.yard', 'worktrees', 'STORY-GEN');
