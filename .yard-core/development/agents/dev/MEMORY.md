...
### Project Structure
- `.yard-core/core/` — Core modules (synapse, session, code-intel, orchestration)
- `.yard-core/development/` — Agents, tasks, templates, scripts
- `.yard-core/infrastructure/` — CI/CD, git detection, project-status
...
- atomicWriteSync from `.yard-core/core/synapse/utils/atomic-write` for safe file writes
