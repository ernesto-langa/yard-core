...
/**
 * Git operations wrapper for YARD framework modifications
 */
class GitWrapper {
  constructor(options = {}) {
  ...
  async commit(message, options = {}) {
    const {
      author = 'yard-developer <yard-developer@yard-fullstack.local>',
      signoff = true
    } = options;
  ...
  async commitModification(files, message, metadata = {}) {
    ...
    fullMessage += '\n\nGenerated by: yard-developer meta-agent';
