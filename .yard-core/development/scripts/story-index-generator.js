/**
 * Story Index Generator for YARD Framework
 *
...
`;
  ...
  markdown += '\n---\n\n';
  markdown += '*Auto-generated by YARD Story Index Generator (Story 6.1.2.6)*\n';
  markdown += '*Update: Run `npm run stories:index` or `node .yard-core/scripts/story-index-generator.js docs/stories`*\n';
