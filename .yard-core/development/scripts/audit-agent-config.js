 ...
 *
 * Analyzes all 13 YARD agents to determine which core-config.yaml sections
...
async function extractAgentDependencies(agentId) {
  const agentPath = path.join('.yard-core', 'agents', `${agentId}.md`);
...
function analyzeConfigNeeds(agentData) {
  ...
  if (agentData.agentId === 'yard-master' ||
...
*Auto-generated by YARD Agent Config Audit (Story 6.1.2.6)*
`;
...
async function auditAllAgents() {
  console.log('🔍 Auditing all 13 YARD agents...\n');
