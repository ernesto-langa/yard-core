 ...
 *
 * Usage:
 *   node .yard-core/utils/validate-filenames.js
 *   node .yard-core/utils/validate-filenames.js --fix
 */
...
class FilenameValidator {
  ...
  report() {
    ...
    if (this.errors.length > 0) {
      ...
      console.log('3. Or run: node .yard-core/utils/validate-filenames.js --fix\n');
