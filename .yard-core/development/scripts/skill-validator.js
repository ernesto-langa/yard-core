...
class SkillValidator {
  constructor(config = {}) {
    this.agentsDir = config.agentsDir || path.join(process.cwd(), '.yard-core', 'development', 'agents');
    this.tasksDir = config.tasksDir || path.join(process.cwd(), '.yard-core', 'development', 'tasks');
    this.errors = [];
    this.warnings = [];
  }
