...
const SCAN_CONFIG = [
  { category: 'tasks', basePath: '.yard-core/development/tasks', glob: '**/*.md', type: 'task' },
  { category: 'templates', basePath: '.yard-core/product/templates', glob: '**/*.{yaml,yml,md}', type: 'template' },
  { category: 'scripts', basePath: '.yard-core/development/scripts', glob: '**/*.{js,mjs}', type: 'script' },
  { category: 'modules', basePath: '.yard-core/core', glob: '**/*.{js,mjs}', type: 'module' },
  { category: 'agents', basePath: '.yard-core/development/agents', glob: '**/*.{md,yaml,yml}', type: 'agent' },
  { category: 'checklists', basePath: '.yard-core/development/checklists', glob: '**/*.md', type: 'checklist' },
  { category: 'data', basePath: '.yard-core/data', glob: '**/*.{yaml,yml,md}', type: 'data' },
  { category: 'workflows', basePath: '.yard-core/development/workflows', glob: '**/*.{yaml,yml}', type: 'workflow' },
  { category: 'utils', basePath: '.yard-core/core/utils', glob: '**/*.js', type: 'util' },
  { category: 'tools', basePath: '.yard-core/development/tools', glob: '**/*.{md,js,sh}', type: 'tool' },
  { category: 'infra-scripts', basePath: '.yard-core/infrastructure/scripts', glob: '**/*.js', type: 'script' },
  { category: 'infra-tools', basePath: '.yard-core/infrastructure/tools', glob: '**/*.{yaml,yml,md}', type: 'tool' },
  { category: 'product-checklists', basePath: '.yard-core/product/checklists', glob: '**/*.md', type: 'checklist' },
  { category: 'product-data', basePath: '.yard-core/product/data', glob: '**/*.{yaml,yml,md}', type: 'data' }
];
