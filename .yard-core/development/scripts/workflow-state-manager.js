 ...
 * New code should use: .yard-core/core/orchestration/session-state.js
 *
 ...
 *
 * State files are stored at: .yard/{instance-id}-state.yaml
 *
 * Design constraints:
...
class WorkflowStateManager {
  ...
  constructor(options = {}) {
    ...
    this.stateDir = path.join(this.basePath, '.yard');
  }
  ...
  resolveAgentPaths(state) {
    const corePath = path.join(this.basePath, '.yard-core', 'development', 'agents');
