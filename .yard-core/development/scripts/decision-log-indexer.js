...
async function loadConfig() {
  ...
  try {
    const configContent = await fs.readFile('.yard-core/core-config.yaml', 'utf8');
...
- [Core Configuration](.yard-core/core-config.yaml)
...
*To manually rebuild the index, run: node .yard-core/scripts/decision-log-indexer.js rebuild*
`;
