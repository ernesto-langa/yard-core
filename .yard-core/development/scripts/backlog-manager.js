/**
 * Backlog Manager for YARD Framework
 *
...
`;
    ...
    markdown += '\n---\n\n';
    markdown += '*Auto-generated by YARD Backlog Manager (Story 6.1.2.6)*\n';
    markdown += '*Update: Run `npm run stories:backlog` or `node .yard-core/scripts/backlog-manager.js generate docs/stories/backlog.md`*\n';
