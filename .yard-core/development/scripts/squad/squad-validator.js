  ...
  async validateWorkflows(squadPath) {
    ...
    try {
      ...
      result.warnings.push({
        ...
        suggestion: 'Ensure workflow-validator.js exists in .yard-core/development/scripts/',
      });
      return result;
    }

    const coreAgentsPath = path.join(process.cwd(), '.yard-core', 'development', 'agents');
