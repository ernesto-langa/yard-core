...
|---------|-----------|-----------|-----------|
| `core` | `.yard-core/development/agents/{agent}.md` | `.yard-core/development/tasks/{uses}.md` | `.yard-core/data/{file}` |
...
2. If not found, check `.yard-core/development/agents/{agent}.md`
