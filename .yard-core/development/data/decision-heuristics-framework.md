...
| ------------------ | --------------------------------------------- | ------------------------------- |
| `@ernesto-langa`     | Mind cloning, DNA extraction, source curation | `/squad-creator @ernesto-langa`   |
...
anti_patterns:
  - name: 'Wrong Specialist'
    ...
    correction: 'Use @ernesto-langa for DNA extraction'
