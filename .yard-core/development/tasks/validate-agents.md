...
1. Check that each referenced task file exists in `.yard-core/development/tasks/`
2. Report missing dependencies as ERRORS

For each agent's `dependencies.checklists` list:
1. Check in `.yard-core/development/checklists/`
...
- Agent files in `.yard-core/development/agents/`
- Task files in `.yard-core/development/tasks/`
