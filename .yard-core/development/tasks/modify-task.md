...
- Target task must exist in `yard-core/tasks/`
...
- Load target task from `yard-core/tasks/{task-name}.md`
- Create timestamped backup: `yard-core/tasks/.backups/{task-name}.md.{timestamp}`
