...
- **Tool:** ast-parser
  ...
  - **Source:** .yard-core/utils/ast-parser.js
...
- **Script:** modify-file.js
  ...
  - **Language:** JavaScript
  - **Location:** .yard-core/scripts/modify-file.js
...
- Target agent must exist in `yard-core/agents/`
...
- Load target agent from `yard-core/agents/{agent-name}.md`
- Parse YAML header and markdown content separately
- Create timestamped backup: `yard-core/agents/.backups/{agent-name}.md.{timestamp}`
