...
- **Tool:** build-component
  ...
  - **Source:** .yard-core/development/tasks/build-component.md

- **Tool:** generate-documentation
  - **Purpose:** Generate Pattern Library docs
  - **Source:** .yard-core/development/tasks/generate-documentation.md
...
- **Tool:** calculate-roi
  ...
  - **Source:** .yard-core/development/tasks/calculate-roi.md
  ...
  quality-pipeline:
    ...
    steps:
      ...
      - name: Run Design System Pipeline
        run: npx yard-core task run-design-system-pipeline --mode=yolo
```
...
{
  "scripts": {
    "ds:pipeline": "npx yard-core task run-design-system-pipeline",
    "ds:pipeline:ci": "npx yard-core task run-design-system-pipeline --mode=yolo"
  }
}
```
