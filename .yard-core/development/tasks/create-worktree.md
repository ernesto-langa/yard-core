...
post-conditions:
  - [ ] Worktree directory exists
    tipo: post-condition
    blocker: true
    validação: Directory exists at .yard/worktrees/{storyId}
...
- **Tool:** WorktreeManager
  ...
  - **Source:** .yard-core/infrastructure/scripts/worktree-manager.js
...
- Directory: `.yard/worktrees/{storyId}/`
- Branch: `auto-claude/{storyId}`
...
Next Steps:
  • cd .yard/worktrees/{storyId}  - Navigate to worktree
...
- `.yard/worktrees/{storyId}/` - Isolated worktree directory
...
```bash
git worktree remove .yard/worktrees/{storyId}
...
- `.yard-core/infrastructure/scripts/worktree-manager.js` - Core manager
...
- **Script:** `.yard-core/infrastructure/scripts/worktree-manager.js`
