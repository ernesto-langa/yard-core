...
const { getCodebaseOverview, getDependencyGraph } = require('.yard-core/core/code-intel/helpers/planning-helper');
...
```javascript
// .yard-core/core/orchestration/executor-assignment.js
const { assignExecutorFromContent } = require('.yard-core/core/orchestration/executor-assignment');
