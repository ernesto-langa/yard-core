...
- **Tool:** component-generator
  ...
  - **Source:** .yard-core/scripts/component-generator.js
...
- **Script:** create-component.js
  ...
  - **Language:** JavaScript
  - **Location:** .yard-core/scripts/create-component.js
...
- **Check code intelligence availability:** Call `isCodeIntelAvailable()` from `.yard-core/core/code-intel`
- **If available:**
  - Call `detectDuplicateStory(storyDescription)` from `.yard-core/core/code-intel/helpers/story-helper`
  ...
  - Call `suggestRelevantFiles(storyDescription)` from `.yard-core/core/code-intel/helpers/story-helper`
...
- Execute `yard-core/tasks/execute-checklist` `yard-core/checklists/story-draft-checklist`
- Provide summary to user including:
  ...
  - Checklist Results
  - Next steps: For Complex stories, suggest the user carefully review the story draft and also optionally have the PO run the task `yard-core/tasks/validate-next-story`
