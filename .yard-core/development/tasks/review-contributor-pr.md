...
#### For Code PRs (packages/, .yard-core/, bin/)
...
gh pr diff {pr_number} -- 'packages/' '.yard-core/' 'bin/' | grep -E "(shell:\s*true|execSync\(|\.exec\(|eval\(|Function\()"
