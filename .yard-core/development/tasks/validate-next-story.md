...
- **Tool:** validation-engine
  ...
  - **Source:** .yard-core/utils/validation-engine.js
...
- **Script:** run-validation.js
  ...
  - **Language:** JavaScript
  - **Location:** .yard-core/scripts/run-validation.js
...
- Load `.yard-core/core-config.yaml`
...
- Identify and load the following inputs:
  ...
  - **Story template**: `yard-core/templates/story-tmpl.yaml` for completeness validation

### 1. Template Completeness Validation

- Load `yard-core/templates/story-tmpl.yaml` and extract all section headings from the template
...
- **If available:**
  - Call `validateNoDuplicates(storyDescription)` from `.yard-core/core/code-intel/helpers/story-helper`
