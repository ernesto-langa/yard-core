...
```javascript
const { generateStoryIndex } = require('.yard-core/scripts/story-index-generator');
...
Stories by Epic:
- Epic 6.1 YARD Migration: 45 stories
...
{
  "scripts": {
    "stories:index": "node .yard-core/scripts/story-index-generator.js docs/stories"
  }
}
```
