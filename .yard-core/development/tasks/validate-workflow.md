...
- **Script:** workflow-validator.js
  ...
  - **Language:** JavaScript
  - **Location:** .yard-core/development/scripts/workflow-validator.js
...
- WorkflowValidator class available at `.yard-core/development/scripts/workflow-validator.js`
...
- Scan directory based on target_context:
  - `core` → all `.yaml` files in `.yard-core/development/workflows/`
