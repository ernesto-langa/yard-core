...
- `.yard-core/core/ids/framework-governor.js` — FrameworkGovernor class
- `.yard-core/core/ids/registry-loader.js` — RegistryLoader
- `.yard-core/core/ids/incremental-decision-engine.js` — DecisionEngine
- `.yard-core/core/ids/registry-updater.js` — RegistryUpdater
- `.yard-core/core/ids/registry-healer.js` — RegistryHealer (optional, IDS-4a)
