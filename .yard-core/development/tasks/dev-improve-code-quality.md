...
*improve-code-quality yard-core/scripts/legacy-utility.js --preview

# Auto-fix all safe improvements in directory
*improve-code-quality yard-core/agents --auto-fix --recursive

# Apply specific patterns
*improve-code-quality yard-core/utils --patterns formatting,modern-syntax,async-await

# Generate improvement report
*improve-code-quality . --recursive --report quality-report.json

# Use custom configuration
*improve-code-quality yard-core --config .yard/quality-config.json
```
...
class ImproveCodeQualityTask {
  ...
  async createBackup(filePath) {
    const backupDir = path.join(this.rootPath, '.yard', 'backups', 'code-quality');
