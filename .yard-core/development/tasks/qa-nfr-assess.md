...
required:
  ...
  - story_path: `yard-core/core-config.yaml` for the `devStoryLocation`

optional:
  - architecture_refs: `yard-core/core-config.yaml` for the `architecture.architectureFile`
  - technical_preferences: `yard-core/core-config.yaml` for the `technicalPreferences`
