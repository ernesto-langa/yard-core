  ...
  async execute(params) {
    ...
    try {
      ...
      const analysis = await analyzer.analyzeCapabilities({
        target_areas,
        currentImplementation: './yard-core'
      });
