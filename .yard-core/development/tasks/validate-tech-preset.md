...
atomic_layer: task
Entrada: |
  - preset_path: Path to the tech preset file (default: .yard-core/data/tech-presets/)
...
1. Resolve preset path
   ...
   ├── If name provided → resolve via .yard-core/data/tech-presets/{name}.md
...
- Preset: .yard-core/data/tech-presets/{name}.md
```

## Related

- **Agent:** @architect (Aria)
- **Location:** .yard-core/data/tech-presets/
