...
*analyze-impact deprecate yard-core/scripts/old-helper.js --output-format visual --save-report reports/deprecation-impact.html
...
*analyze-impact remove yard-core/workflows/legacy-workflow.yaml --depth deep --save-report reports/removal-impact.json
```
...
{
  "success": true,
  "targetComponent": "yard-core/agents/weather-agent.md",
  "riskLevel": "medium",
