...
post-conditions:
  - [ ] Worktree directory removed
    tipo: post-condition
    blocker: true
    validação: Directory .yard/worktrees/{storyId} does not exist
...
Options:
  1. Commit changes first    : cd .yard/worktrees/{storyId} && git commit
...
You are about to remove:
  • Worktree: .yard/worktrees/{storyId}
  • Branch:   auto-claude/{storyId}
...
1. `git worktree remove .yard/worktrees/{storyId}`
...
❌ Cannot remove worktree while inside it.
   ...
   Current directory: .yard/worktrees/{storyId}
...
- `.yard-core/infrastructure/scripts/worktree-manager.js`
