...
pre-conditions:
  ...
  - [ ] Pattern storage exists
    tipo: pre-condition
    blocker: false
    validação: Check .yard-core/data/learned-patterns.yaml exists
...
```javascript
const learning = require('.yard-core/workflow-intelligence/learning');
...
Storage file: .yard-core/data/learned-patterns.yaml
...
try {
  ...
  console.log('Try running: rm .yard-core/data/learned-patterns.yaml');
}
```
