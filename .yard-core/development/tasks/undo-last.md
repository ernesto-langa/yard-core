...
- **Tool:** backup-manager
  ...
  - **Source:** .yard-core/utils/backup-manager.js
...
- **Script:** rollback-changes.js
  ...
  - **Language:** JavaScript
  - **Location:** .yard-core/scripts/rollback-changes.js
...
Operations:
  - Created: /yard-core/agents/data-analyst.md
  - Updated: /yard-core/team-manifest.yaml
  - Created: /yard-core/tasks/analyze-data.md
```
