...
questions:
  - Story path (relative to docs/stories/):
    ...
    example: "epics/epic-pro-yard-pro-architecture/story-pro-5-repo-bootstrap.md"
...
*close-story epics/epic-pro-yard-pro-architecture/story-pro-5-repo-bootstrap.md
