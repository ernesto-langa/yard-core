...
# User selects from available templates in .yard-core/product/templates/
tools:
...
If a YAML Template has not been provided, list all templates from .yard-core/product/templates or ask the user to provide another.
