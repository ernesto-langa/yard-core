...
class ReviewProposalTask {
  ...
  async loadProposal(proposalId) {
    try {
      const proposalFile = path.join(this.rootPath, '.yard', 'proposals', `${proposalId}.json`);
  ...
  async checkForConflicts(proposal) {
    ...
    const indexFile = path.join(this.rootPath, '.yard', 'proposals', 'index.json');
  ...
  async storeReview(proposal, review) {
    const reviewsDir = path.join(this.rootPath, '.yard', 'proposals', 'reviews');
  ...
  async updateProposalStatus(proposal, review) {
    ...
    const proposalFile = path.join(this.rootPath, '.yard', 'proposals', `${proposal.proposalId}.json`);
