...
- **Script:** parse-qa-report.js
  ...
  - **Language:** JavaScript
  - **Location:** .yard-core/development/scripts/parse-qa-report.js (optional)
...
_Generated by Quinn (Test Architect) - YARD QA System_
...
**Location:** `.yard-core/development/tasks/qa-review-story.md`
