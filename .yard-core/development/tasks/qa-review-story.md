...
2. Call `getReferenceImpact(files)` from `.yard-core/core/code-intel/helpers/qa-helper.js`
...
- Create directory defined in `qa.qaLocation/gates` (see `.yard-core/core-config.yaml`) if missing
