...
- **Tool:** query-validator
  ...
  - **Source:** .yard-core/utils/db-query-validator.js
...
- **Script:** db-query.js
  ...
  - **Language:** JavaScript
  - **Location:** .yard-core/scripts/db-query.js
...
3. `.yard-core/product/templates/tmpl-smoke-test.sql` (template)
...
elif [ -f ".yard-core/product/templates/tmpl-smoke-test.sql" ]; then
  SMOKE_TEST=".yard-core/product/templates/tmpl-smoke-test.sql"
else
