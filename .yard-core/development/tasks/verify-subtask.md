...
autoClaude:
  ...
  verification:
    type: script
    script: .yard-core/infrastructure/scripts/subtask-verifier.js
    timeout: 120
```
  ...
  actions:
    - action: find_implementation
      paths:
        ...
        - .yard/plans/{storyId}/implementation.yaml
...
step_2:
  actions:
    - action: execute_script
      script: |
        node .yard-core/infrastructure/scripts/subtask-verifier.js {subtaskId} \
