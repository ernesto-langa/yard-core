 ...
 * - Session states older than 30 days (archived to .yard/archive/sessions/)
...
const ARCHIVE_DIR = '.yard/archive/sessions';
const SNAPSHOTS_DIR = '.yard/snapshots';
...
class DataLifecycleManager {
   ...
   *
   * Sessions with last_updated > 30 days are moved to .yard/archive/sessions/
   *
