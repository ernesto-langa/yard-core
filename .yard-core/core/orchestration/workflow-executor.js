...
class WorkflowExecutor {
  ...
  constructor(projectRoot, options = {}) {
    ...
    this.workflowPath = path.join(
      projectRoot,
      '.yard-core/development/workflows/development-cycle.yaml',
    );
    this.statePath = path.join(process.cwd(), '.yard', 'workflow-state');
    this.configPath = path.join(projectRoot, '.yard-core/core-config.yaml');
