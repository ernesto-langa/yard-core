 ...
 *
 * Reads .yard-core/constitution.md and generates .synapse/constitution
 * in KEY=VALUE format for the SYNAPSE Context Engine L0 layer.
 *
 * Usage: node .yard-core/core/synapse/scripts/generate-constitution.js
 *
...
function generateConstitution(articles) {
  const lines = [
    ...
    '# Auto-generated from .yard-core/constitution.md',
...
function main(options = {}) {
  ...
  const constitutionPath = options.constitutionPath || path.join(projectRoot, '.yard-core', 'constitution.md');
