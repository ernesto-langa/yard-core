 ...
 *
 * Features:
 * - AC1: gotchas-memory.js in .yard-core/core/memory/
 * - AC2: Persists in .yard/gotchas.json and .yard/gotchas.md
...
const CONFIG = {
  // Output paths
  gotchasJsonPath: '.yard/gotchas.json',
  gotchasMdPath: '.yard/gotchas.md',
  errorTrackingPath: '.yard/error-tracking.json',
  ...
  // Version
  version: '1.0.0',
  schemaVersion: 'yard-gotchas-memory-v1',
};
...
> Auto-generated by YARD Gotchas Memory
> Last updated: ${now}
...
*Generated by YARD Gotchas Memory v${CONFIG.version}*
`;
  ...
  static showHelp() {
    console.log(`
Gotchas Memory - YARD Memory Layer (Story 9.4)
