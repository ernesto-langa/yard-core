...
```javascript
// CommonJS
const core = require('./.yard-core/core');

// ES Modules
import { ConfigCache, ElicitationEngine } from './.yard-core/core/index.esm.js';
```
...
```javascript
const { globalConfigCache } = require('./.yard-core/core');
...
```javascript
const { loadAgentConfig } = require('./.yard-core/core');
...
```javascript
const { loadConfigSections } = require('./.yard-core/core');
...
```javascript
const { ContextDetector } = require('./.yard-core/core');
...
```javascript
const { SessionContextLoader } = require('./.yard-core/core');
...
```javascript
const { ElicitationEngine } = require('./.yard-core/core');
...
```javascript
const { ElicitationSessionManager } = require('./.yard-core/core');
...
```javascript
const { YAMLValidator, validateYAML } = require('./.yard-core/core');
...
```javascript
const { PersonalizedOutputFormatter } = require('./.yard-core/core');
