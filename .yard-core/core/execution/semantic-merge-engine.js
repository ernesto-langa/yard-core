 ...
 * Loads project-specific merge rules from .yard/merge-rules.yaml
 */
class CustomRulesLoader {
  constructor(rootPath = process.cwd()) {
    this.rootPath = rootPath;
    this.rulesPath = path.join(rootPath, '.yard', 'merge-rules.yaml');
    this.cache = {
      rules: null,
      lastLoad: null,
...
class SemanticMergeEngine extends EventEmitter {
  constructor(config = {}) {
    ...
    // Storage
    this.storageDir = config.storageDir || path.join(this.rootPath, '.yard', 'merge');
  }
