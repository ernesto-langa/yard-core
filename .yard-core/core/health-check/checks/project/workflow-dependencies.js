 ...
 *
 * @module yard-core/health-check/checks/project/workflow-dependencies
 * @version 1.0.0
...
class WorkflowDependenciesCheck extends BaseCheck {
  constructor() {
    super({
      ...
      cacheable: true,
      healingTier: 0,
      tags: ['yard', 'workflows', 'dependencies'],
    });
  }
  ...
  async execute(context) {
    ...
    const workflowPaths = [
      path.join(projectRoot, '.yard-core', 'development', 'workflows'),
      path.join(projectRoot, '.yard-core', 'infrastructure', 'workflows'),
    ];
    ...
    const taskPaths = [
      path.join(projectRoot, '.yard-core', 'development', 'tasks'),
      path.join(projectRoot, '.yard-core', 'infrastructure', 'tasks'),
    ];
