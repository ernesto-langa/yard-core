...
const HEALING_LOG_PATH = path.resolve(REPO_ROOT, '.yard-core/data/registry-healing-log.jsonl');
const HEALING_BACKUP_DIR = path.resolve(REPO_ROOT, '.yard-core/data/registry-backups/healing');
