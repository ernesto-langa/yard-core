 ...
 *
 * Validates .yard-core/core/graph-dashboard/ directory exists
 * with at least 1 .js file.
 *
 * @module yard-core/doctor/checks/graph-dashboard
 * @story INS-4.1
 */
...
async function run(context) {
  const dashboardDir = path.join(context.projectRoot, '.yard-core', 'core', 'graph-dashboard');
