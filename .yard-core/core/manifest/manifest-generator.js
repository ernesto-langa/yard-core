 ...
 * Scans the .yard-core directory structure to build comprehensive manifests.
 *
...
class ManifestGenerator {
  ...
  async generateAgentsManifest() {
    const agentsDir = path.join(process.cwd(), '.yard-core', 'development', 'agents');
        ...
        try {
          ...
          if (parsed && parsed.agent) {
            ...
            agents.push({
              ...
              status: 'active',
              file_path: `.yard-core/development/agents/${file}`,
  ...
  async generateWorkersManifest() {
    const registryPath = path.join(process.cwd(), '.yard-core', 'core', 'registry', 'service-registry.json');
  ...
  async generateTasksManifest() {
    const tasksDir = path.join(process.cwd(), '.yard-core', 'development', 'tasks');
      ...
      for (const file of mdFiles) {
        try {
          ...
          tasks.push({
            ...
            file_path: `.yard-core/development/tasks/${file}`,
            status: 'active',
          });
