...
const SCAN_SOURCES = [
  {
    pattern: '.yard-core/development/tasks/**/*.md',
    category: 'task',
  ...
  {
    pattern: '.yard-core/product/templates/**/*.md',
    category: 'template',
    taskFormat: 'TEMPLATE',
    subcategoryExtractor: (filePath) => {
  ...
  {
    pattern: '.yard-core/infrastructure/scripts/**/*.js',
    category: 'script',
    taskFormat: 'SCRIPT',
    subcategoryExtractor: (filePath) => {
  ...
  {
    pattern: '.yard-core/product/checklists/**/*.md',
    category: 'checklist',
    taskFormat: 'CHECKLIST',
    subcategoryExtractor: () => 'quality',
  },
  {
    pattern: '.yard-core/development/workflows/**/*.yaml',
    category: 'workflow',
    taskFormat: 'WORKFLOW',
    subcategoryExtractor: (filePath) => {
  ...
  {
    pattern: '.yard-core/core/data/**/*.md',
    category: 'data',
    taskFormat: 'TASK-FORMAT-V1',
    subcategoryExtractor: () => 'knowledge',
  },
  {
    pattern: '.yard-core/core/data/**/*.yaml',
    category: 'data',
    taskFormat: 'TASK-FORMAT-V1',
...
async function main() {
  ...
  const outputPath = process.argv[3] || path.join(baseDir, '.yard-core/core/registry/service-registry.json');
