# YARD Service Registry

The Service Registry is the central catalog of all workers, tasks, templates, scripts, and workflows in the YARD framework. It enables service discovery, search, and reuse across the system.
...
The builder scans:
- `.yard-core/development/tasks/**/*.md` → task
- `.yard-core/product/templates/**/*.md` → template
- `.yard-core/infrastructure/scripts/**/*.js` → script
- `.yard-core/product/checklists/**/*.md` → checklist
- `.yard-core/development/workflows/**/*.yaml` → workflow
- `.yard-core/core/data/**/*` → data
...
- **Discovery CLI** (Story 2.7-2.9): `yard search`, `yard info`, `yard list`
...
*Generated by YARD Framework v4.0.4*
