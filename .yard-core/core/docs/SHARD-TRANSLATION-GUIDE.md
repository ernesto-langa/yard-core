...
YARD-Framework now automatically translates Portuguese documentation into English filenames when sharding documents. This ensures consistency across all projects and compatibility with hardcoded English filenames in configuration files.
...
**See full dictionary:** `.yard-core/tasks/shard-doc.md` (Section 3)
...
**Configuration:** `.yard-core/core-config.yaml`
...
```bash
# Check for issues
node .yard-core/scripts/validate-filenames.js

# Auto-fix issues (renames files)
node .yard-core/scripts/validate-filenames.js --fix
```
...
Edit `.yard-core/tasks/shard-doc.md`, Section 3:
...
**Solution:**
1. Check you're using the updated `.yard-core/tasks/shard-doc.md`
2. Run validator to confirm: `node .yard-core/scripts/validate-filenames.js`
...
**Manual fix:**
Edit `.yard-core/core-config.yaml` to add more fallbacks.
...
```javascript
// .yard-core/scripts/validate-filenames.js
...
A: Edit `.yard-core/tasks/shard-doc.md`, Section 3, and add to the YAML dictionary.
...
2. Run the validator: `node .yard-core/scripts/validate-filenames.js`
3. Review `.yard-core/tasks/shard-doc.md` for translation rules
