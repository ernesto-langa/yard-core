...
**Symptoms:**
```
❌ Error: Agent 'data-analyst' already exists at /yard-core/agents/data-analyst.md
```
...
3. If overwriting is intended:
   ...
   rm yard-core/agents/data-analyst.md
   *create-agent
   ```
...
1. Create session directory:
   ```bash
   mkdir -p yard-core/.sessions
   ```

2. Check permissions:
   ```bash
   chmod 755 yard-core/.sessions
   ```
...
2. Check transaction directory:
   ```bash
   ls yard-core/logs/transactions/
   ```
...
1. Manual cleanup:
   ```bash
   # Check failed files
   ls -la yard-core/agents/file1.md
   
   # Remove manually if needed
   rm yard-core/agents/file1.md
   ```
...
3. Restore from backup:
   ```bash
   # Check backups
   ls yard-core/logs/transactions/txn-*/backups/
   ```
...
1. Check failure details:
   ...
   cat yard-core/logs/transactions/latest.json
   ```
...
- Template syntax: `yard-core/docs/template-syntax.md`
- Creation guide: `yard-core/docs/component-creation-guide.md`
- API reference: `yard-core/docs/api-reference.md`
...
1. **Backup current state**:
   ```bash
   tar -czf yard-backup.tar.gz yard-core/
   ```
