...
```bash
node validate-v3-schema.js .yard-core/development/agents/dev.md
```
...
```bash
node validate-v3-schema.js --diff .yard-core/development/agents/dev.md
```
...
```bash
node validate-v3-schema.js .yard-core/development/agents/dev.md --strict
```
