...
**Tasks:**
- `.yard-core/tasks/{dependency1}.md`
- `.yard-core/tasks/{dependency2}.md`

**Templates:**
- `.yard-core/product/templates/{template1}.yaml`

**Checklists:**
- `.yard-core/product/checklists/{checklist1}.md`
...
All task outputs MUST use this structure (see `.yard-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md`):
...
- See `.yard-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md` for complete guidelines
