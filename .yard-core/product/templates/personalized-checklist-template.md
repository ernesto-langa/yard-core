...
2. All tests pass
3. Execute `.yard-core/product/checklists/story-dod-checklist.md`
...
node .yard-core/scripts/validate-checklist.js {checklist-id}
  ...
  checklist-validation:
    ...
    steps:
      ...
      - name: Generate Report
        run: |
          node .yard-core/scripts/generate-checklist-report.js {checklist-id}
...
- **Standard:** `.yard-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md`
- **Agent File:** `.yard-core/agents/{agent-id}.md`
