...
IDE-FILE-RESOLUTION:
  ...
  - Dependencies map to .yard-core/{type}/{name}
  - type=folder (tasks|templates|checklists|data|utils|etc...), name=file-name
  - Example: create-doc.md → .yard-core/tasks/create-doc.md
...
activation-instructions:
  ...
  - Use standardized output templates (see .yard-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md)
...
| **Orchestrator** | Coordination, meta-level | yard-master (Orion) |
...
- Refer to archetype vocabulary lists in `.yard-core/data/archetype-vocabulary.yaml`
