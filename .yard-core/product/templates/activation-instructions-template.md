...
This template defines the canonical activation-instructions format for YARD agents after GreetingBuilder integration (Story 6.1.2.5).
...
activation-instructions:
  ...
  - STEP 3: Build intelligent greeting using .yard-core/development/scripts/greeting-builder.js
...
```yaml
- STEP 2.5: Load project status using .yard-core/infrastructure/scripts/project-status-loader.js
- STEP 2.6: Load session context using .yard-core/scripts/session-context-loader.js
...
- **GreetingBuilder**: `.yard-core/development/scripts/greeting-builder.js`
- **Context Detector**: `.yard-core/core/session/context-detector.js`
- **Git Config Detector**: `.yard-core/infrastructure/scripts/git-config-detector.js`
- **Workflow Navigator**: `.yard-core/development/scripts/workflow-navigator.js`
- **Project Status Loader**: `.yard-core/infrastructure/scripts/project-status-loader.js`
- **Workflow Patterns**: `.yard-core/data/workflow-patterns.yaml`
...
*Template maintained by YARD Framework Team*
