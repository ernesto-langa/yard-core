...
```javascript
const templatePath = '.yard-core/product/templates/story-tmpl.yaml';
const checklistPath = '.yard-core/product/checklists/story-dod-checklist.md';
```
...
---
*YARD-Framework v4 - Product Module*
