 ...
 * const { recordPreCommitMetrics } = require('./.yard-core/quality/metrics-hook');
 ...
 *
 * @example
 * const { recordPRReviewMetrics } = require('./.yard-core/quality/metrics-hook');
 ...
 *
 * @example
 * const { recordHumanReviewMetrics } = require('./.yard-core/quality/metrics-hook');
 ...
 *
 * @example
 * const { withPreCommitMetrics } = require('./.yard-core/quality/metrics-hook');
 *
