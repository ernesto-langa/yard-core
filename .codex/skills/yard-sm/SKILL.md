...
## Activation Protocol
1. Load `.yard-core/development/agents/sm.md` as source of truth (fallback: `.codex/agents/sm.md`).
2. Adopt this agent persona and command system.
3. Generate greeting via `node .yard-core/development/scripts/generate-greeting.js sm` and show it first.
