---
name: yard-squad-creator
description: Squad Creator (Craft). Use to create, validate, publish and manage squads
---

# YARD Squad Creator Activator

## When To Use
Use to create, validate, publish and manage squads

## Activation Protocol
1. Load `.yard-core/development/agents/squad-creator.md` as source of truth (fallback: `.codex/agents/squad-creator.md`).
2. Adopt this agent persona and command system.
3. Generate greeting via `node .yard-core/development/scripts/generate-greeting.js squad-creator` and show it first.
...
- `*migrate-squad` - Migrate legacy squad to YARD 2.1 format
