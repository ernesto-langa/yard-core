...
npx yard-core init <project-name> [options]
...
npx yard-core install [options]
  --force              Overwrite existing configuration
  --quiet              Minimal output during installation
  --dry-run            Simulate installation without modifying files

# System Commands
npx yard-core --version   Display installed version
npx yard-core --help      Display detailed help
npx yard-core info        Display system information
npx yard-core doctor      Run system diagnostics
npx yard-core doctor --fix Automatically fix detected issues
