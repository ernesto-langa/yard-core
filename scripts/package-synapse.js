...
const FILES = {
  // Core Engine
  'core/engine.js': '.yard-core/core/synapse/engine.js',
  'core/context/context-tracker.js': '.yard-core/core/synapse/context/context-tracker.js',
  'core/domain/domain-loader.js': '.yard-core/core/synapse/domain/domain-loader.js',
  'core/layers/layer-processor.js': '.yard-core/core/synapse/layers/layer-processor.js',
  'core/layers/l0-constitution.js': '.yard-core/core/synapse/layers/l0-constitution.js',
  'core/layers/l1-global.js': '.yard-core/core/synapse/layers/l1-global.js',
  'core/layers/l2-agent.js': '.yard-core/core/synapse/layers/l2-agent.js',
  'core/layers/l3-workflow.js': '.yard-core/core/synapse/layers/l3-workflow.js',
  'core/layers/l4-task.js': '.yard-core/core/synapse/layers/l4-task.js',
  'core/layers/l5-squad.js': '.yard-core/core/synapse/layers/l5-squad.js',
  'core/layers/l6-keyword.js': '.yard-core/core/synapse/layers/l6-keyword.js',
  'core/layers/l7-star-command.js': '.yard-core/core/synapse/layers/l7-star-command.js',
  'core/memory/memory-bridge.js': '.yard-core/core/synapse/memory/memory-bridge.js',
  'core/output/formatter.js': '.yard-core/core/synapse/output/formatter.js',
  'core/session/session-manager.js': '.yard-core/core/synapse/session/session-manager.js',
  'core/scripts/generate-constitution.js': '.yard-core/core/synapse/scripts/generate-constitution.js',
  'core/utils/paths.js': '.yard-core/core/synapse/utils/paths.js',
  'core/utils/tokens.js': '.yard-core/core/synapse/utils/tokens.js',

  // Diagnostics
  'core/diagnostics/synapse-diagnostics.js': '.yard-core/core/synapse/diagnostics/synapse-diagnostics.js',
  'core/diagnostics/report-formatter.js': '.yard-core/core/synapse/diagnostics/report-formatter.js',
  'core/diagnostics/collectors/safe-read-json.js': '.yard-core/core/synapse/diagnostics/collectors/safe-read-json.js',
  'core/diagnostics/collectors/hook-collector.js': '.yard-core/core/synapse/diagnostics/collectors/hook-collector.js',
  'core/diagnostics/collectors/session-collector.js': '.yard-core/core/synapse/diagnostics/collectors/session-collector.js',
  'core/diagnostics/collectors/manifest-collector.js': '.yard-core/core/synapse/diagnostics/collectors/manifest-collector.js',
  'core/diagnostics/collectors/pipeline-collector.js': '.yard-core/core/synapse/diagnostics/collectors/pipeline-collector.js',
  'core/diagnostics/collectors/uap-collector.js': '.yard-core/core/synapse/diagnostics/collectors/uap-collector.js',
  'core/diagnostics/collectors/timing-collector.js': '.yard-core/core/synapse/diagnostics/collectors/timing-collector.js',
  'core/diagnostics/collectors/quality-collector.js': '.yard-core/core/synapse/diagnostics/collectors/quality-collector.js',
  'core/diagnostics/collectors/consistency-collector.js': '.yard-core/core/synapse/diagnostics/collectors/consistency-collector.js',
  'core/diagnostics/collectors/output-analyzer.js': '.yard-core/core/synapse/diagnostics/collectors/output-analyzer.js',
  'core/diagnostics/collectors/relevance-matrix.js': '.yard-core/core/synapse/diagnostics/collectors/relevance-matrix.js',
...
\`\`\`
cp -r core/ <your-project>/.yard-core/core/synapse/
\`\`\`
...
├── core/                      # Engine source (.yard-core/core/synapse/)
...
*SYNAPSE Context Engine v2.0 — YARD*
